...
return new class extends Migration
{
    ...
    {
        Schema::create('uang_jalan_batams', function (Blueprint $table) {
            $table->id();
            $table->string('nomor_uang_jalan')->unique();
            $table->date('tanggal_uang_jalan');
            $table->foreignId('surat_jalan_batam_id')->constrained('surat_jalan_batams')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('uang_jalan_batams');
    }
};
