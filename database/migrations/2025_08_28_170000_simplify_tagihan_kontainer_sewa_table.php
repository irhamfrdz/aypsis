...
class SimplifyTagihanKontainerSewaTable extends Migration
{
    ...
    public function down()
    {
        Schema::table('tagihan_kontainer_sewa', function (Blueprint $table) {
            ...
            if (! Schema::hasColumn('tagihan_kontainer_sewa', 'ukuran_kontainer')) {
                $table->string('ukuran_kontainer')->nullable();
            }
            if (! Schema::hasColumn('tagihan_kontainer_sewa', 'tarif')) {
                $table->string('tarif')->nullable();
            }
            if (! Schema::hasColumn('tagihan_kontainer_sewa', 'harga')) {
            ...
            if (! Schema::hasColumn('tagihan_kontainer_sewa', 'tanggal_checkpoint_supir')) {
