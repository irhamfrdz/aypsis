...
return new class extends Migration
{
    ...
    {
        Schema::create('pembayaran_pranota_lemburs', function (Blueprint $table) {
            $table->id();
            ...
            // Indexes
            $table->index(['status_pembayaran', 'tanggal_pembayaran'], 'idx_pemb_lembur_status_tanggal');
            $table->index(['jenis_transaksi'], 'idx_pemb_lembur_jenis_transaksi');
        });
    }
    ...
    {
        Schema::dropIfExists('pembayaran_pranota_lemburs');
    }
};
