...
/**
 * Script untuk menghapus data manifest dengan nomor voyage SR01BJ26
 * Jalankan: php delete_manifest_SR01BJ26.php
 */
...
echo "===========================================\n";
echo "Delete Manifest dengan Voyage SR01BJ26\n";
echo "===========================================\n\n";
...
try {
    ...
    if ($count === 0) {
        echo "❌ Tidak ada data manifest dengan nomor voyage SR01BJ26\n";
        exit(0);
    }
    
    echo "📊 Ditemukan {$count} record manifest dengan nomor voyage SR01BJ26\n\n";
    ...
    echo "\n✅ Berhasil menghapus {$deleted} record manifest dengan nomor voyage SR01BJ26\n";
    echo "===========================================\n";
