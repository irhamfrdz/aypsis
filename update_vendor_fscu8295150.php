<?php
/**
 * Script untuk mengubah vendor dan size SEMUA kontainer FSCU8295150
 * - Vendor: ZONA
 * - Size: 40ft
 * - DPP = Harga pricelist per bulan (sama untuk semua periode)
 * 
 * Jalankan dengan: php update_vendor_fscu8295150.php
 */
...
echo "===========================================\n";
echo "Script Update SEMUA Kontainer FSCU8295150\n";
echo "- Vendor: ZONA\n";
echo "- Size: 40ft\n";
echo "- DPP: SAMA untuk semua periode\n";
echo "===========================================\n\n";

// 1. Cari SEMUA kontainer FSCU8295150
