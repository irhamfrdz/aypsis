...
@section('title', 'Tambah Merk Ban')
@section('page_title', 'Tambah Merk Ban')
    ...
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900">Tambah Merk Ban Baru</h1>
                    <p class="mt-1 text-sm text-gray-600">Masukkan informasi merk ban yang akan ditambahkan</p>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <form action="{{ route('master.merk-ban.store') }}" method="POST" class="space-y-6">
                @csrf
