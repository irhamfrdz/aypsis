...
<div class="border-b border-gray-200 px-6 py-4 flex items-center justify-between bg-yellow-50/50">
    <h2 class="text-lg font-medium text-gray-900">Folder Spam (IMAP)</h2>
</div>
...
<div class="divide-y divide-gray-200">
    ...
    @endphp
    <div class="hover:bg-gray-50 flex items-center px-6 py-4 {{ !$isRead ? 'bg-yellow-50/50' : '' }}">
