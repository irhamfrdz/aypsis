...
@section('title', 'Tambah Pembelian BBM Batam')
@section('page_title', 'Tambah Pembelian BBM Batam')
...
<div class="container mx-auto px-4 py-6 max-w-3xl">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <div class="bg-gray-50 px-6 py-4 border-b border-gray-200">
            <h3 class="text-lg font-bold text-gray-800">Form Pembelian BBM Batam</h3>
            <p class="text-xs text-gray-500 mt-1">Isi detail pembelian minyak/BBM untuk cabang Batam.</p>
        </div>

        <form action="{{ route('pembelian-bbm-batam.store') }}" method="POST" class="p-6 space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <!-- No Bukti (Disabled - Auto) -->
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-2">No Bukti (Otomatis)</label>
                    <input type="text" value="{{ $nextInvoice }}" disabled
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="jumlah_liter" id="jumlah_liter" value="{{ old('jumlah_liter') }}" required placeholder="Contoh: 150.50"
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" step="0.01" name="harga_per_liter" id="harga_per_liter" value="{{ old('harga_per_liter') }}" required placeholder="Contoh: 14500"
                ...
                <div>
                    ...
                    <input type="text" name="supplier" id="supplier" value="{{ old('supplier') }}" placeholder="Contoh: SPBU Batam Center"
                           class="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm focus:ring-2 focus:ring-blue-500 outline-none">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="nomor_nota" id="nomor_nota" value="{{ old('nomor_nota') }}" placeholder="Contoh: NOTA-12345"
                           class="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm focus:ring-2 focus:ring-blue-500 outline-none">
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="keterangan" id="keterangan" rows="3" placeholder="Masukkan keterangan tambahan..."
                              class="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm focus:ring-2 focus:ring-blue-500 outline-none">{{ old('keterangan') }}</textarea>
                </div>
            </div>
