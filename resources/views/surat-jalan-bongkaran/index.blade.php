                                    ...
                                    <td class="px-4 py-3 text-center">
                                        @if($bl->suratJalanBongkaran)
                                            @can('surat-jalan-bongkaran-update')
                                                <button type="button" onclick="event.stopPropagation(); editSuratJalan({{ $bl->suratJalanBongkaran->id }});"
                                                        title="Edit Surat Jalan" class="inline-flex items-center justify-center w-8 h-8 mr-2 bg-yellow-500 text-white rounded-full hover:bg-yellow-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-400 transition-colors duration-200">
                                        ...
                                        @else
                                            @can('surat-jalan-bongkaran-create')
                                                <button type="button" onclick="event.stopPropagation(); buatSuratJalan({{ $bl->id }});"
                                                        title="Buat Surat Jalan" class="inline-flex items-center justify-center w-8 h-8 mr-2 bg-indigo-600 text-white rounded-full hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-400 transition-colors duration-200">
                                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        @can('surat-jalan-bongkaran-update')
                                            <button type="button" onclick="event.stopPropagation(); editSuratJalan({{ $sj->id }});"
                                                    title="Edit" class="inline-flex items-center justify-center w-8 h-8 mr-2 bg-yellow-500 text-white rounded-full hover:bg-yellow-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-400 transition-colors duration-200">
                                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                                                </svg>
                                            </button>
