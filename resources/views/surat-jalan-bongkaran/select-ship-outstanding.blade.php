...
@section('title', 'Pilih Kapal & Voyage - Outstanding Surat Jalan Bongkaran')
...
<div class="flex-1 p-4 md:p-6">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between mb-4 md:mb-6">
        <div>
            <h1 class="text-xl md:text-2xl font-bold text-gray-900">Outstanding Surat Jalan Bongkaran</h1>
            <nav class="flex flex-wrap text-xs md:text-sm text-gray-600 mt-1 items-center">
                <a href="{{ route('dashboard') }}" class="hover:text-blue-600">Dashboard</a>
                <span class="mx-1 md:mx-2">/</span>
                <a href="{{ route('surat-jalan-bongkaran.outstanding') }}" class="hover:text-blue-600">Surat Jalan Bongkaran</a>
                <span class="mx-1 md:mx-2">/</span>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 max-w-2xl mx-auto">
        ...
        <div class="px-4 md:px-6 py-4 border-b border-gray-200">
            ...
            <p class="text-xs md:text-sm text-gray-600 mt-1">Silakan pilih kapal dan voyage untuk melihat data outstanding</p>
        </div>

        <!-- Card Body -->
        <div class="p-4 md:p-6">
            <form method="GET" action="{{ route('surat-jalan-bongkaran.outstanding') }}" id="selectShipForm">
                <div class="space-y-4 md:space-y-6">
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between pt-4 gap-3 sm:gap-0">
                        <a href="{{ route('surat-jalan-bongkaran.outstanding', ['view_all' => 1]) }}" 
