...
@section('content')
<h2 class="text-xl font-bold text-gray-800 mb-4">Edit Stock Ban</h2>
...
<div class="bg-white shadow-md rounded-lg p-6">
    <form action="{{ route('stock-ban.update', $stockBan->id) }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" 
                           name="kode_ban" 
                           id="kode_ban" 
                           value="{{ old('kode_ban', $stockBan->kode_ban) }}" 
                           class="{{ $inputClasses }}" 
                           required 
                           maxlength="50" 
                ...
                <div>
                    ...
                    <input type="text" 
                           name="ukuran_ban" 
                           id="ukuran_ban" 
                           value="{{ old('ukuran_ban', $stockBan->ukuran_ban) }}" 
                           class="{{ $inputClasses }}" 
                           required 
                           maxlength="50" 
                ...
                <div>
                    ...
                    <input type="text" 
                           name="merek" 
                           id="merek" 
                           value="{{ old('merek', $stockBan->merek) }}" 
                           class="{{ $inputClasses }}" 
                           required 
                           maxlength="100" 
                ...
                <div>
                    ...
                    <input type="number" 
                           name="jumlah" 
                           id="jumlah" 
                           value="{{ old('jumlah', $stockBan->jumlah) }}" 
                           class="{{ $inputClasses }}" 
                           required 
                           min="0" 
                ...
                <div>
                    ...
                    <select name="lokasi" id="lokasi" class="{{ $inputClasses }}" required>
                        ...
                        <option value="BTM" {{ old('lokasi', $stockBan->lokasi) == 'BTM' ? 'selected' : '' }}>BTM</option>
                        <option value="JKT" {{ old('lokasi', $stockBan->lokasi) == 'JKT' ? 'selected' : '' }}>JKT</option>
                        <option value="PNG" {{ old('lokasi', $stockBan->lokasi) == 'PNG' ? 'selected' : '' }}>PNG</option>
                    </select>
                    @error('lokasi')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <div class="mt-1 relative rounded-md shadow-sm">
                        ...
                        <input type="number" 
                               name="harga_satuan" 
                               id="harga_satuan" 
                               value="{{ old('harga_satuan', $stockBan->harga_satuan) }}" 
                ...
                <div>
                    ...
                    <input type="date" 
                           name="tanggal_masuk" 
                           id="tanggal_masuk" 
                           value="{{ old('tanggal_masuk', $stockBan->tanggal_masuk) }}" 
                           class="{{ $inputClasses }}">
                    @error('tanggal_masuk')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <input type="text" 
                           name="supplier" 
                           id="supplier" 
                           value="{{ old('supplier', $stockBan->supplier) }}" 
                           class="{{ $inputClasses }}" 
                           maxlength="200" 
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="keterangan" 
                              ...
                              rows="3" 
                              class="{{ $inputClasses }}" 
                              placeholder="Keterangan tambahan (opsional)">{{ old('keterangan', $stockBan->keterangan) }}</textarea>
                    @error('keterangan')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
        ...
        <div class="mb-6 p-4 bg-gray-50 rounded-lg border border-gray-200">
            <h3 class="text-sm font-semibold text-gray-700 mb-2">Informasi Audit</h3>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-2 text-xs text-gray-600">
                ...
                <div>
                    <span class="font-medium">Diubah pada:</span> 
