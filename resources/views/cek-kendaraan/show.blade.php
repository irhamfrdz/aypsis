...
@section('title', 'Detail Monitoring Cek Kendaraan - AYPSIS')
...
<div class="container mx-auto px-4 py-8">
    <div class="flex items-center justify-between mb-8">
        <div class="flex items-center space-x-4">
            <a href="{{ route('admin.cek-kendaraan.index') }}" class="p-2 bg-white hover:bg-gray-100 rounded-full transition-all border shadow-sm">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="space-y-8">
            ...
            <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-200">
                ...
                @elseif($cekKendaraan->pernyataan == 'tidak_layak')
                ...
                @else
                    <div class="bg-gray-50 border border-gray-100 rounded-2xl p-4">
                        <p class="text-xs text-gray-400 font-medium italic">Belum ada pernyataan.</p>
                    </div>
                @endif
            </div>
