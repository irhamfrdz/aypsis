...
@section('title', 'Edit Pembayaran Aktivitas Lainnya')
    ...
    <div class="bg-white shadow-lg rounded-lg">
        <div class="bg-white border-b border-gray-200 px-6 py-4 flex justify-between items-center rounded-t-lg">
            <h3 class="text-xl font-semibold text-gray-800 flex items-center">
                ...
                Edit Pembayaran Aktivitas Lainnya
            </h3>
            <a href="{{ route('pembayaran-aktivitas-lainnya.show', $pembayaranAktivitasLainnya) }}" class="inline-flex items-center px-3 py-2 bg-gray-600 hover:bg-gray-700 text-white font-medium text-xs rounded-md transition duration-150 ease-in-out">
                <i class="fas fa-arrow-left mr-2"></i> Kembali
            </a>
        </div>

        <form action="{{ route('pembayaran-aktivitas-lainnya.update', $pembayaranAktivitasLainnya) }}" method="POST" class="p-6" id="pembayaran_form">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="date" name="tanggal_pembayaran" id="tanggal_pembayaran"
                           value="{{ old('tanggal_pembayaran', $pembayaranAktivitasLainnya->tanggal_pembayaran->format('Y-m-d')) }}"
                ...
                <div>
                    ...
                    <input type="text" name="nomor_accurate" id="nomor_accurate"
                           value="{{ old('nomor_accurate', $pembayaranAktivitasLainnya->nomor_accurate) }}"
                ...
                <div>
                    ...
                    <select name="pilih_bank" id="pilih_bank"
                        ...
                        @foreach($bankAccounts as $bank)
                            <option value="{{ $bank->id }}" {{ old('pilih_bank', $pembayaranAktivitasLainnya->pilih_bank) == $bank->id ? 'selected' : '' }}>
                ...
                <div>
                    ...
                    <select name="akun_biaya_id" id="akun_biaya_id"
                        ...
                        @foreach($coaBiaya as $coa)
                            <option value="{{ $coa->id }}" {{ old('akun_biaya_id', $pembayaranAktivitasLainnya->akun_biaya_id) == $coa->id ? 'selected' : '' }}>
                ...
                <div>
                    ...
                    <select name="jenis_transaksi" id="jenis_transaksi"
                        ...
                        <option value="kredit" {{ old('jenis_transaksi', $pembayaranAktivitasLainnya->jenis_transaksi) == 'kredit' ? 'selected' : '' }}>Kredit (Pengeluaran)</option>
                        <option value="debit" {{ old('jenis_transaksi', $pembayaranAktivitasLainnya->jenis_transaksi) == 'debit' ? 'selected' : '' }}>Debit (Pemasukan)</option>
                    </select>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="total_pembayaran" id="total_pembayaran"
                               value="{{ old('total_pembayaran', number_format($pembayaranAktivitasLainnya->total_pembayaran, 0, ',', '.')) }}"
            ...
            <div class="mt-6">
                ...
                <textarea name="aktivitas_pembayaran" id="aktivitas_pembayaran" rows="4"
                          ...
                          placeholder="Jelaskan aktivitas pembayaran yang dilakukan..." required>{{ old('aktivitas_pembayaran', $pembayaranAktivitasLainnya->aktivitas_pembayaran) }}</textarea>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
                ...
                <div>
                    ...
                    <input type="text" name="nomor_voyage" id="nomor_voyage"
                           value="{{ old('nomor_voyage', $pembayaranAktivitasLainnya->nomor_voyage) }}"
                ...
                <div>
                    ...
                    <input type="text" name="nama_kapal" id="nama_kapal"
                           value="{{ old('nama_kapal', $pembayaranAktivitasLainnya->nama_kapal) }}"
                ...
                <div>
                    ...
                    <input type="text" name="plat_nomor" id="plat_nomor"
                           value="{{ old('plat_nomor', $pembayaranAktivitasLainnya->plat_nomor) }}"
            ...
            <div class="mt-8 flex justify-end space-x-4">
                <a href="{{ route('pembayaran-aktivitas-lainnya.show', $pembayaranAktivitasLainnya) }}" class="inline-flex items-center px-4 py-2 bg-gray-600 hover:bg-gray-700 text-white font-medium text-sm rounded-md transition duration-150 ease-in-out">
...
document.querySelector('input[name="is_dp"]').addEventListener('change', function() {
    ...
    if (this.checked) {
        ...
        if (document.querySelectorAll('.supir-row').length === 0) {
            addSupirRow();
        }
    } else {
...
// Supir management
let supirRowCount = {{ $pembayaranAktivitasLainnya->supirList->count() }};
    ...
    row.innerHTML = `
        ...
        <div class="md:col-span-2">
            ...
            <div class="flex space-x-2">
                ...
                <button type="button" onclick="removeSupirRow(this)" class="px-3 py-2 bg-red-600 hover:bg-red-700 text-white rounded-md">
...
function removeSupirRow(button) {
    button.closest('.supir-row').remove();
}
