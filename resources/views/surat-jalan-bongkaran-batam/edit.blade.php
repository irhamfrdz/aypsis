...
<div class="container mx-auto px-4 py-4">
    ...
    @endif
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <!-- Gudang Tujuan -->
                <div>
                    <label for="gudang_tujuan" class="block text-sm font-medium text-gray-700 mb-1">Gudang Tujuan <span class="text-red-500">*</span></label>
                    <select name="gudang_tujuan" id="gudang_tujuan" required
