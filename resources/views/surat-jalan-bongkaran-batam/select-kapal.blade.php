...
<div class="flex-1 p-6">
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 max-w-4xl mx-auto">
        ...
        <!-- Card Body -->
        <div class="p-6">
            <form action="{{ route('surat-jalan-bongkaran-batam.create') }}" method="GET" class="space-y-6" id="kapalForm">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    kapalSelect.addEventListener('change', function() {
        ...
        fetch(`{{ route('surat-jalan-bongkaran-batam.bl-data', [], false) }}?nama_kapal=${encodeURIComponent(namaKapal)}`)
