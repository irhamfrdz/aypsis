...
<div class="flex-1 p-4 md:p-6">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between mb-4 md:mb-6">
        <div>
            ...
            <nav class="flex flex-wrap text-xs md:text-sm text-gray-600 mt-1 items-center">
                ...
                <a href="{{ route('surat-jalan-bongkaran-batam.select-ship') }}" class="hover:text-blue-600">Surat Jalan Bongkaran</a>
                <span class="mx-1 md:mx-2">/</span>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 max-w-2xl mx-auto">
        ...
        <div class="p-4 md:p-6">
            <form method="GET" action="{{ $targetRoute ?? route('surat-jalan-bongkaran-batam.list') }}" id="selectShipForm">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function loadVoyages(kapalName) {
        ...
        fetch(`{{ route('surat-jalan-bongkaran-batam.get-voyages', [], false) }}?nama_kapal=${encodeURIComponent(kapalName)}`)
