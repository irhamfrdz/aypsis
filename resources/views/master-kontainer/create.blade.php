            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <select name="tipe_kontainer" id="tipe_kontainer" class="{{ $inputClasses }}" required>
                        ...
                        <option value="FREE USE" {{ old('tipe_kontainer') == 'FREE USE' ? 'selected' : '' }}>FREE USE</option>
                    </select>
                ...
                <div>
                    ...
                    <select name="vendor" id="vendor" class="{{ $inputClasses }}">
                        ...
                        <option value="SOC" {{ old('vendor') == 'SOC' ? 'selected' : '' }}>SOC</option>
                        <option value="FREEUSE" {{ old('vendor') == 'FREEUSE' ? 'selected' : '' }}>FREEUSE</option>
                    </select>
                    @error('vendor')
                        <p class="mt-2 text-xs text-red-600">{{ $message }}</p>
                    @enderror
