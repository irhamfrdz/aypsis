            ...
            <form action="{{ route('master.buruh.update', $buruh->id) }}" method="POST" class="p-8">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="nik" id="nik" value="{{ old('nik', $buruh->nik) }}"
                    ...
                    <div>
                        ...
                        <div class="flex gap-4">
                            <label class="relative flex items-center p-3 rounded-xl border border-gray-200 cursor-pointer hover:bg-gray-50 transition-colors w-1/2">
                                <input type="radio" name="status_bpjs" value="aktif" {{ old('status_bpjs', $buruh->status_bpjs) == 'aktif' ? 'checked' : '' }} class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300">
                                <span class="ml-3 flex flex-col">
                                    <span class="block text-sm font-medium text-gray-900">Aktif</span>
                            ...
                            <label class="relative flex items-center p-3 rounded-xl border border-gray-200 cursor-pointer hover:bg-gray-50 transition-colors w-1/2">
                                <input type="radio" name="status_bpjs" value="tidak aktif" {{ old('status_bpjs', $buruh->status_bpjs ?? 'tidak aktif') == 'tidak aktif' ? 'checked' : '' }} class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300">
                                <span class="ml-3 flex flex-col">
