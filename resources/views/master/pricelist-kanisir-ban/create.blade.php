...
@section('title', 'Tambah Master Pricelist Kanisir Ban')
@section('page_title', 'Tambah Master Pricelist Kanisir Ban')
...
<div class="min-h-screen bg-gray-50 py-8">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white shadow-lg rounded-lg overflow-hidden mb-6">
            <div class="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-4">
                <div class="flex items-center">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-white">Tambah Master Pricelist Kanisir Ban</h1>
                        <p class="text-blue-100 text-sm">Buat pricelist kanisir ban baru</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white shadow-lg rounded-lg overflow-hidden">
            <form action="{{ route('master.pricelist-kanisir-ban.store') }}" method="POST" class="p-6">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="harga_1000_kawat" id="harga_1000_kawat" value="{{ old('harga_1000_kawat', 0) }}"
                                   min="0"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <span class="absolute left-3 top-2 text-gray-500">Rp</span>
                            <input type="number" name="harga_1000_benang" id="harga_1000_benang" value="{{ old('harga_1000_benang', 0) }}"
                                   min="0"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <span class="absolute left-3 top-2 text-gray-500">Rp</span>
                            <input type="number" name="harga_900_kawat" id="harga_900_kawat" value="{{ old('harga_900_kawat', 0) }}"
                                   min="0"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <span class="absolute left-3 top-2 text-gray-500">Rp</span>
                            <input type="number" name="harga_900_benang" id="harga_900_benang" value="{{ old('harga_900_benang', 0) }}"
                                   min="0"
