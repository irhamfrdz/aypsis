            ...
            <div class="col-span-1 md:col-span-2 bg-gray-50 p-4 rounded-lg border border-gray-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="notify_party" id="notify_party" value="{{ old('notify_party', $shipper_consignee->notify_party) }}" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 text-xs">
                    </div>
                    <div>
                        ...
                        <input type="text" name="npwp_notify_party" id="npwp_notify_party" value="{{ old('npwp_notify_party', $shipper_consignee->npwp_notify_party) }}" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 text-xs">
                    </div>
                    <div class="md:col-span-2">
                        <label for="alamat_notify_party" class="block text-xs font-semibold text-gray-700 mb-1">Address (Notify Party Consignee)</label>
                        <textarea name="alamat_notify_party" id="alamat_notify_party" rows="2" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 text-xs">{{ old('alamat_notify_party', $shipper_consignee->alamat_notify_party) }}</textarea>
                    </div>
                </div>
            </div>
        </div>
