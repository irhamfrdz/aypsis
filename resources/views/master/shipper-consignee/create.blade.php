...
@section('title', 'Tambah Shipper / Consignee')
@section('page_title', 'Tambah Shipper / Consignee')
...
<div class="bg-white shadow-md rounded-lg p-6 max-w-4xl mx-auto" style="font-family: Arial, sans-serif; font-size: 11px;">
    <div class="flex justify-between items-center mb-6 border-b pb-4">
        <h2 class="text-xl font-bold text-gray-800">Tambah Data Shipper / Consignee</h2>
    ...
    <form action="{{ route('master.shipper-consignee.store') }}" method="POST">
        @csrf
            ...
            <div class="col-span-1 md:col-span-2 bg-gray-50 p-4 rounded-lg border border-gray-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="telepon" id="telepon" value="{{ old('telepon') }}" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 text-xs">
                    </div>
                    <div>
                        <label for="alamat_email" class="block text-xs font-semibold text-gray-700 mb-1">Alamat Email</label>
                        <input type="email" name="alamat_email" id="alamat_email" value="{{ old('alamat_email') }}" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 text-xs">
                    </div>
                    <div>
                        <label for="hs_code" class="block text-xs font-semibold text-gray-700 mb-1">HS Code</label>
                        <input type="text" name="hs_code" id="hs_code" value="{{ old('hs_code') }}" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 text-xs">
                    </div>
                    <div>
            ...
            <div class="col-span-1 bg-gray-50 p-4 rounded-lg border border-gray-200">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" name="shipper" id="shipper" value="{{ old('shipper') }}" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 text-xs">
                    </div>
                    <div>
                        <label for="alamat_shipper" class="block text-xs font-semibold text-gray-700 mb-1">Address (Shipper)</label>
                        <textarea name="alamat_shipper" id="alamat_shipper" rows="2" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 text-xs">{{ old('alamat_shipper') }}</textarea>
                    </div>
                    <div>
                        <label for="npwp_shipper" class="block text-xs font-semibold text-gray-700 mb-1">No Identitas (NPWP Shipper)</label>
                        <input type="text" name="npwp_shipper" id="npwp_shipper" value="{{ old('npwp_shipper') }}" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 text-xs">
                    </div>
                    <div>
                        <label for="nitku_shipper" class="block text-xs font-semibold text-gray-700 mb-1">NITKU Shipper</label>
                        <input type="text" name="nitku_shipper" id="nitku_shipper" value="{{ old('nitku_shipper') }}" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 text-xs">
                    </div>
                    <div>
                        <label for="contact_person" class="block text-xs font-semibold text-gray-700 mb-1">Contact Person</label>
                        <div class="flex">
                            <input type="text" name="contact_person" id="contact_person" value="{{ old('contact_person') }}" class="w-full px-3 py-2 border border-gray-300 rounded-l-md focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 text-xs">
            ...
            <div class="col-span-1 bg-gray-50 p-4 rounded-lg border border-gray-200">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" name="consignee" id="consignee" value="{{ old('consignee') }}" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 text-xs">
                    </div>
                    <div>
                        <label for="alamat_consignee" class="block text-xs font-semibold text-gray-700 mb-1">Address (Consignee)</label>
                        <textarea name="alamat_consignee" id="alamat_consignee" rows="2" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 text-xs">{{ old('alamat_consignee') }}</textarea>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="text" name="nitku_consignee" id="nitku_consignee" value="{{ old('nitku_consignee') }}" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 text-xs">
                    </div>
                </div>
            </div>
