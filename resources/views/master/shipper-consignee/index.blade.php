...
<div class="bg-white shadow-md rounded-lg p-6" style="font-family: Arial, sans-serif; font-size: 10px;">
    <div class="flex justify-between items-center mb-6">
        ...
        <div class="flex items-center space-x-3">
            ...
            <a href="{{ route('master.shipper-consignee.create') }}" class="bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded-lg transition duration-300">+ Tambah Data</a>
            @endcan
        </div>
    </div>
