...
<div class="min-h-screen bg-gray-50 py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="overflow-hidden rounded-lg bg-white shadow">
            ...
            @forelse($pricelists as $pricelist)<tr><td class="px-5 py-4 text-sm">{{ $pricelist->size_kontainer_label }}</td><td class="px-5 py-4 text-sm">{{ $pricelist->status_kontainer_label ?: 'Tidak berlaku' }}</td><td class="px-5 py-4 text-sm">{{ $pricelist->status_service_label }}</td><td class="px-5 py-4 text-sm font-medium">{{ $pricelist->formatted_biaya }}</td><td class="px-5 py-4 text-sm">{{ $pricelist->keterangan ?: '-' }}</td><td class="px-5 py-4 text-right text-sm">
