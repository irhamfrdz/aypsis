...
@section('title', 'Tambah Master Pricelist Gate Pelabuhan Sunda Kelapa')
@section('page_title', 'Tambah Master Pricelist Gate Pelabuhan Sunda Kelapa')
        ...
        <div class="bg-white shadow-lg rounded-lg overflow-hidden mb-6">
            <div class="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-4">
                <div class="flex items-center">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-white">Tambah Master Pricelist Gate Pelabuhan Sunda Kelapa</h1>
                        <p class="text-blue-100 text-sm">Buat pricelist gate pelabuhan sunda kelapa baru</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <form action="{{ route('master.pricelist-gate-in.store') }}" method="POST" class="p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="pelabuhan" id="pelabuhan" value="{{ old('pelabuhan') }}"
                    ...
                    <div>
                        ...
                        <select name="kegiatan" id="kegiatan"
                            ...
                            <option value="BATAL MUAT" {{ old('kegiatan') == 'BATAL MUAT' ? 'selected' : '' }}>BATAL MUAT</option>
                            <option value="CHANGE VASSEL" {{ old('kegiatan') == 'CHANGE VASSEL' ? 'selected' : '' }}>CHANGE VASSEL</option>
                            <option value="DELIVERY" {{ old('kegiatan') == 'DELIVERY' ? 'selected' : '' }}>DELIVERY</option>
                            <option value="DISCHARGE" {{ old('kegiatan') == 'DISCHARGE' ? 'selected' : '' }}>DISCHARGE</option>
                            <option value="DISCHARGE TL" {{ old('kegiatan') == 'DISCHARGE TL' ? 'selected' : '' }}>DISCHARGE TL</option>
                            <option value="LOADING" {{ old('kegiatan') == 'LOADING' ? 'selected' : '' }}>LOADING</option>
                            <option value="PENUMPUKAN BPRP" {{ old('kegiatan') == 'PENUMPUKAN BPRP' ? 'selected' : '' }}>PENUMPUKAN BPRP</option>
                            <option value="PERPANJANGAN DELIVERY" {{ old('kegiatan') == 'PERPANJANGAN DELIVERY' ? 'selected' : '' }}>PERPANJANGAN DELIVERY</option>
                            <option value="RECEIVING" {{ old('kegiatan') == 'RECEIVING' ? 'selected' : '' }}>RECEIVING</option>
                            <option value="RECEIVING LOSING" {{ old('kegiatan') == 'RECEIVING LOSING' ? 'selected' : '' }}>RECEIVING LOSING</option>
                        </select>
                        @error('kegiatan')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <select name="biaya" id="biaya"
                            ...
                            <option value="ADMINISTRASI" {{ old('biaya') == 'ADMINISTRASI' ? 'selected' : '' }}>ADMINISTRASI</option>
                            <option value="DERMAGA" {{ old('biaya') == 'DERMAGA' ? 'selected' : '' }}>DERMAGA</option>
                            <option value="HAULAGE" {{ old('biaya') == 'HAULAGE' ? 'selected' : '' }}>HAULAGE</option>
                            <option value="LOLO" {{ old('biaya') == 'LOLO' ? 'selected' : '' }}>LOLO</option>
                            <option value="MASA 1A" {{ old('biaya') == 'MASA 1A' ? 'selected' : '' }}>MASA 1A</option>
                            <option value="MASA 1B" {{ old('biaya') == 'MASA 1B' ? 'selected' : '' }}>MASA 1B</option>
                            <option value="MASA2" {{ old('biaya') == 'MASA2' ? 'selected' : '' }}>MASA2</option>
                            <option value="STEVEDORING" {{ old('biaya') == 'STEVEDORING' ? 'selected' : '' }}>STEVEDORING</option>
                            <option value="STRIPPING" {{ old('biaya') == 'STRIPPING' ? 'selected' : '' }}>STRIPPING</option>
                            <option value="STUFFING" {{ old('biaya') == 'STUFFING' ? 'selected' : '' }}>STUFFING</option>
                        </select>
                        @error('biaya')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <select name="gudang" id="gudang"
                            ...
                            <option value="CY" {{ old('gudang') == 'CY' ? 'selected' : '' }}>CY</option>
                            <option value="DERMAGA" {{ old('gudang') == 'DERMAGA' ? 'selected' : '' }}>DERMAGA</option>
                            <option value="SS" {{ old('gudang') == 'SS' ? 'selected' : '' }}>SS</option>
                        </select>
                        @error('gudang')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <select name="kontainer" id="kontainer"
                            ...
                            <option value="20" {{ old('kontainer') == '20' ? 'selected' : '' }}>20 Feet</option>
                            <option value="40" {{ old('kontainer') == '40' ? 'selected' : '' }}>40 Feet</option>
                        </select>
                        @error('kontainer')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <select name="muatan" id="muatan"
                            ...
                            <option value="EMPTY" {{ old('muatan') == 'EMPTY' ? 'selected' : '' }}>EMPTY</option>
                            <option value="FULL" {{ old('muatan') == 'FULL' ? 'selected' : '' }}>FULL</option>
                        </select>
                        @error('muatan')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
