...
@section('title', 'Import Tujuan Kirim CSV')
@section('page_title', 'Import Tujuan Kirim CSV')
...
<div class="min-h-screen bg-gray-50 py-6">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                <div class="mb-4 sm:mb-0">
                    <h1 class="text-3xl font-bold text-gray-900">Import Tujuan Kirim CSV</h1>
                    <p class="mt-1 text-sm text-gray-600">Upload file CSV untuk import data tujuan kirim secara massal</p>
                </div>
            ...
            <div class="flex items-start">
                ...
                <div>
                    ...
                    <div class="text-sm text-blue-700 space-y-2">
                        ...
                        <p><strong>3. Header Kolom:</strong> kode, nama_tujuan, catatan, status</p>
                        <p><strong>4. Ketentuan Data:</strong></p>
                        <ul class="ml-4 space-y-1">
                            <li>• <strong>kode:</strong> Wajib diisi, maksimal 10 karakter, harus unik</li>
                            <li>• <strong>nama_tujuan:</strong> Wajib diisi, maksimal 100 karakter</li>
                            <li>• <strong>catatan:</strong> Opsional, maksimal 500 karakter</li>
                            <li>• <strong>status:</strong> Opsional, nilai: 'active' atau 'inactive' (default: active jika kosong)</li>
                        </ul>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <form action="{{ route('tujuan-kirim.import.process') }}" method="POST" enctype="multipart/form-data" class="p-6">
                @csrf
                ...
                <div class="mb-6 p-4 bg-gray-50 rounded-lg">
                    ...
                    <div class="bg-white p-3 rounded border font-mono text-xs overflow-x-auto">
                        <div class="text-gray-600">kode;nama_tujuan;catatan;status</div>
                        <div class="text-gray-800">JKT001;Jakarta Pusat;Pelabuhan Tanjung Priok;active</div>
                        <div class="text-gray-800">SBY002;Surabaya Timur;;inactive</div>
                        <div class="text-gray-800">BDG003;Bandung;;</div>
                        <div class="text-gray-500 text-xs mt-1">* Status akan default ke 'active' jika kosong</div>
                    </div>
                </div>
