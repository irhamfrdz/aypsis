...
@section('title', 'Tambah Pricelist Tanto')
    ...
    <div class="max-w-3xl mx-auto">
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div class="flex items-center justify-between mb-8">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900">Tambah Pricelist Tanto</h1>
                    <p class="text-gray-600 mt-1">Masukkan data tarif baru untuk Tanto</p>
                </div>
            ...
            <form action="{{ route('master.pricelist-tanto.store') }}" method="POST">
                @csrf
                <div class="space-y-6">
                    <div>
