...
@section('title', 'Tambah Pricelist TKBM')
    ...
    <div class="max-w-3xl mx-auto">
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div class="mb-6 border-b border-gray-200 pb-4">
                <h1 class="text-2xl font-bold text-gray-900">Tambah Pricelist TKBM</h1>
            </div>

            <form action="{{ route('master.pricelist-tkbm.store') }}" method="POST">
                @csrf
