...
@section('title', 'Edit Vendor Asuransi')
    ...
    <div class="max-w-2xl mx-auto">
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <div class="flex items-center justify-between mb-6">
                <div>
                    <h1 class="text-2xl font-bold text-gray-800">Edit Vendor Asuransi</h1>
                    <p class="text-gray-600 mt-1">Perbarui data vendor asuransi</p>
                </div>
            ...
            <!-- Form -->
            <form action="{{ route('master.vendor-asuransi.update', $vendorAsuransi) }}" method="POST" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" id="nama_asuransi" name="nama_asuransi" value="{{ old('nama_asuransi', $vendorAsuransi->nama_asuransi) }}"
                ...
                <div>
                    ...
                    <textarea id="alamat" name="alamat" rows="2"
                              class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                              placeholder="Alamat lengkap kantor asuransi...">{{ old('alamat', $vendorAsuransi->alamat) }}</textarea>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" id="telepon" name="telepon" value="{{ old('telepon', $vendorAsuransi->telepon) }}"
                               class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    ...
                    <div>
                        ...
                        <input type="email" id="email" name="email" value="{{ old('email', $vendorAsuransi->email) }}"
                               class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                ...
                <!-- Tarif -->
                <div>
                    <label for="tarif" class="block text-sm font-medium text-gray-700 mb-2">Tarif (%)</label>
                    <div class="relative">
                        <input type="number" id="tarif" name="tarif" value="{{ old('tarif', $vendorAsuransi->tarif) }}" step="0.01" min="0" max="100"
                               class="w-full border border-gray-300 rounded-lg pl-3 pr-10 py-2 focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                               placeholder="0.00">
                        <span class="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-500">%</span>
                    </div>
                    @error('tarif') <p class="mt-1 text-sm text-red-600">{{ $message }}</p> @enderror
                </div>

                <!-- Keterangan -->
                <div>
                    <label for="keterangan" class="block text-sm font-medium text-gray-700 mb-2">Keterangan</label>
                    <input type="text" id="keterangan" name="keterangan" value="{{ old('keterangan', $vendorAsuransi->keterangan) }}"
                           class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                ...
                <div>
                    ...
                    <textarea id="catatan" name="catatan" rows="3"
                              class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                              placeholder="Catatan tambahan seperti nama PIC, dll...">{{ old('catatan', $vendorAsuransi->catatan) }}</textarea>
