    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900">Import Term</h1>
                    <p class="text-gray-600 mt-1">Upload file CSV untuk mengimport data Term</p>
                </div>
                <a href="{{ route('term.index') }}" class="bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded-lg transition duration-200">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <form action="{{ route('term.import.process') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                @csrf
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            ...
                            <div class="mt-2 text-sm text-blue-700">
                                ...
                                <a href="{{ route('term.download-template') }}" class="inline-flex items-center mt-2 px-3 py-1 border border-blue-300 shadow-sm text-sm leading-4 font-medium rounded-md text-blue-700 bg-white hover:bg-blue-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                    ...
                    <div class="flex">
                        <div class="text-sm text-yellow-700">
                            <ul class="list-disc pl-5 space-y-1">
                                ...
                                <li>Header kolom harus: kode;nama_status;catatan;status</li>
                                <li>Kolom status harus berisi: 1 (aktif) atau 0 (tidak aktif)</li>
