...
@section('page_title', 'Master Pricelist Lembur')
...
<div class="container mx-auto px-4 py-6">
    <div class="mb-6">
        <div class="flex flex-col md:flex-row justify-between items-center gap-4">
            <div>
                <h1 class="text-2xl font-bold text-gray-800">Pricelist Lembur</h1>
                <p class="text-gray-600 mt-1">Kelola data nominal lembur dan nginap</p>
            </div>
            @can('master-pricelist-lembur-create')
            <a href="{{ route('master.pricelist-lembur.create') }}" 
    ...
    <div class="bg-white rounded-lg shadow p-4 mb-6">
        <form action="{{ route('master.pricelist-lembur.index') }}" method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div>
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                            <div class="flex justify-center gap-2">
                                @can('master-pricelist-lembur-update')
                                <a href="{{ route('master.pricelist-lembur.edit', $pricelist) }}" 
                                ...
                                @can('master-pricelist-lembur-delete')
                                <form action="{{ route('master.pricelist-lembur.destroy', $pricelist) }}" 
                                      method="POST" 
