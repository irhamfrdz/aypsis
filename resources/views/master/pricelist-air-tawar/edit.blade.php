...
@section('title', 'Edit Master Pricelist Air Tawar')
@section('page_title', 'Edit Master Pricelist Air Tawar')
...
<div class="min-h-screen bg-gray-50 py-8">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white shadow-lg rounded-lg overflow-hidden mb-6">
            <div class="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-4">
                <div class="flex items-center">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-white">Edit Master Pricelist Air Tawar</h1>
                        <p class="text-blue-100 text-sm">Edit pricelist air tawar #{{ $pricelistAirTawar->id }}</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white shadow-lg rounded-lg overflow-hidden">
            <form action="{{ route('master.pricelist-air-tawar.update', $pricelistAirTawar) }}" method="POST" class="p-6">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="nama_agen" id="nama_agen" value="{{ old('nama_agen', $pricelistAirTawar->nama_agen) }}"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="harga" id="harga" value="{{ old('harga', $pricelistAirTawar->harga) }}"
                                   step="0.01" min="0"
                    ...
                    <div>
                        ...
                        <textarea name="keterangan" id="keterangan" rows="4"
                                  ...
                                  placeholder="Masukkan keterangan tambahan (opsional)">{{ old('keterangan', $pricelistAirTawar->keterangan) }}</textarea>
                        @error('keterangan')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
