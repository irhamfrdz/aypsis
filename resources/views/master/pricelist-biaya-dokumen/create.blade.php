...
<div class="container mx-auto px-4 py-6">
    <div class="mb-6">
        <div class="flex justify-between items-center">
            <div>
                <h1 class="text-2xl font-bold text-gray-800">Tambah Pricelist Biaya Dokumen</h1>
                <p class="text-gray-600 mt-1">Tambah data pricelist biaya dokumen baru</p>
            </div>
    ...
    <form action="{{ route('master.pricelist-biaya-dokumen.store') }}" method="POST" class="space-y-6">
        @csrf
