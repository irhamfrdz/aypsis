...
@section('title', 'Detail Pembayaran Pranota Stock')
@section('page_title', 'Detail Pembayaran Pranota Stock')
...
<div class="max-w-4xl mx-auto">
    <div class="bg-white shadow-xl rounded-lg overflow-hidden border border-gray-200">
                ...
                <div class="border rounded-lg overflow-hidden">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="divide-y divide-gray-100 bg-white">
                            ...
                            <tr>
                                <td class="px-4 py-2 text-sm font-medium">{{ $pranota->nomor_pranota }}</td>
                                <td class="px-4 py-2 text-sm text-gray-500">{{ $pranota->vendor ?? '-' }}</td>
        ...
        <div class="bg-gray-50 px-6 py-4 flex justify-between border-t border-gray-200">
            <a href="{{ route('pembayaran-pranota-stock.index') }}" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-100">
