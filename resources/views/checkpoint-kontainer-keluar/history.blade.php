            ...
            <form method="GET" action="{{ route('checkpoint-kontainer-keluar.history') }}" class="space-y-4">
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div class="flex items-end gap-2">
                        ...
                        <a href="{{ route('checkpoint-kontainer-keluar.export-excel', request()->all()) }}" 
                           class="flex-1 px-4 py-2 bg-green-600 text-white text-sm font-medium rounded-lg hover:bg-green-700 transition-colors text-center inline-flex items-center justify-center">
