...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-2xl mx-auto">
        <div class="mb-6">
            ...
            <h1 class="text-2xl font-bold text-gray-800 mt-2">Tambah Pricelist Vendor Supir</h1>
        </div>

        <div class="bg-white rounded-lg shadow-md p-6">
            <form action="{{ route('master.pricelist-vendor-supir.store') }}" method="POST">
                @csrf
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <select name="jenis_kontainer" id="jenis_kontainer" required
                            ...
                            <option value="20" {{ old('jenis_kontainer') == '20' ? 'selected' : '' }}>20 Feet</option>
                            <option value="40" {{ old('jenis_kontainer') == '40' ? 'selected' : '' }}>40 Feet</option>
                            <option value="45" {{ old('jenis_kontainer') == '45' ? 'selected' : '' }}>45 Feet</option>
                        </select>
