...
<div class="min-h-screen bg-gray-50 py-6">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4 mb-6">
            <form action="{{ route('cuti.index') }}" method="GET" class="flex flex-col sm:flex-row items-center gap-4">
                ...
                <div>
                    <a href="{{ route('cuti.index') }}" class="text-sm text-indigo-600 hover:text-indigo-900">Reset Filter</a>
                </div>
                @endif
            </form>
        </div>
