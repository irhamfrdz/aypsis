...
<div class="bg-white shadow-md rounded-lg p-6">
    <div class="mb-6">
        <h2 class="text-2xl font-bold text-gray-800 mb-2">Form Edit Data Transportasi</h2>
        <p class="text-gray-600 text-sm">Silakan edit form di bawah ini untuk mengubah data transportasi</p>
    </div>
        ...
        <div class="mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="kode" id="kode" value="{{ old('kode', $tujuanKegiatanUtama->kode) }}" 
                ...
                <div>
                    ...
                    <input type="text" name="cabang" id="cabang" value="{{ old('cabang', $tujuanKegiatanUtama->cabang) }}" 
                           class="w-full bg-gray-50 border border-gray-300 rounded-lg p-3 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200" 
                ...
                <div>
                    ...
                    <input type="text" name="wilayah" id="wilayah" value="{{ old('wilayah', $tujuanKegiatanUtama->wilayah) }}" 
                           class="w-full bg-gray-50 border border-gray-300 rounded-lg p-3 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200" 
        ...
        <div class="mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="dari" id="dari" value="{{ old('dari', $tujuanKegiatanUtama->dari) }}" 
                           class="w-full bg-gray-50 border border-gray-300 rounded-lg p-3 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200" 
                ...
                <div>
                    ...
                    <input type="text" name="ke" id="ke" value="{{ old('ke', $tujuanKegiatanUtama->ke) }}" 
                           class="w-full bg-gray-50 border border-gray-300 rounded-lg p-3 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200" 
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="jarak_dari_penjaringan_km" id="jarak_dari_penjaringan_km" value="{{ old('jarak_dari_penjaringan_km', $tujuanKegiatanUtama->jarak_dari_penjaringan_km) }}" 
                           class="w-full bg-gray-50 border border-gray-300 rounded-lg p-3 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200" 
                           placeholder="0.00">
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="liter" id="liter" value="{{ old('liter', $tujuanKegiatanUtama->liter) }}" 
                           class="w-full bg-gray-50 border border-gray-300 rounded-lg p-3 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200" 
                           placeholder="0.00">
                    @error('liter')
                        <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" step="0.01" name="uang_jalan_20ft" id="uang_jalan_20ft" value="{{ old('uang_jalan_20ft', $tujuanKegiatanUtama->uang_jalan_20ft) }}" 
                ...
                <div>
                    ...
                    <div class="relative">
                        <span class="absolute left-3 top-3 text-gray-500 text-sm">Rp</span>
                        <input type="number" step="0.01" name="mel_20ft" id="mel_20ft" value="{{ old('mel_20ft', $tujuanKegiatanUtama->mel_20ft) }}" 
                               class="w-full bg-gray-50 border border-gray-300 rounded-lg p-3 pl-8 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200" 
                               placeholder="0.00">
                    </div>
                    @error('mel_20ft')
                ...
                <div>
                    ...
                    <div class="relative">
                        <span class="absolute left-3 top-3 text-gray-500 text-sm">Rp</span>
                        <input type="number" step="0.01" name="ongkos_truk_20ft" id="ongkos_truk_20ft" value="{{ old('ongkos_truk_20ft', $tujuanKegiatanUtama->ongkos_truk_20ft) }}" 
                               class="w-full bg-gray-50 border border-gray-300 rounded-lg p-3 pl-8 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200" 
                               placeholder="0.00">
                    </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        <span class="absolute left-3 top-3 text-gray-500 text-sm">Rp</span>
                        <input type="number" step="0.01" name="antar_lokasi_20ft" id="antar_lokasi_20ft" value="{{ old('antar_lokasi_20ft', $tujuanKegiatanUtama->antar_lokasi_20ft) }}" 
                               class="w-full bg-gray-50 border border-gray-300 rounded-lg p-3 pl-8 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200" 
                               placeholder="0.00">
                    </div>
        ...
        <div class="mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div>
                    ...
                    <div class="relative">
                        <span class="absolute left-3 top-3 text-gray-500 text-sm">Rp</span>
                        <input type="number" step="0.01" name="uang_jalan_40ft" id="uang_jalan_40ft" value="{{ old('uang_jalan_40ft', $tujuanKegiatanUtama->uang_jalan_40ft) }}" 
                               class="w-full bg-gray-50 border border-gray-300 rounded-lg p-3 pl-8 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200" 
                               placeholder="0.00">
                    </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        <span class="absolute left-3 top-3 text-gray-500 text-sm">Rp</span>
                        <input type="number" step="0.01" name="mel_40ft" id="mel_40ft" value="{{ old('mel_40ft', $tujuanKegiatanUtama->mel_40ft) }}" 
                               class="w-full bg-gray-50 border border-gray-300 rounded-lg p-3 pl-8 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200" 
                               placeholder="0.00">
                    </div>
                    @error('mel_40ft')
                ...
                <div>
                    ...
                    <div class="relative">
                        <span class="absolute left-3 top-3 text-gray-500 text-sm">Rp</span>
                        <input type="number" step="0.01" name="ongkos_truk_40ft" id="ongkos_truk_40ft" value="{{ old('ongkos_truk_40ft', $tujuanKegiatanUtama->ongkos_truk_40ft) }}" 
                               class="w-full bg-gray-50 border border-gray-300 rounded-lg p-3 pl-8 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200" 
                               placeholder="0.00">
                    </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        <span class="absolute left-3 top-3 text-gray-500 text-sm">Rp</span>
                        <input type="number" step="0.01" name="antar_lokasi_40ft" id="antar_lokasi_40ft" value="{{ old('antar_lokasi_40ft', $tujuanKegiatanUtama->antar_lokasi_40ft) }}" 
                               class="w-full bg-gray-50 border border-gray-300 rounded-lg p-3 pl-8 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200" 
                               placeholder="0.00">
                    </div>
        ...
        <div class="mb-8">
            ...
            <div class="mb-4">
                ...
                <textarea name="keterangan" id="keterangan" rows="4" 
                          ...
                          placeholder="Masukkan keterangan tambahan mengenai rute transportasi ini...">{{ old('keterangan', $tujuanKegiatanUtama->keterangan) }}</textarea>
                @error('keterangan')
                    <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="flex items-center space-x-2">
                <input type="checkbox" name="aktif" id="aktif" value="1" {{ old('aktif', $tujuanKegiatanUtama->aktif) ? 'checked' : '' }} 
