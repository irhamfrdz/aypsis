...
@section('title', 'Report Lembur/Nginap - Pilih Periode')
@section('page_title', 'Report Lembur/Nginap - Pilih Periode')
    ...
    <div class="bg-white rounded-lg shadow-sm p-8">
        <div class="max-w-2xl mx-auto">
            <div class="text-center mb-8">
                ...
                <p class="text-gray-600">Silakan pilih rentang tanggal untuk menampilkan laporan yang melakukan <strong>Lembur</strong> atau <strong>Nginap</strong>.</p>
            </div>

            <form method="GET" action="{{ route('report.lembur.view') }}" class="space-y-6">
