            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="relative pengirim-dropdown-container">
                    ...
                    <div class="relative">
                        ...
                        <input type="hidden" name="pengirim" id="pengirim_value" value="{{ old('pengirim', $suratJalan->pengirim) }}">
                ...
                <div class="relative penerima-dropdown-container">
                    ...
                    <div class="relative">
                        <input type="text" id="penerima_search" placeholder="Cari penerima..." autocomplete="off"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition-all">
                        <input type="hidden" name="penerima" id="penerima_value" value="{{ old('penerima', $suratJalan->penerima) }}">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="alamat" id="alamat_input" value="{{ old('alamat', $suratJalan->alamat) }}"
                           class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-indigo-500 focus:border-indigo-500">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="ring" id="ring_input" readonly
                           ...
                           value="{{ old('ring', $suratJalan->ring ?? '') }}">
                </div>
        ...
        (item) => {
            ...
            if (size) {
                ...
                if (sizeSelect) {
                    ...
                    // Trigger change event to update Uang Jalan
