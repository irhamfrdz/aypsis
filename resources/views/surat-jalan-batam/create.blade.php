        ...
        <form action="{{ route('surat-jalan-batam.store') }}" method="POST" class="p-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <select name="gudang_tujuan_id" id="gudang_tujuan_id" required class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-indigo-500 focus:border-indigo-500">
