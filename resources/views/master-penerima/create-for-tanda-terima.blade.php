        ...
        <form action="{{ route('tanda-terima.penerima.store') }}" method="POST" class="p-6 space-y-4" id="penerimaForm">
            ...
            <div>
                ...
                <input type="text" 
                       ...
                       class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 @error('nama_penerima') border-red-500 @enderror"
