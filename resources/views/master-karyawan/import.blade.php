    ...
    <div class="bg-white rounded-lg shadow-sm border overflow-hidden">
        ...
        <div class="px-6 py-4 border-b bg-white">
            <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
                <h2 class="text-xl font-semibold text-gray-900">Import Data Karyawan dari CSV</h2>
                                ...
                                <div class="space-y-1 text-center">
                                    ...
                                    <div class="flex text-sm text-gray-600">
                                        <label for="csv_file" class="relative cursor-pointer bg-white rounded-md font-medium text-blue-600 hover:text-blue-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-blue-500">
                                            ...
                                            <input id="csv_file" name="csv_file" type="file" accept=".csv,text/csv,.txt" class="sr-only" required>
                                        </label>
                        ...
                        <div class="text-sm text-blue-800 space-y-3">
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p class="text-blue-700">Klik tombol "Download Template CSV" untuk mendapatkan format yang benar</p>
                                </div>
                            </div>
                            <div class="flex items-start">
                            ...
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p class="text-blue-700">Upload file CSV yang sudah diisi untuk import data</p>
                                </div>
                            </div>
                        </div>
                    </div>
