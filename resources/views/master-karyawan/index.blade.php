                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <div class="flex items-center bg-gray-50 border border-gray-200 rounded-lg p-0.5 shadow-sm">
                            <div class="flex items-center">
                                ...
                                <a href="{{ route('karyawan.import-update') }}" class="p-1.5 text-gray-400 hover:text-blue-600 transition-colors" title="Import Update Data"><i class="fas fa-sync-alt border-r pr-2 border-gray-200 ml-1"></i></a>
