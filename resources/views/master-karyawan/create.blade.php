                ...
                <div class="col-span-2 border-t pt-4 mt-2">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                            ...
                            <input type="text" name="no_sim" id="no_sim" class="{{ $inputClasses }}" placeholder="Masukkan Nomor SIM">
                        </div>
                        <div>
                            <label for="sim_berlaku_mulai" class="{{ $labelClasses }}">Berlaku Mulai</label>
                            <input type="date" name="sim_berlaku_mulai" id="sim_berlaku_mulai" class="{{ $inputClasses }}">
                        </div>
                        <div>
                            <label for="sim_berlaku_sampai" class="{{ $labelClasses }}">Berlaku Sampai</label>
                            <input type="date" name="sim_berlaku_sampai" id="sim_berlaku_sampai" class="{{ $inputClasses }}">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <fieldset class="border p-4 rounded-md mb-4">
            ...
            <div class="form-section pt-4">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <select name="penempatan" id="penempatan" class="{{ $selectClasses }}">
                            ...
                            <option value="JAKARTA PELABUHAN 1" {{ old('penempatan') == "JAKARTA PELABUHAN 1" ? 'selected' : '' }}>JAKARTA PELABUHAN 1</option>
                    ...
                    <div>
                        ...
                        <input type="number" name="nominal_uang_makan" id="nominal_uang_makan" class="{{ $inputClasses }}" value="{{ old('nominal_uang_makan', 50000) }}">
                    </div>
                ...
                <div class="col-span-2">
                    ...
                    <textarea name="catatan_pekerjaan" id="catatan_pekerjaan" rows="4" class="{{ $inputClasses }}" placeholder="Catatan terkait pekerjaan karyawan...">{{ old('catatan_pekerjaan') }}</textarea>
                </div>
            </div>
        </fieldset>
            ...
            <div class="form-section pt-4">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="cabang_bpjs" id="cabang_bpjs" class="{{ $inputClasses }}" placeholder="Contoh: Cabang Batam" value="{{ old('cabang_bpjs', $pelamar?->cabang_bpjs) }}">
                    </div>
                </div>
            </div>
        </fieldset>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function validateNik(input, errorElement) {
                ...
                const isValid = value !== '' && value.length >= 3; // Minimal 3 karakter
                ...
                if (value === '') {
                    ...
                    errorElement.textContent = 'NIK minimal 3 karakter';
                    errorElement.classList.remove('hidden');
                    input.classList.add('border-red-500');
                    return false;
                } else {
            ...
            // Event listener untuk NIK manual
            if (nikInput) {
                nikInput.addEventListener('input', function() {
                    if (nikError) validateNik(this, nikError);
                });
