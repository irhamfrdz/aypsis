        ...
        <fieldset class="border p-4 rounded-md mb-4">
            ...
            <div class="form-section pt-4">
                ...
                <div>
                    ...
                    <input type="text" name="posisi" id="posisi" class="{{ $inputClasses }}" placeholder="Masukkan posisi" value="{{ old('posisi', $karyawan->posisi) }}">
                </div>
                    ...
                    <div id="grup-container" class="space-y-2">
                        @php
                            ...
                            foreach ($selectedGrup as $s) {
                                $parts = explode(':', $s, 2);
                                $main = $parts[0];
                                if (!in_array($main, $allGrups) && $main !== '') $allGrups[] = $main;
                            }
                            sort($allGrups);
                            ...
                            @foreach($karyawan->familyMembers ?? [] as $index => $familyMember)
                                <tr class="family-member-row" data-index="{{ $index }}">
                                    ...
                                    <td class="border border-gray-300 px-2 py-2">
                                     ...
                                     <td class="border border-gray-300 px-2 py-2">
                                        <input type="text" name="family_members[{{ $index }}][tanggal_lahir]" class="family-datepicker w-full rounded border-gray-300 text-xs p-1" value="{{ $familyMember->tanggal_lahir ? $familyMember->tanggal_lahir->format('Y-m-d') : '' }}" placeholder="dd/mmm/yyyy">
                                    </td>
                                    <td class="border border-gray-300 px-2 py-2">
...
@push('scripts')
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function createFamilyMemberForm(index, data = {}) {
                ...
                return `
                    <tr class="family-member-row" data-index="${index}">
                        ...
                        <td class="border border-gray-300 px-2 py-2">
                            <input type="text" name="family_members[${index}][tanggal_lahir]" class="family-datepicker w-full rounded border-gray-300 text-xs p-1" value="${data.tanggal_lahir || ''}" placeholder="dd/mmm/yyyy">
                        </td>
                        <td class="border border-gray-300 px-2 py-2">
            ...
            flatpickr(".family-datepicker", dateConfig);
