...
@section('title','Import Update Karyawan')
@section('page_title', 'Import Update Karyawan')

@section('content')
@cannot('master-karyawan-update')
<div class="max-w-4xl mx-auto px-4 py-8">
    <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-6 mb-6">
        <div class="flex items-start">
            ...
            <div class="ml-4">
                <h3 class="text-lg font-medium text-yellow-800 mb-2">Peringatan Izin Akses</h3>
                <p class="text-yellow-700 mb-3">
                    Anda tidak memiliki izin <strong>master-karyawan-update</strong> untuk melakukan update data karyawan.
                    Fitur import akan tetap dapat digunakan, namun disarankan untuk mendapatkan izin yang diperlukan dari administrator.
                </p>
                <div class="flex space-x-3">
                    <a href="{{ route('master.karyawan.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-500 hover:bg-gray-600 text-white text-sm font-medium rounded transition duration-150">
                        <i class="fas fa-arrow-left mr-2"></i>Kembali
                    </a>
                    <button onclick="this.parentElement.parentElement.parentElement.parentElement.style.display='none'" class="inline-flex items-center px-4 py-2 bg-yellow-600 hover:bg-yellow-700 text-white text-sm font-medium rounded transition duration-150">
                        <i class="fas fa-times mr-2"></i>Lanjutkan Import
                    </button>
                </div>
            </div>
        </div>
                ...
                <div>
                    <form action="{{ route('master.karyawan.import-update.store') }}" method="POST" enctype="multipart/form-data" id="importForm">
                        ...
                        <div class="mb-6">
                            ...
                            <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-lg hover:border-blue-500 hover:bg-blue-50 transition-colors cursor-pointer" id="dropZone" onclick="document.getElementById('excel_file').click()">
                                <div class="space-y-1 text-center">
                                    ...
                                    <div class="flex text-sm text-gray-600 justify-center">
                                        <label for="excel_file" class="relative cursor-pointer bg-white rounded-md font-medium text-blue-600 hover:text-blue-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-blue-500">
                                            ...
                                            <input id="excel_file" name="excel_file" type="file" class="sr-only" accept=".csv,.xlsx,.xls">
                                        </label>
                ...
                <div class="space-y-6">
                    <div class="bg-blue-50 rounded-lg p-6">
                        <h3 class="text-lg font-medium text-blue-900 mb-4">
                            <i class="fas fa-info-circle mr-2"></i>Panduan Update Data
                        </h3>
                        <div class="text-sm text-blue-800 space-y-3">
                            <div class="flex items-start">
                                ...
                                <div>
                                    <p class="font-medium">Siapkan Excel</p>
                                    <p class="text-blue-700">Pastikan Excel Anda memiliki kolom: NIK, NAMA LENGKAP, KANTOR CABANG AYP, PEKERJAAN, PENEMPATAN, GROUP, SUB GROUP.</p>
                                </div>
                            </div>
                            <div class="flex items-start">
                            ...
                            <div class="flex items-start">
                                ...
                                <div>
                                    <p class="font-medium">Group & Sub Group</p>
                                    <p class="text-blue-700">Jika terdapat lebih dari satu, pisahkan dengan koma. Contoh: "GAJI, UANG MAKAN".</p>
                                </div>
                            </div>
                        </div>
                    </div>
