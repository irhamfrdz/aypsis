            ...
            <form method="GET" action="{{ route('pranota-perbaikan-kontainer.index') }}" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="search" value="{{ request('search') }}"
                           placeholder="Nomor pranota, kontainer, tagihan, teknisi..."
                           class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                </div>
...
$(document).ready(function() {
    initResizableTable('pranotaPerbaikanKontainerTable');
});
</script>
@endpush