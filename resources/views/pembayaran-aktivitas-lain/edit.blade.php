            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="jenis_aktivitas" required class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm @error('jenis_aktivitas') border-red-500 @enderror">
                        ...
                        <option value="Pembayaran KIR" {{ old('jenis_aktivitas', $pembayaranAktivitasLain->jenis_aktivitas) == 'Pembayaran KIR' ? 'selected' : '' }}>Pembayaran KIR</option>
                        <option value="Pembayaran Pajak dan STNK" {{ old('jenis_aktivitas', $pembayaranAktivitasLain->jenis_aktivitas) == 'Pembayaran Pajak dan STNK' ? 'selected' : '' }}>Pembayaran Pajak dan STNK</option>
                        <option value="Pembayaran Asuransi" {{ old('jenis_aktivitas', $pembayaranAktivitasLain->jenis_aktivitas) == 'Pembayaran Asuransi' ? 'selected' : '' }}>Pembayaran Asuransi</option>
                ...
                <div>
                    ...
                    <select name="akun_coa_id" required class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm @error('akun_coa_id') border-red-500 @enderror">
                        ...
                        @foreach($akunBiaya as $akun)
                            <option value="{{ $akun->id }}" {{ old('akun_coa_id', $pembayaranAktivitasLain->akun_coa_id) == $akun->id ? 'selected' : '' }}>
