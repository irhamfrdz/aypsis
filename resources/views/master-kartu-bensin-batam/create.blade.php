...
@section('title', 'Tambah Kartu Bensin Batam')
@section('page_title', 'Tambah Kartu Bensin Batam')
...
<div class="container mx-auto px-4 py-6 max-w-3xl">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <div class="bg-gray-50 px-6 py-4 border-b border-gray-200">
            <h3 class="text-lg font-bold text-gray-800">Form Kartu Bensin Batam</h3>
            <p class="text-xs text-gray-500 mt-1">Buat data kartu bensin baru untuk operasional cabang Batam.</p>
        </div>

        <form action="{{ route('master-kartu-bensin-batam.store') }}" method="POST" class="p-6 space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="nomor_kartu" id="nomor_kartu" value="{{ old('nomor_kartu') }}" required placeholder="Masukkan nomor kartu bensin"
                ...
                <div>
                    ...
                    <input type="text" name="nama_kartu" id="nama_kartu" value="{{ old('nama_kartu') }}" required placeholder="Contoh: Kartu Bensin Batam 01"
                           class="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm focus:ring-2 focus:ring-blue-500 outline-none">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="provider" id="provider" value="{{ old('provider', 'Pertamina') }}" required placeholder="Contoh: Pertamina, Flazz, dll."
                           class="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm focus:ring-2 focus:ring-blue-500 outline-none">
                </div>
                ...
                <!-- Saldo Awal -->
                <div>
                    <label for="saldo" class="block text-sm font-semibold text-gray-700 mb-2">Saldo Awal</label>
                    <input type="number" name="saldo" id="saldo" value="{{ old('saldo', 0) }}" min="0" placeholder="0"
                           class="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm focus:ring-2 focus:ring-blue-500 outline-none">
                </div>
