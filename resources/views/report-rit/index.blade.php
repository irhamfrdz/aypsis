...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
        ...
        <form method="GET" action="{{ route('report.rit.index') }}">
            ...
            <div class="flex gap-2 mt-4">
                ...
                <a href="{{ route('report.rit.index') }}" class="bg-gray-500 hover:bg-gray-600 text-white px-6 py-2 rounded-md transition duration-200 inline-flex items-center">
                    <i class="fas fa-times mr-2"></i>
                    Reset
                </a>
                @if($suratJalans && $suratJalans->count() > 0)
    ...
    <div class="bg-white rounded-lg shadow-sm p-12 text-center">
        ...
        <h3 class="text-xl font-semibold text-gray-700 mb-2">Pilih Periode Tanggal</h3>
        <p class="text-gray-500">Pilih tanggal mulai dan tanggal akhir untuk menampilkan laporan surat jalan</p>
    </div>
    @endif
</div>
@endsection
