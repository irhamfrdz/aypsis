    ...
    <div class="bg-white shadow-md rounded-lg p-6 max-w-2xl mx-auto">
        ...
        <form action="{{ route('master.chasis-batam.store') }}" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <input type="text" name="plat_nomor" id="plat_nomor" value="{{ old('plat_nomor') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-xs focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500" placeholder="Contoh: BP 9123 XX">
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="merek" id="merek" value="{{ old('merek') }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-xs focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500" placeholder="Contoh: CIMC">
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="number" name="tahun_pembuatan" id="tahun_pembuatan" value="{{ old('tahun_pembuatan') }}" min="1900" max="{{ date('Y') + 1 }}" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-xs focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500" placeholder="Contoh: 2020">
                </div>
