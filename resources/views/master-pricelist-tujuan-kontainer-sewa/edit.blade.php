...
@section('title', 'Edit Pricelist Tujuan Kontainer Sewa')
@section('page_title', 'Edit Pricelist Tujuan')
        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100">
            <div class="bg-gradient-to-r from-blue-600 to-blue-800 px-6 py-4">
                <h3 class="text-xl font-bold text-white flex items-center">
                    ...
                    Edit Pricelist: {{ $pricelist->tujuan }}
                </h3>
            </div>

            <form action="{{ route('master-pricelist-tujuan-kontainer-sewa.update', $pricelist->id) }}" method="POST" class="p-6">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="tujuan" id="tujuan" value="{{ old('tujuan', $pricelist->tujuan) }}" placeholder="Contoh: JAKARTA - SURABAYA" required
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" name="ongkos_truk_20ft" id="ongkos_truk_20ft" value="{{ old('ongkos_truk_20ft', $pricelist->ongkos_truk_20ft) }}" min="0" required
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" name="ongkos_truk_40ft" id="ongkos_truk_40ft" value="{{ old('ongkos_truk_40ft', $pricelist->ongkos_truk_40ft) }}" min="0" required
                    ...
                    <div>
                        ...
                        <select name="status" id="status" required
                            ...
                            <option value="nonaktif" {{ old('status', $pricelist->status) === 'nonaktif' ? 'selected' : '' }}>Nonaktif</option>
                        </select>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="keterangan" id="keterangan" rows="3" placeholder="Informasi tambahan (opsional)"
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition duration-200">{{ old('keterangan', $pricelist->keterangan) }}</textarea>
                    </div>
                </div>
