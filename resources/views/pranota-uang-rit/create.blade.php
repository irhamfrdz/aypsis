                ...
                <div class="bg-gray-50 px-3 py-2 border-b border-gray-200">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                        ...
                        <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
                            ...
                            <button type="button" id="downloadExcelBtn" class="inline-flex items-center px-2 py-1.5 border border-green-300 rounded-md text-xs text-green-700 bg-white hover:bg-green-50 focus:outline-none focus:ring-2 focus:ring-green-500 transition-colors">
                                <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
