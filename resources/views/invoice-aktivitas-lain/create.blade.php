                                ...
                                <tr>
                                    ...
                                    <td class="px-3 py-3 text-right">
                                        <div class="relative">
                                            ...
                                            <input type="text" name="pbm_biaya_adjustment" id="pbm_biaya_adjustment" value="" class="w-full pl-6 text-right border-gray-300 rounded-md text-sm font-bold text-pink-600 shadow-sm focus:ring-blue-500 focus:border-blue-500 pbm-adj-calc" placeholder="0">
                                        </div>
                                    </td>
                                    <td></td>
                                </tr>
                    ...
                    <div class="bg-white rounded-2xl border-2 border-blue-200 shadow-sm overflow-hidden">
                        ...
                        <div class="p-5 bg-blue-50/30 border-t-2 border-blue-100">
                            <div class="flex flex-col md:flex-row justify-end items-center gap-6">
                                ...
                                <div class="text-right">
                                    <span class="block text-xs font-bold text-blue-500 mb-1">Total PPN 11%</span>
...
(function() {
    ...
    function initializeSelect2AndForm($) {
        ...
        function setupBiayaUtilitiesCalculations(entry) {
            ...
            $(alatBeratSelect).on('change', applyTarifFromAlat);
        ...
        function updateTotalFromBiayaUtilities() {
            ...
            // Recalculate taxes for adjustment if it follows standard 11% / 10%
            // Or just add the adjustment to DPP and then grand total?
            // User says "adjust dpp". 
            // Usually, Tax = DPP * rate.
            // So PPN and PPH should ideally follow the adjustment too.
        ...
        function setupPBMCalculations() {
            ...
            function addPBMLine(data = {}) {
                ...
                row.innerHTML = `
                    ...
                    <td class="px-2 py-2">
                        <div class="relative">
                            <span class="absolute left-2 top-1/2 -translate-y-1/2 text-gray-400 text-[10px]">Rp</span>
                            <input type="text" name="pbm_detail[${pbmRowIndex}][nominal_bayar]" value="${data.nominal_bayar || ''}" class="w-full pl-6 text-right border-gray-300 rounded-md text-xs shadow-sm focus:ring-blue-500 focus:border-blue-500 pbm-row-calc" placeholder="0">
                        </div>
                    </td>
                    <td class="px-2 py-2">
                        <div class="relative">
            ...
            // Initial row if none exist and it's visible
            window.addEventListener('load', () => {
                const wrapper = document.getElementById('biaya_pbm_wrapper');
                if (wrapper && !wrapper.classList.contains('hidden') && tbody.children.length === 0) {
                    addPBMLine();
                }
            });
