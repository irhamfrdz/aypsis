...
<div class="container mx-auto px-3 py-2">
    <div class="max-w-4xl mx-auto bg-white rounded-lg shadow-sm border border-gray-200">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 p-3 border-b border-gray-200">
            <div>
                <h1 class="text-lg font-semibold text-gray-900">Edit Uang Jalan</h1>
                <p class="text-xs text-gray-600 mt-0.5">Edit pembayaran uang jalan {{ $uangJalan->nomor_uang_jalan ?? 'ID: ' . $uangJalan->id }}</p>
            </div>
        ...
        <div class="bg-blue-50 border border-blue-200 rounded mx-3 mt-2 p-3">
            <div class="flex items-start">
                ...
                <div class="flex-1">
                    <h4 class="text-xs font-medium text-blue-800 mb-2">Surat Jalan</h4>
        ...
        <!-- Form -->
        <form action="{{ route('uang-jalan.update', $uangJalan->id) }}" method="POST" class="p-3">
            @csrf
            @method('PUT')
            ...
            <div class="mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <!-- Nomor Uang Jalan -->
                    <div>
                        <label class="block text-xs font-medium text-gray-700 mb-1">Nomor Uang Jalan</label>
                        <input type="text"
                               value="{{ $uangJalan->nomor_uang_jalan ?? '-' }}"
                               readonly
                    ...
                    <div>
                        ...
                        <input type="date"
                               ...
                               value="{{ old('tanggal_uang_jalan', $uangJalan->tanggal_uang_jalan ? $uangJalan->tanggal_uang_jalan->format('Y-m-d') : '') }}"
                               required
                        ...
                        <div class="flex gap-4">
                            <label class="flex items-center cursor-pointer">
                                <input type="radio" 
                                       ...
                                       value="bongkar" 
                                       {{ old('kegiatan_bongkar_muat', $uangJalan->kegiatan_bongkar_muat) == 'bongkar' ? 'checked' : '' }}
                                       required
                            ...
                            <label class="flex items-center cursor-pointer">
                                <input type="radio" 
                                       name="kegiatan_bongkar_muat" 
                                       value="muat" 
                                       {{ old('kegiatan_bongkar_muat', $uangJalan->kegiatan_bongkar_muat) == 'muat' ? 'checked' : '' }}
                                       required
                                       class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 focus:ring-2 border-gray-300 border-2">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number"
                                   ...
                                   value="{{ old('jumlah_uang_jalan', $uangJalan->jumlah_uang_jalan) }}"
                                   min="0"
                                   step="1"
                                   required
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number"
                                   name="jumlah_mel"
                                   id="jumlah_mel"
                                   value="{{ old('jumlah_mel', $uangJalan->jumlah_mel ?? 0) }}"
                                   min="0"
                                   step="1"
                                   oninput="calculateTotal()"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number"
                                   ...
                                   id="jumlah_pelancar"
                                   value="{{ old('jumlah_pelancar', $uangJalan->jumlah_pelancar ?? 0) }}"
                                   min="0"
                                   step="1"
                                   oninput="calculateTotal()"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number"
                                   name="jumlah_kawalan"
                                   id="jumlah_kawalan"
                                   value="{{ old('jumlah_kawalan', $uangJalan->jumlah_kawalan ?? 0) }}"
                                   min="0"
                                   step="1"
                                   oninput="calculateTotal()"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number"
                                   name="jumlah_parkir"
                                   id="jumlah_parkir"
                                   value="{{ old('jumlah_parkir', $uangJalan->jumlah_parkir ?? 0) }}"
                                   min="0"
                                   step="1"
                                   oninput="calculateTotal()"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number"
                                   ...
                                   id="subtotal"
                                   readonly
                                   value="{{ old('subtotal', $uangJalan->subtotal) }}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                    ...
                    <div>
                        ...
                        <input type="text" 
                               ...
                               value="{{ old('alasan_penyesuaian', $uangJalan->alasan_penyesuaian) }}"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" 
                                   ...
                                   value="{{ old('jumlah_penyesuaian', $uangJalan->jumlah_penyesuaian ?? 0) }}"
                                   step="1"
                                   oninput="calculateTotal()"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                        ...
                        <div class="bg-gray-50 p-3 rounded">
                            ...
                            <div class="relative">
                                ...
                                <input type="number" 
                                       ...
                                       id="jumlah_total"
                                       readonly
                                       value="{{ old('jumlah_total', $uangJalan->jumlah_total) }}"
                    ...
                    <div>
                        ...
                        <textarea name="memo" 
                                  ...
                                  class="w-full px-2.5 py-1.5 text-sm border border-gray-300 rounded focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 @error('memo') border-red-500 @enderror">{{ old('memo', $uangJalan->memo) }}</textarea>
                        @error('memo')
                            <p class="mt-0.5 text-xs text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
