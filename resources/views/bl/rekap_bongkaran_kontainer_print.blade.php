...
<head>
    ...
    <title>Rekapan Bongkar/Muat Kontainer - {{ $namaKapal }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="no-print-controls no-print">
        ...
        <a href="{{ route('bl.rekap-bongkaran', ['nama_kapal' => $namaKapal, 'no_voyage' => $noVoyage]) }}" class="bg-gray-600 hover:bg-gray-700 text-white px-3 py-2 rounded text-sm no-underline" style="text-decoration: none;">Kembali</a>
    </div>
        ...
        <div class="info-section">
            <table class="info-table">
                <tr>
                    ...
                    <td style="width: 15%;">{{ ucwords(strtolower($labelTanggal)) }}</td>
                    <td>: {{ $estTiba }}</td>
                </tr>
                <tr>
                    <td>Voyage</td>
