...
<div class="container mx-auto px-4 py-6 max-w-4xl no-print">
    ...
    <div class="flex items-center justify-between mb-6 bg-white p-4 rounded-2xl shadow-sm border border-gray-100">
        <a href="{{ route('bl.rekap-bongkaran-kontainer.select') }}" class="inline-flex items-center justify-center px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-xl hover:bg-gray-50 transition duration-150 ease-in-out shadow-sm">
            <i class="fas fa-arrow-left mr-2"></i> Kembali ke Pemilihan
        </a>
        <div class="flex space-x-2">
            <a href="{{ route('bl.rekap-bongkaran-kontainer.print', ['nama_kapal' => $namaKapal, 'no_voyage' => $noVoyage]) }}" target="_blank" class="inline-flex items-center justify-center px-4 py-2 text-sm font-medium text-white bg-indigo-600 border border-transparent rounded-xl shadow-sm hover:bg-indigo-700 focus:outline-none transition duration-150 ease-in-out">
...
<div class="container mx-auto px-4 py-6 max-w-4xl">
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 md:p-12 print:shadow-none print:border-none print:p-0 print-half-folio">
        ...
        <div class="text-center mb-8 border-b-2 border-double border-gray-300 pb-4">
            <h1 class="text-2xl md:text-3xl font-extrabold text-gray-900 uppercase tracking-wider underline">Rekapan Bongkar/Muat Kontainer</h1>
        </div>
