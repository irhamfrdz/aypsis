    ...
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">Tambah Pajak</h1>
                    <p class="mt-1 text-sm text-gray-600">Tambahkan data pajak baru ke dalam sistem</p>
                </div>
            ...
            <form action="{{ route('master.pajak.store') }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <textarea name="keterangan"
                              ...
                              placeholder="Masukkan keterangan pajak (opsional)">{{ old('keterangan') }}</textarea>
                    @error('keterangan')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
