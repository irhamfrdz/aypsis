                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <div class="flex items-center gap-2">
                                    <input type="number" step="any"
                                           class="text-sm font-medium text-gray-900 border border-gray-300 rounded px-2 py-1 w-20 focus:border-purple-500 focus:ring-1 focus:ring-purple-500 kuantitas-input" 
                                           data-manifest-id="{{ $manifest->id }}"
                                           data-original-value="{{ $manifest->kuantitas }}"
                                           value="{{ $manifest->kuantitas }}"
                                           title="Edit kuantitas, lalu klik Simpan">
                                    <button type="button" 
                                            class="save-kuantitas-btn px-2 py-1 bg-green-500 hover:bg-green-600 text-white text-xs font-medium rounded transition-colors hidden"
                                            data-manifest-id="{{ $manifest->id }}"
                                            title="Simpan">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                                ...
                                @else
                                <div class="text-sm text-gray-900">{{ $manifest->kuantitas ?? '-' }}</div>
                                @endcan
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                @can('manifest-edit')
