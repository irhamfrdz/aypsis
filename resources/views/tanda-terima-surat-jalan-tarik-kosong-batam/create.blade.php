...
@section('title', 'Tambah Tanda Terima SJ Tarik Kosong Batam')
...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Tambah Tanda Terima</h1>
                <p class="text-gray-600">Buat tanda terima penarikan kosong baru</p>
            </div>
        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
            <form action="{{ route('tanda-terima-surat-jalan-tarik-kosong-batam.store') }}" method="POST" class="p-8">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="no_tanda_terima" value="{{ old('no_tanda_terima', $noTandaTerima) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg bg-gray-50 font-bold text-blue-600" readonly>
                        </div>

                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Tanggal Tanda Terima <span class="text-red-500">*</span></label>
                            <input type="date" name="tanggal_tanda_terima" value="{{ old('tanggal_tanda_terima', date('Y-m-d')) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500" required>
                        </div>
                        
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Penerima</label>
                            <input type="text" name="penerima" value="{{ old('penerima') }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500" placeholder="Nama penerima barang">
                        </div>
                    </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="relative">
                            <label class="block text-sm font-medium text-gray-700 mb-1">Cari Surat Jalan Tarik Kosong</label>
                            <div class="relative">
                        ...
                        <input type="hidden" name="surat_jalan_tarik_kosong_batam_id" id="sj_id" value="{{ $suratJalan ? $suratJalan->id : '' }}">

                        <div id="sj_details" class="p-4 bg-blue-50 rounded-lg border border-blue-100 {{ $suratJalan ? '' : 'hidden' }}">
                            <div class="flex items-start gap-3">
                                ...
                                <div class="flex-grow">
                                    ...
                                    <div id="sj_info" class="mt-1">
                                        @if($suratJalan)
                                            <div class="font-bold text-blue-900">{{ $suratJalan->no_surat_jalan }}</div>
                                            <div class="text-sm text-blue-700">Kontainer: {{ $suratJalan->no_kontainer }} ({{ $suratJalan->size }})</div>
                                            <div class="text-sm text-blue-700">Supir: {{ $suratJalan->supir }} / {{ $suratJalan->no_plat }}</div>
                                        @endif
                                    </div>
                                </div>
                            </div>
                ...
                <div class="mb-8">
                    ...
                    <textarea name="catatan" rows="3" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500" placeholder="Catatan tambahan jika ada...">{{ old('catatan') }}</textarea>
                </div>
                ...
                <div class="flex justify-end gap-3 pt-6 border-t border-gray-100">
                    ...
                    <button type="submit" class="px-8 py-2 bg-blue-600 text-white rounded-lg font-bold shadow-lg hover:bg-blue-700 transition duration-200">Simpan Tanda Terima</button>
                </div>
            </form>
        </div>
    </div>
