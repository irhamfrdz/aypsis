...
<script>
    ...
    function renderPreview() {
        ...
        // Sort rows: even descending, odd ascending
                            ...
                            <table class="w-full table-auto border-collapse">
                                <thead>
                                    <tr>
                                        ...
                                        ${sortedRows.map(row => `<th class="p-2 border-b-2 border-gray-200 bg-orange-50 text-xs font-bold text-orange-700 text-center w-14 shadow-sm">${row}</th>`).join('')}
                                    </tr>
                                </thead>
                                <tbody>
