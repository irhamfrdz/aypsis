...
<div class="container-fluid px-4">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('master-kapal.update', $masterKapal->id) }}" method="POST">
                @csrf
                @method('PUT')
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('kode') is-invalid @enderror" 
                                   id="kode" name="kode" value="{{ old('kode', $masterKapal->kode) }}" 
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('kode_kapal') is-invalid @enderror" 
                                   id="kode_kapal" name="kode_kapal" value="{{ old('kode_kapal', $masterKapal->kode_kapal) }}" 
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('nama_kapal') is-invalid @enderror" 
                           id="nama_kapal" name="nama_kapal" value="{{ old('nama_kapal', $masterKapal->nama_kapal) }}" 
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('lokasi') is-invalid @enderror" 
                           id="lokasi" name="lokasi" value="{{ old('lokasi', $masterKapal->lokasi) }}" 
