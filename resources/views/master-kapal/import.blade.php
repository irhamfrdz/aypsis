                        ...
                        <div class="ml-3">
                            ...
                            <div class="mt-2 text-sm text-yellow-700">
                                <ul class="list-disc pl-5 space-y-1">
                                    ...
                                    <li>Header kolom harus: <code class="bg-yellow-100 px-1 rounded">kode;kode_kapal;nama_kapal;lokasi;catatan;status</code></li>
                                    <li>Kolom <strong>kode</strong> dan <strong>nama_kapal</strong> wajib diisi</li>
                                    <li>Kolom status harus berisi: <strong>aktif</strong> atau <strong>nonaktif</strong></li>
                                    <li>Data yang sudah ada dengan kode sama akan diupdate</li>
                                    <li>Baris dengan kode kosong akan diabaikan</li>
                                    <li>Kolom kode_kapal, lokasi, dan catatan bersifat opsional</li>
                                </ul>
                            </div>
                        </div>
                    </div>
