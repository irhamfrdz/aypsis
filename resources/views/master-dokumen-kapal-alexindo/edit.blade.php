                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        ...
                        <div class="col-span-1">
                            ...
                            <div class="custom-select-container" id="sertifikat-select-container">
                                <input type="hidden" name="sertifikat_kapal_id" id="sertifikat_kapal_id" value="{{ old('sertifikat_kapal_id') ?? $dokumen->sertifikat_kapal_id }}" required>
                        ...
                        <div class="col-span-1">
                            ...
                            <input type="date" name="tanggal_terbit" required value="{{ old('tanggal_terbit') ?? $dokumen->tanggal_terbit }}" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                        </div>

                        <div class="col-span-1">
                            <label class="block text-sm font-medium text-gray-700 mb-1">Tanggal Kadaluarsa <span class="text-red-500">*</span></label>
                            <input type="date" name="tanggal_berakhir" required value="{{ old('tanggal_berakhir') ?? $dokumen->tanggal_berakhir }}" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                        </div>
