...
@section('title', 'Detail Dokumen Kapal: ' . $kapal->nama_kapal)
...
<div class="container mx-auto px-4 py-8">
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
        <div class="flex items-center justify-between">
            <div>
                <a href="{{ route('master-dokumen-kapal-alexindo.index') }}" class="text-gray-500 hover:text-blue-600 mb-2 inline-block">
                    <i class="fas fa-arrow-left mr-1"></i> Kembali ke Daftar Kapal
                </a>
                <h1 class="text-2xl font-bold text-gray-900">Dokumen Kapal: {{ $kapal->nama_kapal }}</h1>
                <p class="text-gray-600 mt-1">Total: {{ $dokumens->count() }} Dokumen</p>
            </div>
            <div class="flex gap-2">
                <a href="{{ route('master-dokumen-kapal-alexindo.create', ['kapal_id' => $kapal->id]) }}" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg transition duration-200 inline-flex items-center">
