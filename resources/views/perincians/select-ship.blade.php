    ...
    <div class="bg-white rounded-2xl shadow-2xl max-w-lg w-full mx-4">
        ...
        <div class="flex items-center justify-between p-6 border-b border-gray-200">
            <div class="flex items-center">
                ...
                <div>
                    <h3 class="text-xl font-bold text-gray-900">Import Perincian (Bulk)</h3>
        ...
        <!-- Modal Body -->
        <form action="{{ route('report.perincians.bulk-import') }}" method="POST" enctype="multipart/form-data" class="p-6">
            @csrf
                ...
                <div class="flex">
                    ...
                    <div class="text-sm text-blue-800">
                        ...
                        <ul class="list-disc list-inside space-y-1 text-xs text-blue-700">
                            ...
                            <li>Data perincian akan dikelompokkan otomatis per kapal dan voyage</li>
            ...
            <!-- Download Template -->
            <div class="mb-6">
                <a href="{{ route('report.perincians.download-bulk-template') }}" 
            ...
            <div class="mb-6 bg-gray-50 rounded-xl p-4">
                    ...
                    <table class="min-w-full text-xs border border-gray-300">
                        <thead class="bg-gray-200">
                            <tr>
                                ...
                                <th class="border border-gray-300 px-2 py-1">No Perincian</th>
                ...
                <p class="text-xs text-gray-600 mt-2">
                    <strong>Total 25 kolom:</strong> Nama Kapal, No Voyage, Tanggal Berangkat, No BL, No Perincian, No Tanda Terima, 
...
window.autoUpdateNomorUrutAll = function(event) {
    ...
    fetch('{{ route("report.perincians.auto-update-nomor-urut-all", [], false) }}', {
        method: 'POST',
        headers: {
