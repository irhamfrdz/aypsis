...
@section('title', 'Tambah Perincian')
@section('page_title', 'Tambah Perincian')
...
<div class="min-h-screen bg-gray-50 py-6">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-6">
            ...
            <h1 class="mt-2 text-3xl font-bold text-gray-900">Tambah Perincian Baru</h1>
        </div>

        <form action="{{ route('report.perincians.store') }}" method="POST">
            @csrf
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number" step="0.001" name="tonnage_perincian" id="tonnage_perincian" value="{{ old('tonnage_perincian') }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-purple-500 focus:border-purple-500">
                    </div>

                    <div>
                        <label for="volume_perincian" class="block text-sm font-medium text-gray-700 mb-2">Volume/Kubikasi Perincian</label>
                        <input type="number" step="0.001" name="volume_perincian" id="volume_perincian" value="{{ old('volume_perincian') }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-purple-500 focus:border-purple-500">
                    </div>
