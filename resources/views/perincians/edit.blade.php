...
@section('title', 'Edit Perincian')
@section('page_title', 'Edit Perincian')
...
<div class="min-h-screen bg-gray-50 py-6">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <!-- Header -->
        <div class="mb-6">
            <a href="{{ route('report.perincians.index') }}" class="inline-flex items-center text-sm text-gray-600 hover:text-gray-900">
                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"></path>
                </svg>
                Kembali ke Daftar Perincian
            </a>
            <h1 class="mt-2 text-3xl font-bold text-gray-900">Edit Perincian</h1>
        </div>

        <form action="{{ route('report.perincians.update', $perincian->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="number" name="nomor_urut" id="nomor_urut" value="{{ old('nomor_urut', $perincian->nomor_urut) }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="nomor_bl" id="nomor_bl" value="{{ old('nomor_bl', $perincian->nomor_bl) }}" required
                        ...
                        <div class="relative">
                            <div class="dropdown-container-prospek">
                                <input type="text" id="search_prospek" placeholder="Cari prospek..." autocomplete="off"
                                       ...
                                       value="{{ $perincian->prospek ? $perincian->prospek->pt_pengirim : '' }}">
                                <select name="prospek_id" id="prospek_id" class="hidden">
                                    <option value="">- Pilih Prospek -</option>
                                    @if($perincian->prospek)
                                        <option value="{{ $perincian->prospek_id }}" selected>{{ $perincian->prospek->pt_pengirim }}</option>
                                    @endif
                                </select>
                    ...
                    <div>
                        ...
                        <input type="text" name="nomor_kontainer" id="nomor_kontainer" value="{{ old('nomor_kontainer', $perincian->nomor_kontainer) }}" required
                    ...
                    <div>
                        ...
                        <input type="text" name="no_seal" id="no_seal" value="{{ old('no_seal', $perincian->no_seal) }}"
                    ...
                    <div>
                        ...
                        <select name="tipe_kontainer" id="tipe_kontainer" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-purple-500 focus:border-purple-500">
                            ...
                            @php
                                ...
                                $currentTipe = old('tipe_kontainer', $perincian->tipe_kontainer);
                            @endphp
                    ...
                    <div>
                        ...
                        <select name="size_kontainer" id="size_kontainer" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-purple-500 focus:border-purple-500">
                            ...
                            @php
                                ...
                                $currentSize = old('size_kontainer', $perincian->size_kontainer);
                            @endphp
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="nama_kapal" id="nama_kapal" value="{{ old('nama_kapal', $perincian->nama_kapal) }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-purple-500 focus:border-purple-500">
                    </div>

                    <div>
                        <label for="no_voyage" class="block text-sm font-medium text-gray-700 mb-2">No. Voyage</label>
                        <input type="text" name="no_voyage" id="no_voyage" value="{{ old('no_voyage', $perincian->no_voyage) }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-purple-500 focus:border-purple-500">
                    </div>

                    <div>
                        <label for="pelabuhan_asal" class="block text-sm font-medium text-gray-700 mb-2">Pelabuhan Asal</label>
                        <input type="text" name="pelabuhan_asal" id="pelabuhan_asal" value="{{ old('pelabuhan_asal', $perincian->pelabuhan_asal) }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-purple-500 focus:border-purple-500">
                    </div>

                    <div>
                        <label for="pelabuhan_tujuan" class="block text-sm font-medium text-gray-700 mb-2">Pelabuhan Tujuan</label>
                        <input type="text" name="pelabuhan_tujuan" id="pelabuhan_tujuan" value="{{ old('pelabuhan_tujuan', $perincian->pelabuhan_tujuan) }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-purple-500 focus:border-purple-500">
                    </div>

                    <div>
                        <label for="tanggal_berangkat" class="block text-sm font-medium text-gray-700 mb-2">Tanggal Berangkat</label>
                        <input type="date" name="tanggal_berangkat" id="tanggal_berangkat" value="{{ old('tanggal_berangkat', $perincian->tanggal_berangkat ? $perincian->tanggal_berangkat->format('Y-m-d') : '') }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-purple-500 focus:border-purple-500">
                    </div>

                    <div>
                        <label for="penerimaan" class="block text-sm font-medium text-gray-700 mb-2">Tanggal Penerimaan</label>
                        <input type="date" name="penerimaan" id="penerimaan" value="{{ old('penerimaan', $perincian->penerimaan ? $perincian->penerimaan->format('Y-m-d') : '') }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-purple-500 focus:border-purple-500">
                    </div>
                </div>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="md:col-span-2">
                        ...
                        <textarea name="nama_barang" id="nama_barang" rows="3"
                                  class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-purple-500 focus:border-purple-500">{{ old('nama_barang', $perincian->nama_barang) }}</textarea>
                    </div>

                    <div>
                        <label for="tonnage" class="block text-sm font-medium text-gray-700 mb-2">Tonnage</label>
                        <input type="number" step="0.001" name="tonnage" id="tonnage" value="{{ old('tonnage', $perincian->tonnage) }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-purple-500 focus:border-purple-500">
                    </div>

                    <div>
                        <label for="volume" class="block text-sm font-medium text-gray-700 mb-2">Volume</label>
                        <input type="number" step="0.001" name="volume" id="volume" value="{{ old('volume', $perincian->volume) }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-purple-500 focus:border-purple-500">
                    </div>

                    <div>
                        <label for="tonnage_perincian" class="block text-sm font-medium text-gray-700 mb-2">Tonnage Perincian</label>
                        <input type="number" step="0.001" name="tonnage_perincian" id="tonnage_perincian" value="{{ old('tonnage_perincian', $perincian->tonnage_perincian) }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-purple-500 focus:border-purple-500">
                    </div>

                    <div>
                        <label for="volume_perincian" class="block text-sm font-medium text-gray-700 mb-2">Volume/Kubikasi Perincian</label>
                        <input type="number" step="0.001" name="volume_perincian" id="volume_perincian" value="{{ old('volume_perincian', $perincian->volume_perincian) }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-purple-500 focus:border-purple-500">
                    </div>

                    <div>
                        <label for="satuan" class="block text-sm font-medium text-gray-700 mb-2">Satuan</label>
                        <input type="text" name="satuan" id="satuan" value="{{ old('satuan', $perincian->satuan) }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-purple-500 focus:border-purple-500">
                    </div>

                    <div>
                        <label for="kuantitas" class="block text-sm font-medium text-gray-700 mb-2">Kuantitas</label>
                        <input type="number" name="kuantitas" id="kuantitas" value="{{ old('kuantitas', $perincian->kuantitas) }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-purple-500 focus:border-purple-500">
                    </div>

                    <div>
                        <label for="term" class="block text-sm font-medium text-gray-700 mb-2">Term</label>
                        <input type="text" name="term" id="term" value="{{ old('term', $perincian->term) }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-purple-500 focus:border-purple-500">
                    </div>

                    <div>
                        <label for="hs_code" class="block text-sm font-medium text-gray-700 mb-2">HS Code</label>
                        <input type="text" name="hs_code" id="hs_code" value="{{ old('hs_code', $perincian->hs_code) }}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <div class="relative">
                            <div class="dropdown-container-shipper">
                                <input type="hidden" name="shipper_id" id="shipper_id" value="{{ old('shipper_id', $perincian->shipper_id ?? '') }}">
                                <input type="text" id="search_shipper" name="pengirim" placeholder="Search shipper..." autocomplete="off"
                                       ...
                                       value="{{ old('pengirim', $perincian->pengirim) }}">
                                <select id="pengirim_id" class="hidden">
                                    <option value="">- Pilih Shipper -</option>
                                    @if($perincian->pengirim)
                                        <option value="{{ $perincian->pengirim }}" 
                                                data-alamat="{{ $perincian->alamat_pengirim }}"
                                                data-edit-url="{{ $perincian->shipper_id ? route('master.shipper-consignee.edit', $perincian->shipper_id) : '#' }}"
                                                selected>
                                            {{ $perincian->pengirim }}
                                        </option>
                                    @endif
                    ...
                    <div>
                        ...
                        <textarea name="alamat_pengirim" id="alamat_pengirim" rows="1"
                                  class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-purple-500 focus:border-purple-500">{{ old('alamat_pengirim', $perincian->alamat_pengirim) }}</textarea>
                    </div>
                        ...
                        <div class="relative">
                            <div class="dropdown-container-consignee">
                                <input type="text" name="penerima" id="search_consignee" placeholder="Search consignee..." autocomplete="off"
                                       class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:border-purple-500 bg-white text-sm"
                                       value="{{ old('penerima', $perincian->penerima) }}">
                                <select id="penerima_id" class="hidden">
                                    <option value="">- Pilih Consignee -</option>
                                    @if(old('penerima', $perincian->penerima))
                                        <option value="{{ old('penerima', $perincian->penerima) }}" selected>{{ old('penerima', $perincian->penerima) }}</option>
                                    @endif
                                </select>
                    ...
                    <div>
                        ...
                        <input type="text" name="notify_party" id="notify_party" value="{{ old('notify_party', $perincian->notify_party) }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-purple-500 focus:border-purple-500">
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="alamat_notify_party" id="alamat_notify_party" rows="1"
                                  class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-purple-500 focus:border-purple-500">{{ old('alamat_notify_party', $perincian->alamat_notify_party) }}</textarea>
                    </div>

                    <div>
                        <label for="asal_kontainer" class="block text-sm font-medium text-gray-700 mb-2">Asal Kontainer</label>
                        <input type="text" name="asal_kontainer" id="asal_kontainer" value="{{ old('asal_kontainer', $perincian->asal_kontainer) }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-purple-500 focus:border-purple-500">
                    </div>

                    <div>
                        <label for="ke" class="block text-sm font-medium text-gray-700 mb-2">Ke</label>
                        <input type="text" name="ke" id="ke" value="{{ old('ke', $perincian->ke) }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-purple-500 focus:border-purple-500">
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="alamat_pengiriman" id="alamat_pengiriman" rows="3"
                                  class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-purple-500 focus:border-purple-500">{{ old('alamat_pengiriman', $perincian->alamat_pengiriman) }}</textarea>
                    </div>

                    <div>
                        <label for="contact_person" class="block text-sm font-medium text-gray-700 mb-2">Contact Person</label>
                        <input type="text" name="contact_person" id="contact_person" value="{{ old('contact_person', $perincian->contact_person) }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-purple-500 focus:border-purple-500">
                    </div>
                </div>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    initSearchableDropdown({
        ...
        apiUrl: '/api/perincians/search-shippers',
    ...
    initSearchableDropdown({
        ...
        apiUrl: '/api/perincians/search-consignees',
        onSelect: (option, optElement) => {
    ...
    initSearchableDropdown({
        ...
        apiUrl: '/api/perincians/search-prospeks'
    });
