...
@section('page_title', 'Tambah Jenis Barang')
    ...
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900">Tambah Jenis Barang Baru</h1>
                    <p class="mt-1 text-sm text-gray-600">Masukkan informasi jenis barang yang akan ditambahkan</p>
                </div>
