...
@section('title', 'Pilihan Tanggal - Pranota Uang Rit Batam')
...
<div class="min-h-screen bg-gray-50 py-6">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <p class="text-sm text-gray-600 mb-4">Silakan pilih rentang tanggal untuk menampilkan daftar Surat Jalan Batam yang tersedia untuk pranota uang rit.</p>

            <form method="GET" action="{{ route('pranota-uang-rit-batam.create') }}" class="grid grid-cols-1 sm:grid-cols-2 gap-4 items-end">
                <div>
                ...
                <div class="sm:col-span-2 flex gap-3">
                    ...
                    <a href="{{ route('pranota-uang-rit-batam.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-100 text-gray-700 rounded-md hover:bg-gray-200">Batal</a>
                </div>
            </form>
            @if(session('error'))
