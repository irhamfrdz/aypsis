...
@section('title', 'Edit Tarif Batam')
...
<div class="container-fluid px-4">
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h1 class="h3 mb-1 text-gray-800">💰 Edit Tarif Batam</h1>
                    <p class="text-muted">Mengubah tarif pengiriman untuk wilayah Batam</p>
                </div>
    ...
    <div class="card shadow">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Form Edit Tarif Batam</h6>
        </div>
        <div class="card-body">
            <form action="{{ route('tarif-batam.update', $tarifBatam) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" 
                                   ...
                                   id="chasis_ayp" 
                                   name="chasis_ayp" 
                                   value="{{ old('chasis_ayp', $tarifBatam->chasis_ayp) }}"
                                   placeholder="0"
                                   min="0"
                                   step="0.01">
                        </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" 
                                   ...
                                   id="20ft_full" 
                                   name="20ft_full" 
                                   value="{{ old('20ft_full', $tarifBatam->{'20ft_full'}) }}"
                                   placeholder="0"
                                   min="0"
                                   step="0.01">
                        </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" 
                                   ...
                                   id="20ft_empty" 
                                   name="20ft_empty" 
                                   value="{{ old('20ft_empty', $tarifBatam->{'20ft_empty'}) }}"
                                   placeholder="0"
                                   min="0"
                                   step="0.01">
                        </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" 
                                   ...
                                   id="antar_lokasi" 
                                   name="antar_lokasi" 
                                   value="{{ old('antar_lokasi', $tarifBatam->antar_lokasi) }}"
                                   placeholder="0"
                                   min="0"
                                   step="0.01">
                        </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" 
                                   ...
                                   id="40ft_full" 
                                   name="40ft_full" 
                                   value="{{ old('40ft_full', $tarifBatam->{'40ft_full'}) }}"
                                   placeholder="0"
                                   min="0"
                                   step="0.01">
                        </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" 
                                   ...
                                   id="40ft_empty" 
                                   name="40ft_empty" 
                                   value="{{ old('40ft_empty', $tarifBatam->{'40ft_empty'}) }}"
                                   placeholder="0"
                                   min="0"
                                   step="0.01">
                        </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" 
                                   ...
                                   value="{{ old('40ft_antar_lokasi', $tarifBatam->{'40ft_antar_lokasi'}) }}"
                                   placeholder="0"
                                   min="0"
                                   step="0.01">
                        </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" 
                               ...
                               id="masa_berlaku" 
                               name="masa_berlaku" 
                               value="{{ old('masa_berlaku', $tarifBatam->masa_berlaku->format('Y-m-d')) }}"
                               required>
                        @error('masa_berlaku')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select @error('status') is-invalid @enderror" 
                            ...
                            <option value="aktif" {{ old('status', $tarifBatam->status) === 'aktif' ? 'selected' : '' }}>Aktif</option>
                            <option value="nonaktif" {{ old('status', $tarifBatam->status) === 'nonaktif' ? 'selected' : '' }}>Non-aktif</option>
                        </select>
                        @error('status')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <textarea class="form-control @error('keterangan') is-invalid @enderror" 
                                  ...
                                  name="keterangan" 
                                  rows="3"
                                  placeholder="Keterangan tambahan (opsional)">{{ old('keterangan', $tarifBatam->keterangan) }}</textarea>
                        @error('keterangan')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
