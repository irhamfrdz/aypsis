                    ...
                    <table class="permission-matrix">
                        ...
                        <tbody>
                            ...
                            <tr class="submodule-row" data-parent="master">
                                ...
                                <td><input type="checkbox" name="permissions[pranota-puml][view]" value="1" class="permission-checkbox"></td>
                                <td><input type="checkbox" name="permissions[pranota-puml][create]" value="1" class="permission-checkbox"></td>
                                <td><input type="checkbox" name="permissions[pranota-puml][update]" value="1" class="permission-checkbox"></td>
                                <td><input type="checkbox" name="permissions[pranota-puml][delete]" value="1" class="permission-checkbox"></td>
                                <td class="empty-cell"></td>
                                <td class="empty-cell"></td>
                                <td class="empty-cell"></td>
                            </tr>
                            ...
                            <tr class="submodule-row" data-parent="master">
                                <td class="submodule">
                                    <div class="flex items-center">
                                        <span>Data Pricelist Lembur</span>
                                    </div>
                                </td>
                            ...
                            <tr class="submodule-row" data-parent="master">
                                <td class="submodule">
                                    <div class="flex items-center">
                                        <span>Data Pricelist Uang Jalan Batam</span>
                                    </div>
                                </td>
                                <td><input type="checkbox" name="permissions[master-pricelist-uang-jalan-batam][view]" value="1" class="permission-checkbox"></td>
                                <td><input type="checkbox" name="permissions[master-pricelist-uang-jalan-batam][create]" value="1" class="permission-checkbox"></td>
                                <td><input type="checkbox" name="permissions[master-pricelist-uang-jalan-batam][update]" value="1" class="permission-checkbox"></td>
                                <td><input type="checkbox" name="permissions[master-pricelist-uang-jalan-batam][delete]" value="1" class="permission-checkbox"></td>
                                <td class="text-center text-gray-400">-</td>
                                <td>-</td>
                                <td>-</td>
                            </tr>
                            ...
                            <tr class="submodule-row" data-parent="master-tarif">
                                ...
                                <td><input type="checkbox" name="permissions[master-pricelist-freight][view]" value="1" class="permission-checkbox"></td>
                                <td><input type="checkbox" name="permissions[master-pricelist-freight][create]" value="1" class="permission-checkbox"></td>
                                <td><input type="checkbox" name="permissions[master-pricelist-freight][update]" value="1" class="permission-checkbox"></td>
                                <td><input type="checkbox" name="permissions[master-pricelist-freight][delete]" value="1" class="permission-checkbox"></td>
                                <td class="empty-cell"></td>
                                <td class="empty-cell"></td>
                                <td class="empty-cell"></td>
                            </tr>
                            ...
                            <tr class="submodule-row" data-parent="master-tarif">
                                ...
                                <td><input type="checkbox" name="permissions[master-pricelist-vendor-supir][view]" value="1" class="permission-checkbox"></td>
                                <td><input type="checkbox" name="permissions[master-pricelist-vendor-supir][create]" value="1" class="permission-checkbox"></td>
                                <td><input type="checkbox" name="permissions[master-pricelist-vendor-supir][update]" value="1" class="permission-checkbox"></td>
                                <td><input type="checkbox" name="permissions[master-pricelist-vendor-supir][delete]" value="1" class="permission-checkbox"></td>
                                <td class="empty-cell"></td>
                                <td class="empty-cell"></td>
                                <td class="empty-cell"></td>
                            </tr>
                            <tr class="submodule-row" data-parent="master-tarif">
                                ...
                                <td><input type="checkbox" name="permissions[master-pricelist-tujuan-kontainer-sewa][view]" value="1" class="permission-checkbox"></td>
                                <td><input type="checkbox" name="permissions[master-pricelist-tujuan-kontainer-sewa][create]" value="1" class="permission-checkbox"></td>
                                <td><input type="checkbox" name="permissions[master-pricelist-tujuan-kontainer-sewa][update]" value="1" class="permission-checkbox"></td>
                                <td><input type="checkbox" name="permissions[master-pricelist-tujuan-kontainer-sewa][delete]" value="1" class="permission-checkbox"></td>
                                <td class="empty-cell"></td>
                                <td class="empty-cell"></td>
                                <td class="empty-cell"></td>
                            </tr>
                            ...
                            <tr class="submodule-row" data-parent="master-tarif">
                                ...
                                <td><input type="checkbox" name="permissions[master-pricelist-meratus][view]" value="1" class="permission-checkbox"></td>
                                <td><input type="checkbox" name="permissions[master-pricelist-meratus][create]" value="1" class="permission-checkbox"></td>
                                <td><input type="checkbox" name="permissions[master-pricelist-meratus][update]" value="1" class="permission-checkbox"></td>
                                <td><input type="checkbox" name="permissions[master-pricelist-meratus][delete]" value="1" class="permission-checkbox"></td>
                                <td class="empty-cell"></td>
                                <td class="empty-cell"></td>
                                <td class="empty-cell"></td>
                            </tr>
                            ...
                            <tr class="submodule-row" data-parent="master-tarif">
                                ...
                                <td><input type="checkbox" name="permissions[master-pricelist-tanto][view]" value="1" class="permission-checkbox"></td>
                                <td><input type="checkbox" name="permissions[master-pricelist-tanto][create]" value="1" class="permission-checkbox"></td>
                                <td><input type="checkbox" name="permissions[master-pricelist-tanto][update]" value="1" class="permission-checkbox"></td>
                                <td><input type="checkbox" name="permissions[master-pricelist-tanto][delete]" value="1" class="permission-checkbox"></td>
                                <td class="empty-cell"></td>
                                <td class="empty-cell"></td>
                                <td class="empty-cell"></td>
                            </tr>
                            ...
                            <tr class="submodule-row" data-parent="master-tarif">
                                ...
                                <td><input type="checkbox" name="permissions[master-pricelist-pelindo][view]" value="1" class="permission-checkbox"></td>
                                <td><input type="checkbox" name="permissions[master-pricelist-pelindo][create]" value="1" class="permission-checkbox"></td>
                                <td><input type="checkbox" name="permissions[master-pricelist-pelindo][update]" value="1" class="permission-checkbox"></td>
                                <td><input type="checkbox" name="permissions[master-pricelist-pelindo][delete]" value="1" class="permission-checkbox"></td>
                                <td class="empty-cell"></td>
                                <td class="empty-cell"></td>
                                <td class="empty-cell"></td>
                            </tr>
                            ...
                            <tr class="submodule-row" data-parent="operational">
                                ...
                                <td><input type="checkbox" name="permissions[tanda-terima-surat-jalan-tarik-kosong-batam][view]" value="1" class="permission-checkbox"></td>
                                <td><input type="checkbox" name="permissions[tanda-terima-surat-jalan-tarik-kosong-batam][create]" value="1" class="permission-checkbox"></td>
                                <td><input type="checkbox" name="permissions[tanda-terima-surat-jalan-tarik-kosong-batam][update]" value="1" class="permission-checkbox"></td>
                                <td><input type="checkbox" name="permissions[tanda-terima-surat-jalan-tarik-kosong-batam][delete]" value="1" class="permission-checkbox"></td>
                                <td class="empty-cell"></td>
                                <td><input type="checkbox" name="permissions[tanda-terima-surat-jalan-tarik-kosong-batam][print]" value="1" class="permission-checkbox"></td>
                                <td class="empty-cell"></td>
                            </tr>
                            ...
                            <tr class="submodule-row" data-parent="pembayaran">
                                ...
                                <td><input type="checkbox" name="permissions[pembayaran-pranota-uang-jalan-batam][view]" value="1" class="permission-checkbox" @if(old('permissions.pembayaran-pranota-uang-jalan-batam.view')) checked @endif></td>
                                <td><input type="checkbox" name="permissions[pembayaran-pranota-uang-jalan-batam][create]" value="1" class="permission-checkbox" @if(old('permissions.pembayaran-pranota-uang-jalan-batam.create')) checked @endif></td>
                                <td><input type="checkbox" name="permissions[pembayaran-pranota-uang-jalan-batam][update]" value="1" class="permission-checkbox" @if(old('permissions.pembayaran-pranota-uang-jalan-batam.update')) checked @endif></td>
                                <td><input type="checkbox" name="permissions[pembayaran-pranota-uang-jalan-batam][delete]" value="1" class="permission-checkbox" @if(old('permissions.pembayaran-pranota-uang-jalan-batam.delete')) checked @endif></td>
                                <td><input type="checkbox" name="permissions[pembayaran-pranota-uang-jalan-batam][approve]" value="1" class="permission-checkbox" @if(old('permissions.pembayaran-pranota-uang-jalan-batam.approve')) checked @endif></td>
                            ...
                            <tr class="submodule-row" data-parent="pembayaran">
                                ...
                                <td><input type="checkbox" name="permissions[pembayaran-pranota-lembur][view]" value="1" class="permission-checkbox" @if(old('permissions.pembayaran-pranota-lembur.view')) checked @endif></td>
                                <td><input type="checkbox" name="permissions[pembayaran-pranota-lembur][create]" value="1" class="permission-checkbox" @if(old('permissions.pembayaran-pranota-lembur.create')) checked @endif></td>
                                <td><input type="checkbox" name="permissions[pembayaran-pranota-lembur][update]" value="1" class="permission-checkbox" @if(old('permissions.pembayaran-pranota-lembur.update')) checked @endif></td>
                                <td><input type="checkbox" name="permissions[pembayaran-pranota-lembur][delete]" value="1" class="permission-checkbox" @if(old('permissions.pembayaran-pranota-lembur.delete')) checked @endif></td>
                                <td><input type="checkbox" name="permissions[pembayaran-pranota-lembur][approve]" value="1" class="permission-checkbox" @if(old('permissions.pembayaran-pranota-lembur.approve')) checked @endif></td>
                                <td><input type="checkbox" name="permissions[pembayaran-pranota-lembur][print]" value="1" class="permission-checkbox" @if(old('permissions.pembayaran-pranota-lembur.print')) checked @endif></td>
                                <td><input type="checkbox" name="permissions[pembayaran-pranota-lembur][export]" value="1" class="permission-checkbox" @if(old('permissions.pembayaran-pranota-lembur.export')) checked @endif></td>
                            </tr>
                            ...
                            <tr class="submodule-row" data-parent="pembayaran">
                                ...
                                <td><input type="checkbox" name="permissions[pembayaran-pranota-stock][view]" value="1" class="permission-checkbox" @if(old('permissions.pembayaran-pranota-stock.view')) checked @endif></td>
                                <td><input type="checkbox" name="permissions[pembayaran-pranota-stock][create]" value="1" class="permission-checkbox" @if(old('permissions.pembayaran-pranota-stock.create')) checked @endif></td>
                                <td><input type="checkbox" name="permissions[pembayaran-pranota-stock][update]" value="1" class="permission-checkbox" @if(old('permissions.pembayaran-pranota-stock.update')) checked @endif></td>
                                <td><input type="checkbox" name="permissions[pembayaran-pranota-stock][delete]" value="1" class="permission-checkbox" @if(old('permissions.pembayaran-pranota-stock.delete')) checked @endif></td>
                                <td class="empty-cell"></td>
                                <td class="empty-cell"></td>
                                <td class="empty-cell"></td>
                            </tr>
