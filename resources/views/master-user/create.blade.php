                ...
                <div class="overflow-x-auto bg-white rounded-lg border border-gray-200">
                    ...
                    <table class="permission-matrix">
                        ...
                        <tbody>
                            ...
                            {{-- Approval Tugas I --}}
                            <tr class="module-row" data-module="approval-tugas-i">
                                <td class="module-header">
                                    <div class="flex items-center">
                                        <span class="expand-icon text-lg mr-2">▶</span>
                                        <div>
                                            <div class="font-semibold">Approval Tugas I</div>
                                            <div class="text-xs text-gray-500">Modul approval tugas level I</div>
                                        </div>
                                    </div>
                                </td>
                                <td class="text-center text-gray-500 text-sm py-3">
                                    <input type="checkbox" class="approval-tugas-i-header-checkbox permission-checkbox" data-permission="view">
                                </td>
                                <td class="text-center text-gray-500 text-sm py-3">
                                    <input type="checkbox" class="approval-tugas-i-header-checkbox permission-checkbox" data-permission="create">
                                </td>
                                <td class="text-center text-gray-500 text-sm py-3">
                                    <input type="checkbox" class="approval-tugas-i-header-checkbox permission-checkbox" data-permission="update">
                                </td>
                                <td class="text-center text-gray-500 text-sm py-3">
                                    <input type="checkbox" class="approval-tugas-i-header-checkbox permission-checkbox" data-permission="delete">
                                </td>
                                <td class="text-center text-gray-500 text-sm py-3">
                                    <input type="checkbox" class="approval-tugas-i-header-checkbox permission-checkbox" data-permission="approve">
                                </td>
                                <td class="text-center text-gray-500 text-sm py-3">
                                    <input type="checkbox" class="approval-tugas-i-header-checkbox permission-checkbox" data-permission="print">
                                </td>
                                <td class="text-center text-gray-500 text-sm py-3">
                                    <input type="checkbox" class="approval-tugas-i-header-checkbox permission-checkbox" data-permission="export">
                                </td>
                            </tr>

                            {{-- Approval Tugas I Sub-modules --}}
                            <tr class="submodule-row" data-parent="approval-tugas-i">
                                <td class="submodule">
                                    <div class="flex items-center">
                                        <span>Approval Tugas I</span>
                                    </div>
                                </td>
                                <td><input type="checkbox" name="permissions[approval-tugas-i][view]" value="1" class="permission-checkbox"></td>
                                <td><input type="checkbox" name="permissions[approval-tugas-i][create]" value="1" class="permission-checkbox"></td>
                                <td><input type="checkbox" name="permissions[approval-tugas-i][update]" value="1" class="permission-checkbox"></td>
                                <td><input type="checkbox" name="permissions[approval-tugas-i][delete]" value="1" class="permission-checkbox"></td>
                                <td><input type="checkbox" name="permissions[approval-tugas-i][approve]" value="1" class="permission-checkbox"></td>
                                <td><input type="checkbox" name="permissions[approval-tugas-i][print]" value="1" class="permission-checkbox"></td>
                                <td><input type="checkbox" name="permissions[approval-tugas-i][export]" value="1" class="permission-checkbox"></td>
                            </tr>

                            {{-- Approval Tugas II --}}
                            <tr class="module-row" data-module="approval-tugas-ii">
                                <td class="module-header">
                                    <div class="flex items-center">
                                        <span class="expand-icon text-lg mr-2">▶</span>
                                        <div>
                                            <div class="font-semibold">Approval Tugas II</div>
                                            <div class="text-xs text-gray-500">Modul approval tugas level II</div>
                                        </div>
                                    </div>
                                </td>
                                <td class="text-center text-gray-500 text-sm py-3">
                                    <input type="checkbox" class="approval-tugas-ii-header-checkbox permission-checkbox" data-permission="view">
                                </td>
                                <td class="text-center text-gray-500 text-sm py-3">
                                    <input type="checkbox" class="approval-tugas-ii-header-checkbox permission-checkbox" data-permission="create">
                                </td>
                                <td class="text-center text-gray-500 text-sm py-3">
                                    <input type="checkbox" class="approval-tugas-ii-header-checkbox permission-checkbox" data-permission="update">
                                </td>
                                <td class="text-center text-gray-500 text-sm py-3">
                                    <input type="checkbox" class="approval-tugas-ii-header-checkbox permission-checkbox" data-permission="delete">
                                </td>
                                <td class="text-center text-gray-500 text-sm py-3">
                                    <input type="checkbox" class="approval-tugas-ii-header-checkbox permission-checkbox" data-permission="approve">
                                </td>
                                <td class="text-center text-gray-500 text-sm py-3">
                                    <input type="checkbox" class="approval-tugas-ii-header-checkbox permission-checkbox" data-permission="print">
                                </td>
                                <td class="text-center text-gray-500 text-sm py-3">
                                    <input type="checkbox" class="approval-tugas-ii-header-checkbox permission-checkbox" data-permission="export">
                                </td>
                            </tr>

                            {{-- Approval Tugas II Sub-modules --}}
                            <tr class="submodule-row" data-parent="approval-tugas-ii">
                                <td class="submodule">
                                    <div class="flex items-center">
                                        <span>Approval Tugas II</span>
                                    </div>
                                </td>
                                <td><input type="checkbox" name="permissions[approval-tugas-ii][view]" value="1" class="permission-checkbox"></td>
                                <td><input type="checkbox" name="permissions[approval-tugas-ii][create]" value="1" class="permission-checkbox"></td>
                                <td><input type="checkbox" name="permissions[approval-tugas-ii][update]" value="1" class="permission-checkbox"></td>
                                <td><input type="checkbox" name="permissions[approval-tugas-ii][delete]" value="1" class="permission-checkbox"></td>
                                <td><input type="checkbox" name="permissions[approval-tugas-ii][approve]" value="1" class="permission-checkbox"></td>
                                <td><input type="checkbox" name="permissions[approval-tugas-ii][print]" value="1" class="permission-checkbox"></td>
                                <td><input type="checkbox" name="permissions[approval-tugas-ii][export]" value="1" class="permission-checkbox"></td>
                            </tr>
...
@push('scripts')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // Initialize check all approval tugas i permissions
            initializeCheckAllApprovalTugasI();

            // Initialize check all approval tugas ii permissions
            initializeCheckAllApprovalTugasII();
            ...
            function initializeCheckAllApprovalTugasI() {
                // Handle header checkbox changes
                document.querySelectorAll('.approval-tugas-i-header-checkbox').forEach(function(headerCheckbox) {
                    headerCheckbox.addEventListener('change', function() {
                        const permission = this.dataset.permission;
                        const isChecked = this.checked;

                        // Update all checkboxes for this permission in approval tugas i sub-modules
                        const approvalTugasICheckboxes = document.querySelectorAll(`[data-parent="approval-tugas-i"] input[name*="[${permission}]"]`);
                        approvalTugasICheckboxes.forEach(function(checkbox) {
                            checkbox.checked = isChecked;
                        });

                        // Show toast notification
                        if (isChecked) {
                            showToast(`✅ Semua izin ${permission} Approval Tugas I telah dicentang`, 'success');
                        } else {
                            showToast(`❌ Semua izin ${permission} Approval Tugas I telah dihapus`, 'warning');
                        }
                    });
                });

                // Handle sub-module checkbox changes to update header checkboxes
                document.querySelectorAll('[data-parent="approval-tugas-i"] .permission-checkbox').forEach(function(subCheckbox) {
                    subCheckbox.addEventListener('change', function() {
                        updateApprovalTugasIHeaderCheckboxes();
                    });
                });
            ...
            function updateApprovalTugasIHeaderCheckboxes() {
                const permissions = ['view', 'create', 'update', 'delete', 'approve', 'print', 'export'];

                permissions.forEach(function(permission) {
                    const headerCheckbox = document.querySelector(`.approval-tugas-i-header-checkbox[data-permission="${permission}"]`);
                    const approvalTugasICheckboxes = document.querySelectorAll(`[data-parent="approval-tugas-i"] input[name*="[${permission}]"]`);

                    if (headerCheckbox && approvalTugasICheckboxes.length > 0) {
                        const allChecked = Array.from(approvalTugasICheckboxes).every(cb => cb.checked);
                        const someChecked = Array.from(approvalTugasICheckboxes).some(cb => cb.checked);
            ...
            function initializeCheckAllApprovalTugasII() {
                // Handle header checkbox changes
                document.querySelectorAll('.approval-tugas-ii-header-checkbox').forEach(function(headerCheckbox) {
                    headerCheckbox.addEventListener('change', function() {
                        const permission = this.dataset.permission;
                        const isChecked = this.checked;

                        // Update all checkboxes for this permission in approval tugas ii sub-modules
                        const approvalTugasIICheckboxes = document.querySelectorAll(`[data-parent="approval-tugas-ii"] input[name*="[${permission}]"]`);
                        approvalTugasIICheckboxes.forEach(function(checkbox) {
                            checkbox.checked = isChecked;
                        });

                        // Show toast notification
                        if (isChecked) {
                            showToast(`✅ Semua izin ${permission} Approval Tugas II telah dicentang`, 'success');
                        } else {
                            showToast(`❌ Semua izin ${permission} Approval Tugas II telah dihapus`, 'warning');
                        }
                    });
                });

                // Handle sub-module checkbox changes to update header checkboxes
                document.querySelectorAll('[data-parent="approval-tugas-ii"] .permission-checkbox').forEach(function(subCheckbox) {
                    subCheckbox.addEventListener('change', function() {
                        updateApprovalTugasIIHeaderCheckboxes();
                    });
                });
            ...
            function updateApprovalTugasIIHeaderCheckboxes() {
                const permissions = ['view', 'create', 'update', 'delete', 'approve', 'print', 'export'];

                permissions.forEach(function(permission) {
                    const headerCheckbox = document.querySelector(`.approval-tugas-ii-header-checkbox[data-permission="${permission}"]`);
                    const approvalTugasIICheckboxes = document.querySelectorAll(`[data-parent="approval-tugas-ii"] input[name*="[${permission}]"]`);

                    if (headerCheckbox && approvalTugasIICheckboxes.length > 0) {
                        const allChecked = Array.from(approvalTugasIICheckboxes).every(cb => cb.checked);
                        const someChecked = Array.from(approvalTugasIICheckboxes).some(cb => cb.checked);
