...
<div class="max-w-full mx-auto px-3 py-2 overflow-hidden">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 mb-4">
        <div>
            <h1 class="text-lg font-semibold text-gray-900">Pranota Uang Jalan Batam Batam</h1>
            <p class="text-xs text-gray-600 mt-0.5">Kelola pranota pembayaran Uang Jalan Batam</p>
        </div>
        <a href="{{ route('pranota-uang-jalan-batam.create') }}" 
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4 mb-4">
        <form method="GET" action="{{ route('pranota-uang-jalan-batam.index') }}">
                ...
                <div class="md:col-span-2">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" 
                               ...
                               placeholder="Cari nomor pranota atau nomor Uang Jalan Batam..."
                    ...
                    <a href="{{ route('pranota-uang-jalan-batam.index') }}" 
                       class="bg-gray-200 hover:bg-gray-300 text-gray-700 px-4 py-2.5 rounded-lg text-sm font-medium transition-colors">
                        Reset
                          ...
                          @can('pranota-uang-jalan-batam-export')
                          <a href="{{ route('pranota-uang-jalan-batam.export') }}?{{ http_build_query(request()->only(['search', 'status'])) }}" 
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200 resizable-table" id="pranotaUangJalanTable">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse($pranotaUangJalanBatams as $index => $pranota)
                        <tr class="hover:bg-gray-50 transition-colors">
                            <td class="px-2 py-2.5 whitespace-nowrap text-sm text-gray-900 font-medium">
                                {{ $pranotaUangJalanBatams->firstItem() + $index }}
                            </td>
                            ...
                            <td class="px-2 py-2.5 whitespace-nowrap text-center">
                                <div class="flex items-center justify-center space-x-1">
                                    <a href="{{ route('pranota-uang-jalan-batam.show', $pranota) }}" 
                                    ...
                                    <a href="{{ route('pranota-uang-jalan-batam.print', $pranota) }}" 
                                    ...
                                    @if($pranota->status_pembayaran == 'unpaid')
                                        <a href="{{ route('pranota-uang-jalan-batam.edit', $pranota) }}" 
                                    ...
                                    <form action="{{ route('pranota-uang-jalan-batam.destroy', $pranota) }}" 
                                          method="POST" 
                                          class="inline"
                        ...
                        <tr>
                            <td colspan="7" class="px-2 py-8 text-center">
                                <div class="flex flex-col items-center justify-center">
                                    ...
                                    <p class="text-gray-500 text-sm mb-3">Belum ada Pranota Uang Jalan Batam Batam yang tersedia</p>
                                    <a href="{{ route('pranota-uang-jalan-batam.create') }}" 
        ...
        <!-- Pagination -->
        @if($pranotaUangJalanBatams->hasPages())
            <div class="bg-gray-50 px-3 py-2 border-t border-gray-200">
                {{ $pranotaUangJalanBatams->links() }}
            </div>
        @endif
    </div>
