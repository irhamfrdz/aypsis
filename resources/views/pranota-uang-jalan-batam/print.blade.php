...
<head>
    ...
    <title>Print Permohonan Transfer - {{ $pranotaUangJalanBatam->nomor_pranota }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <div class="container">
        ...
        <div class="header">
            ...
            <div style="display: flex; justify-content: space-between; align-items: center; margin-top: 10px; font-size: 10px;">
                <span><strong>No Pranota : {{ $pranotaUangJalanBatam->nomor_pranota }}</strong></span>
                <span><strong>Tgl Uang Jalan Batam : {{ $pranotaUangJalanBatam->tanggal_pranota->format('d-m-Y') }}</strong></span>
            </div>
        </div>

        <!-- Uang Jalan Batam Table -->
            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th style="width: 10%">Uang Jalan Batam</th>
                ...
                <tbody>
                    ...
                    <!-- Penyesuaian Row -->
                    @if($pranotaUangJalanBatam->penyesuaian != 0)
                    <tr>
                        <td colspan="7" style="text-align: center; font-weight: bold;">Penyesuaian</td>
                        <td class="text-right">{{ number_format($pranotaUangJalanBatam->penyesuaian, 0, ',', '.') }}</td>
                    ...
                    <tr style="background-color: #f0f0f0; font-weight: bold;">
                        ...
                        <td class="text-right">{{ number_format($pranotaUangJalanBatam->total_with_penyesuaian, 0, ',', '.') }}</td>
                        <td class="text-right">{{ number_format($pranotaUangJalanBatam->total_with_penyesuaian, 0, ',', '.') }}</td>
                    </tr>
                </tbody>
            </table>
