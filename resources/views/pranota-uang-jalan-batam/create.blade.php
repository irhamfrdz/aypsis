...
<div class="container mx-auto px-3 py-2">
    <div class="max-w-6xl mx-auto">
        ...
        <form action="{{ route('pranota-uang-jalan-batam.store') }}" method="POST" id="pranotaForm">
            @csrf
            ...
            <div class="bg-blue-50 border border-blue-200 p-3 mb-4 rounded">
                <div class="flex items-center">
                    ...
                    <div class="text-xs text-blue-800">
                        ...
                        dan status Uang Jalan Batam yang dipilih akan berubah dari 
            ...
            <!-- Available Uang Jalan Batam -->
            <div class="bg-white rounded border border-gray-200 p-4 mb-4">
                <div class="flex justify-between items-center mb-3">
                    <h3 class="text-sm font-medium text-gray-900">Pilih Uang Jalan Batam</h3>
                ...
                @if($availableUangJalanBatams->count() > 0)
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @foreach($availableUangJalanBatams as $uangJalan)
                    ...
                    <div class="mt-4 p-3 bg-gray-50 rounded">
                        <div class="flex justify-between items-center">
                            <div class="text-sm text-gray-600">
                                <span id="selectedCount">0</span> Uang Jalan Batam dipilih
                            </div>
                            <div class="text-sm font-semibold text-gray-900">
