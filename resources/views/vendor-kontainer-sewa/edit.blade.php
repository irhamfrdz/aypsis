                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            <select name="status"
                                ...
                                <option value="aktif" {{ old('status', $vendorKontainerSewa->status) === 'aktif' ? 'selected' : '' }}>Aktif</option>
                                <option value="non-aktif" {{ old('status', $vendorKontainerSewa->status) === 'non-aktif' ? 'selected' : '' }}>Non-Aktif</option>
                            </select>
