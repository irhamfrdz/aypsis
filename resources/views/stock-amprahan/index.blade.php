...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between mb-8">
        ...
        <div class="mt-4 md:mt-0 flex space-x-2">
            ...
            <button type="button" onclick="openValuasiModal()" class="inline-flex items-center px-4 py-2 bg-rose-600 hover:bg-rose-700 text-white text-sm font-semibold rounded-lg shadow-sm transition-all duration-200" style="background-color: #e11d48; color: white;">
                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="mb-6 p-4 bg-red-50 border-l-4 border-red-500 rounded-r-lg shadow-sm flex items-start">
        ...
        <div class="ml-3 w-full">
            <h3 class="text-sm font-medium text-red-800">Proses Gagal</h3>
            <div class="mt-1 text-sm text-red-700 whitespace-pre-wrap">
                {!! session('error') !!}
            </div>
        </div>
    </div>
                                        ...
                                        <div>
                                          ...
                                          <div class="relative" id="kantor_dropdown">
                                             ...
                                             <div id="kantor_options_list" class="absolute z-[60] w-full mt-1 bg-white shadow-lg max-h-60 rounded-md py-1 text-base ring-1 ring-black ring-opacity-5 overflow-auto focus:outline-none sm:text-sm hidden border border-gray-100">
                                                 <div class="kantor-option cursor-pointer select-none relative py-2.5 pl-4 pr-9 hover:bg-blue-50 text-gray-900 transition-colors duration-150 border-b border-gray-50 last:border-0" data-value="MONTIR GARASI PLUIT" onclick="selectKantor('MONTIR GARASI PLUIT')">MONTIR GARASI PLUIT</div>
                                                 <div class="kantor-option cursor-pointer select-none relative py-2.5 pl-4 pr-9 hover:bg-blue-50 text-gray-900 transition-colors duration-150 border-b border-gray-50 last:border-0" data-value="MONTIR PELABUHAN" onclick="selectKantor('MONTIR PELABUHAN')">MONTIR PELABUHAN</div>
                                                 <div class="kantor-option cursor-pointer select-none relative py-2.5 pl-4 pr-9 hover:bg-blue-50 text-gray-900 transition-colors duration-150 border-b border-gray-50 last:border-0" data-value="TUKANG LAS GARASI" onclick="selectKantor('TUKANG LAS GARASI')">TUKANG LAS GARASI</div>
                                                 <div class="kantor-option cursor-pointer select-none relative py-2.5 pl-4 pr-9 hover:bg-blue-50 text-gray-900 transition-colors duration-150 border-b border-gray-50 last:border-0" data-value="TUKANG TAMBAL BAN GARASI" onclick="selectKantor('TUKANG TAMBAL BAN GARASI')">TUKANG TAMBAL BAN GARASI</div>
                                                 <div class="kantor-option cursor-pointer select-none relative py-2.5 pl-4 pr-9 hover:bg-blue-50 text-gray-900 transition-colors duration-150 border-b border-gray-50 last:border-0" data-value="KENEK MONTIR GARASI" onclick="selectKantor('KENEK MONTIR GARASI')">KENEK MONTIR GARASI</div>
                                                 ...
                                                 <div class="kantor-option cursor-pointer select-none relative py-2.5 pl-4 pr-9 hover:bg-blue-50 text-gray-900 transition-colors duration-150 border-b border-gray-50 last:border-0" data-value="KANTOR PLUIT" onclick="selectKantor('KANTOR PLUIT')">KANTOR PLUIT</div>
                                         ...
                                         <div class="hidden" id="odometer_group">
                                             <label for="odometer" class="block text-sm font-medium text-gray-700 mb-1">Odometer (Opsional)</label>
                                             <input type="number" name="odometer" id="odometer" class="block w-full px-4 py-2.5 border border-gray-300 rounded-lg shadow-sm placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 sm:text-sm transition duration-150 ease-in-out" placeholder="Masukkan odometer...">
                                         </div>
                                         <div>
...
<script>
    ...
    openUsageModal = function(id, name, stock, unit) {
        ...
        filterLainLainOptions('');
        closeLainLainDropdown();

        // Odometer visibility reset
        document.getElementById('odometer').value = '';
        checkIndexOdometerVisibility();
    };
...
<script>
    ...
    function checkIndexOdometerVisibility() {
        const kendaraanId = document.getElementById('kendaraan_id_hidden')?.value || '';
        const truckId = document.getElementById('truck_id_hidden')?.value || '';
        const alatBeratId = document.getElementById('alat_berat_id_hidden')?.value || '';
        const odometerGroup = document.getElementById('odometer_group');
        if (!odometerGroup) return;
        
        if (kendaraanId || truckId || alatBeratId) {
