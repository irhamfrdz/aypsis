...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between mb-8">
        ...
        <div class="mt-4 md:mt-0 flex space-x-2 no-print">
            ...
            <a href="{{ route('stock-amprahan.export-history-excel', array_merge(request()->all(), ['id' => isset($item) ? $item->id : null])) }}" 
               class="inline-flex items-center px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white text-sm font-semibold rounded-lg shadow-sm transition-all duration-200">
                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
