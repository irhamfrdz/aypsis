                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="flex items-center space-x-4 p-5 rounded-2xl bg-gray-50/80 border border-gray-100">
                            ...
                            <div>
                                <p class="text-[10px] font-bold text-gray-400 uppercase tracking-widest leading-none mb-1">Nama Toko (Vendor)</p>
                        ...
                        <div class="flex items-center space-x-4 p-5 rounded-2xl bg-gray-50/80 border border-gray-100">
                            ...
                            <div>
                                <p class="text-[10px] font-bold text-gray-400 uppercase tracking-widest leading-none mb-1">Status Pranota</p>
                                <p class="text-lg font-black tracking-tight leading-none {{ $item->status_pranota == 'Sudah' ? 'text-indigo-600' : 'text-gray-400' }}">
                                    {{ $item->status_pranota == 'Sudah' ? 'SUDAH DIBUAT PRANOTA' : 'BELUM DIBUAT PRANOTA' }}
                                </p>
                            </div>
                        </div>
