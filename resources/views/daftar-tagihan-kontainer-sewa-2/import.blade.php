...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function displayImportResults(response) {
        ...
        if (!response.validate_only && response.success) {
            html += '<a href="{{ route("daftar-tagihan-kontainer-sewa-2.index") }}" class="bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-lg transition-colors duration-150">Lihat Data</a>';
        }
