...
<div class="container mx-auto p-4">
    <div class="max-w-4xl mx-auto">
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <div class="relative inline-block">
                        ...
                        <div id="templateDropdownMenu" class="hidden absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-lg border border-gray-200 z-10">
                            <a href="{{ route('daftar-tagihan-kontainer-sewa-2.export-template', ['format' => 'standard']) }}"
                            ...
                            <a href="{{ route('daftar-tagihan-kontainer-sewa-2.export-template', ['format' => 'dpe']) }}"
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
            ...
            <form id="importForm" action="{{ route('daftar-tagihan-kontainer-sewa-2.import.process') }}" method="POST" enctype="multipart/form-data">
                @csrf
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function displayImportResults(response) {
        ...
        if (!response.validate_only && response.success) {
            html += '<a href="{{ route("daftar-tagihan-kontainer-sewa-2.index", [], false) }}" class="bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-lg transition-colors duration-150">Lihat Data</a>';
        }
