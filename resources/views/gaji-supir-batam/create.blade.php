            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <div class="relative rounded-md shadow-sm">
                        ...
                        <input type="number" name="biaya_bensin" id="biaya_bensin" value="{{ old('biaya_bensin', 0) }}" min="0" class="block w-full pl-9 pr-3 py-2 border border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500 text-sm bg-white font-semibold" placeholder="0">
                    </div>
                </div>
            </div>
        </div>
