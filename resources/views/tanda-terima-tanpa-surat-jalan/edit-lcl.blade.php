                            ...
                            @foreach($tandaTerima->items as $index => $item)
                                <div class="dimensi-row mb-4 pb-4 border-b border-purple-200">
                                    <div class="flex justify-end mb-2">
                                        <button type="button" class="remove-dimensi-btn inline-flex items-center gap-1 px-2 py-1 text-xs font-medium text-red-600 bg-red-50 hover:bg-red-100 border border-red-200 rounded transition" title="Hapus barang ini" onclick="removeDimensiRow(this)">
