...
@section('content')
<div class="min-h-screen bg-gradient-to-br from-gray-50 via-white to-green-50 py-6 sm:py-12 px-3 sm:px-4 lg:px-8">
    <div class="max-w-6xl mx-auto">
        ...
        <div class="text-center mb-8 sm:mb-12">
            ...
            <p class="text-sm sm:text-base lg:text-lg text-gray-600 px-4">
                Cabang: <span class="inline-flex items-center px-2.5 py-1 rounded-full text-xs sm:text-sm font-medium bg-green-100 text-green-800">{{ $cabangNama }}</span>
            </p>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-8 sm:mb-12">
            @forelse($gudangs as $gudang)
                <a href="{{ route('checkpoint-kontainer-masuk.kontainer', ['cabangSlug' => $cabangSlug, 'gudangId' => $gudang->id]) }}" 
                   class="group relative bg-white rounded-xl sm:rounded-2xl shadow-lg hover:shadow-2xl active:shadow-xl transition-all duration-300 overflow-hidden border-2 border-transparent hover:border-green-400 active:scale-95 sm:active:scale-100 sm:hover:-translate-y-1 touch-manipulation">
                    ...
                    <div class="relative p-5 sm:p-8">
                        ...
                        <h3 class="text-lg sm:text-xl font-bold text-gray-900 mb-1 sm:mb-2 group-hover:text-green-600 transition-colors">{{ $gudang->nama_gudang }}</h3>
