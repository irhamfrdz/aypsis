...
@section('page_title', 'Edit Langsir Kontainer Batam')
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div class="px-6 py-4 border-b border-gray-200 bg-white flex justify-between items-center">
                <div>
                    <h1 class="text-xl font-bold text-gray-900">Edit Langsir Kontainer Batam</h1>
                    <p class="text-xs text-gray-600 mt-1">Update data pengiriman langsir: <span class="font-bold text-blue-600">{{ $langsir->no_transaksi }}</span></p>
                </div>
            ...
            <form action="{{ route('langsir-batam.update', $langsir->id) }}" method="POST" class="p-6">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            <label class="block text-xs font-semibold text-gray-700 mb-1 uppercase tracking-wider">No. Transaksi</label>
                            <input type="text" value="{{ $langsir->no_transaksi }}" readonly 
                        ...
                        <div>
                            ...
                            <input type="text" name="no_surat_jalan" value="{{ old('no_surat_jalan', $langsir->no_surat_jalan) }}" placeholder="Contoh: SJ-2026/001 (Opsional)"
                        ...
                        <div>
                            ...
                            <input type="date" name="tanggal" value="{{ old('tanggal', $langsir->tanggal->format('Y-m-d')) }}" required
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div class="relative kontainer-dropdown-container">
                                ...
                                <div class="relative">
                                    <input type="text" id="kontainer_search" placeholder="Cari kontainer..." autocomplete="off" value="{{ old('no_kontainer', $langsir->no_kontainer) }}"
                                    ...
                                    <input type="hidden" name="no_kontainer" id="no_kontainer" value="{{ old('no_kontainer', $langsir->no_kontainer) }}">
                            ...
                            <div>
                                ...
                                <select name="size" id="size_select" required class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all">
                                    <option value="20FT" {{ old('size', $langsir->size) == '20FT' ? 'selected' : '' }}>20 FT</option>
                                    <option value="40FT" {{ old('size', $langsir->size) == '40FT' ? 'selected' : '' }}>40 FT</option>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-2 gap-4" id="rute_grid_container">
                            <div class="relative dari-dropdown-container">
                                ...
                                <div class="relative">
                                    <input type="text" name="dari" id="dari_search" placeholder="Cari Lokasi Asal..." autocomplete="off" value="{{ old('dari', $langsir->dari) }}" required
                            ...
                            <div class="relative ke-dropdown-container">
                                ...
                                <div class="relative">
                                    <input type="text" name="ke" id="ke_search" placeholder="Cari Lokasi Tujuan..." autocomplete="off" value="{{ old('ke', $langsir->ke) }}" required
                                           class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none transition-all uppercase">
                        ...
                        <div class="flex items-center pt-1">
                            <input type="checkbox" name="ob_dalam_pelabuhan" id="ob_dalam_pelabuhan" value="1" 
                                   {{ old('ob_dalam_pelabuhan', $langsir->ob_dalam_pelabuhan) ? 'checked' : '' }}
                        ...
                        <div class="relative supir-dropdown-container">
                            ...
                            <div class="relative">
                                <input type="text" id="supir_search" value="{{ old('supir', $langsir->supir) }}" placeholder="Cari supir..." autocomplete="off"
                                ...
                                <input type="hidden" name="supir_karyawan_id" id="supir_karyawan_id" value="{{ old('supir_karyawan_id', $langsir->supir_karyawan_id) }}">
                                <input type="hidden" name="supir" id="supir_name" value="{{ old('supir', $langsir->supir) }}">
                        ...
                        <div>
                            ...
                            <input type="text" name="no_plat" id="no_plat" value="{{ old('no_plat', $langsir->no_plat) }}" placeholder="Otomatis terisi saat pilih supir"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" name="biaya_display" id="biaya_display" 
                                           value="{{ old('biaya_display', number_format($langsir->biaya, 0, ',', '.')) }}" required
                                    ...
                                    <input type="hidden" name="biaya" id="biaya" value="{{ old('biaya', $langsir->biaya) }}">
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <textarea name="keterangan" rows="2" placeholder="Catatan tambahan jika ada..."
                                          class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all">{{ old('keterangan', $langsir->keterangan) }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
