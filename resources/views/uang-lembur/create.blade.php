                ...
                <form action="{{ route('uang-lembur.store') }}" method="POST" id="lemburForm">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                        <div>
                            ...
                            <input type="text" name="group" id="group" value="{{ old('group', 'LEMBUR') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required>
                        </div>

                        <div>
                            <label for="sub_group" class="block text-sm font-medium text-gray-700">Sub Group <span class="text-red-500">*</span></label>
                            <input type="text" name="sub_group" id="sub_group" value="{{ old('sub_group') }}" placeholder="Contoh: PELABUHAN 1, GARASI" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="mt-1 relative rounded-md shadow-sm">
                                <input type="number" step="0.5" min="0" name="pengali_uang_makan_hari_libur" id="pengali_uang_makan_hari_libur" value="{{ old('pengali_uang_makan_hari_libur', 1) }}" class="block w-full pr-8 border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" placeholder="1">
