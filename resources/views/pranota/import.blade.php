                                    ...
                                    <div class="mt-2 space-y-2">
                                        @foreach($result['pranota_details'] as $detail)
                                            <div class="text-xs p-2 bg-gray-50 border border-gray-200 rounded">
                                                ...
                                                <div class="mt-1">
                                                    <span class="font-medium">Group {{ $detail['group'] }}</span> -
                                                    <span class="font-medium">Periode {{ $detail['periode'] }}</span>
                                                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-3 text-xs">
                    <div class="bg-white bg-opacity-60 rounded p-2.5 border border-blue-100">
                        ...
                        <ul class="text-blue-800 space-y-0.5 ml-5">
                            <li>• <strong>Group</strong> & <strong>Periode</strong> (wajib)</li>
                            <li>• <strong>Nomor Kontainer</strong> (auto-detect)</li>
                    ...
                    <div class="bg-white bg-opacity-60 rounded p-2.5 border border-indigo-100">
                        <h4 class="font-semibold text-indigo-900 mb-1.5 flex items-center">
                            <span class="bg-indigo-500 text-white rounded-full w-4 h-4 flex items-center justify-center text-[10px] mr-1.5">2</span>
                            Hasil Import
                        </h4>
                        <ul class="text-indigo-800 space-y-0.5 ml-5">
                            <li>• 1 pranota = beberapa kontainer</li>
                            <li>• Grouped by Group & Periode</li>
                            <li>• Status → "masuk pranota"</li>
                        </ul>
                    </div>
                </div>

                <div class="mt-2.5 p-2 bg-blue-100 bg-opacity-70 border border-blue-300 rounded text-xs flex items-start">
                    ...
                    <div>
                        <strong>Tips:</strong> Gunakan file export dari "Daftar Tagihan Kontainer Sewa" untuk import otomatis
                    </div>
                </div>
