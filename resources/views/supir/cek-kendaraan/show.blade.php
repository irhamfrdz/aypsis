            ...
            <div class="md:col-span-2">
                <div class="glass-card rounded-2xl p-6 shadow-xl">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div class="flex items-center justify-between p-4 rounded-xl border {{ $cekKendaraan->lampu_rem_kiri === 'berfungsi' ? 'bg-green-50 border-green-100' : 'bg-red-50 border-red-100' }}">
                            <span class="text-sm font-medium text-gray-700">Lampu Rem Kiri</span>
                            <div class="flex items-center">
                                @if($cekKendaraan->lampu_rem_kiri === 'berfungsi')
                                    <span class="text-xs font-bold text-green-700 uppercase">BERFUNGSI</span>
                                    <svg class="w-5 h-5 ml-2 text-green-500" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg>
                                @else
                                    <span class="text-xs font-bold text-red-700 uppercase">TIDAK BERFUNGSI</span>
                        ...
                        <div class="flex items-center justify-between p-4 rounded-xl border {{ $cekKendaraan->lampu_alarm_mundur === 'berfungsi' ? 'bg-green-50 border-green-100' : 'bg-red-50 border-red-100' }}">
                            <span class="text-sm font-medium text-gray-700">Lampu Alarm Mundur</span>
                            <div class="flex items-center">
                                @if($cekKendaraan->lampu_alarm_mundur === 'berfungsi')
                                    <span class="text-xs font-bold text-green-700 uppercase">BERFUNGSI</span>
                                    <svg class="w-5 h-5 ml-2 text-green-500" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg>
                                @else
                                    <span class="text-xs font-bold text-red-700 uppercase">TIDAK BERFUNGSI</span>
                        ...
                        <div class="flex items-center justify-between p-4 rounded-xl border {{ $cekKendaraan->kamvas_rem_depan_kanan === 'berfungsi' ? 'bg-green-50 border-green-100' : 'bg-red-50 border-red-100' }}">
                            <span class="text-sm font-medium text-gray-700">Kamvas Rem Depan Kanan</span>
                            <div class="flex items-center">
                                @if($cekKendaraan->kamvas_rem_depan_kanan === 'berfungsi')
                                    <span class="text-xs font-bold text-green-700 uppercase">BERFUNGSI</span>
                                    <svg class="w-5 h-5 ml-2 text-green-500" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg>
                                @else
                                    <span class="text-xs font-bold text-red-700 uppercase">TIDAK BERFUNGSI</span>
