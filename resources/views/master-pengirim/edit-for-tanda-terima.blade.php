            ...
            <form action="{{ route('tanda-terima.pengirim.update', $pengirim->id) }}" method="POST" class="space-y-6" id="pengirimForm">
                ...
                <div>
                    ...
                    <input type="text" name="pic" id="pic" value="{{ old('pic', $pengirim->pic) }}"
                           class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-amber-500 focus:border-amber-500 @error('pic') border-red-500 @enderror"
                ...
                <div>
                    ...
                    <input type="text" name="contact_person" id="contact_person" value="{{ old('contact_person', $pengirim->contact_person) }}"
                           class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-amber-500 focus:border-amber-500 @error('contact_person') border-red-500 @enderror"
                ...
                <div>
                    ...
                    <input type="text" name="telepon" id="telepon" value="{{ old('telepon', $pengirim->telepon) }}"
                           class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-amber-500 focus:border-amber-500 @error('telepon') border-red-500 @enderror"
