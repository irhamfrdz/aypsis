                    ...
                    <tbody class="bg-white divide-y divide-gray-200 text-xs">
                        @forelse ($pengirims as $pengirim)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-3 py-2 text-xs text-gray-900 max-w-xs truncate" title="{{ $pengirim->contact_person }}">{{ $pengirim->contact_person ?: '-' }}</td>
