...
@section('title', 'Tambah Pengirim')
@section('page_title', 'Tambah Pengirim')
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <form action="{{ route('pengirim.store') }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="nama_pengirim" id="nama_pengirim" value="{{ old('nama_pengirim', request('search')) }}" required
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" name="harga_krani_20ft" id="harga_krani_20ft" value="{{ old('harga_krani_20ft', 0) }}" min="0" step="1000"
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" name="harga_krani_40ft" id="harga_krani_40ft" value="{{ old('harga_krani_40ft', 0) }}" min="0" step="1000"
...
<script>
    // Auto-focus on nama_pengirim field if there's a search term
    document.addEventListener('DOMContentLoaded', function() {
        const namaPengirimField = document.getElementById('nama_pengirim');
        const searchTerm = '{{ request("search") }}';

        if (namaPengirimField && searchTerm) {
            namaPengirimField.focus();
            namaPengirimField.select();
        }
    });
</script>
