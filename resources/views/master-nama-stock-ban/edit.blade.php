...
@section('title', 'Edit Nama Stock Ban')
@section('page_title', 'Edit Nama Stock Ban')
    ...
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900">Edit Nama Stock Ban</h1>
                    <p class="mt-1 text-sm text-gray-600">Perbarui informasi nama stock ban</p>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <form action="{{ route('master.nama-stock-ban.update', $namaStockBan->id) }}" method="POST" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div>
                    <label for="nama" class="block text-sm font-medium text-gray-700 mb-2">
                        Nama Stock Ban <span class="text-red-500">*</span>
                    </label>
                    <input type="text" name="nama" id="nama" value="{{ old('nama', $namaStockBan->nama) }}" required
                           ...
                           placeholder="Masukkan nama stock ban">
                    @error('nama')
                ...
                <div>
                    ...
                    <div class="space-y-2">
                        <div class="flex items-center">
                            <input type="radio" name="status" id="status_active" value="active" {{ old('status', $namaStockBan->status) === 'active' ? 'checked' : '' }} required
                        ...
                        <div class="flex items-center">
                            <input type="radio" name="status" id="status_inactive" value="inactive" {{ old('status', $namaStockBan->status) === 'inactive' ? 'checked' : '' }}
                                   class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300">
