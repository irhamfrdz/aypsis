...
@section('page_title', 'Edit Izin')

@section('content')
<div class="bg-white p-6 rounded-lg shadow-md">
    <h2 class="text-2xl font-bold mb-4 text-gray-800">Formulir Edit Izin</h2>
    ...
    <form action="{{ route('master.permission.update', $permission->id) }}" method="POST">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="text" name="name" id="name" class="{{ $inputClasses }}" value="{{ old('name', $permission->name) }}" placeholder="contoh: master-data" required>
            ...
            <div>
                ...
                <input type="text" name="description" id="description" class="{{ $inputClasses }}" value="{{ old('description', $permission->description) }}" placeholder="Contoh: Akses ke Master Karyawan">
