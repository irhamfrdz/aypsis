...
@section('title', 'Import Term CSV')
@section('page_title', 'Import Term CSV')
...
<div class="min-h-screen bg-gray-50 py-6">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                <div class="mb-4 sm:mb-0">
                    <h1 class="text-3xl font-bold text-gray-900">Import Term CSV</h1>
                    <p class="mt-1 text-sm text-gray-600">Upload file CSV untuk import data term secara massal</p>
                </div>
                <div class="flex flex-col sm:flex-row gap-3">
                    ...
                    <a href="{{ route('term.index') }}" class="inline-flex items-center justify-center px-4 py-2 bg-gray-500 text-white text-sm font-medium rounded-lg hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 transition-colors duration-200 shadow-sm">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="flex items-start">
                ...
                <div>
                    ...
                    <div class="text-sm text-blue-700 space-y-2">
                        ...
                        <p><strong>3. Header Kolom:</strong> kode, nama_status, catatan, status</p>
                        <p><strong>4. Ketentuan Data:</strong></p>
                        <ul class="ml-4 space-y-1">
                            <li>• <strong>kode:</strong> Wajib diisi, maksimal 50 karakter, harus unik</li>
                            <li>• <strong>nama_status:</strong> Wajib diisi, maksimal 255 karakter</li>
                            <li>• <strong>catatan:</strong> Opsional, maksimal 1000 karakter</li>
                            <li>• <strong>status:</strong> Wajib diisi, nilai: 'active' atau 'inactive'</li>
                        </ul>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <form action="{{ route('term.import.process') }}" method="POST" enctype="multipart/form-data" class="p-6">
                @csrf
                ...
                <div class="mb-6 p-4 bg-gray-50 rounded-lg">
                    ...
                    <div class="bg-white p-3 rounded border font-mono text-xs overflow-x-auto">
                        <div class="text-gray-600">kode;nama_status;catatan;status</div>
                        <div class="text-gray-800">TERM001;Term of Payment 30 days;Pembayaran dalam 30 hari;active</div>
                        <div class="text-gray-800">TERM002;Cash on Delivery;;inactive</div>
                    </div>
                </div>

                <!-- Action Buttons -->
                <div class="flex flex-col sm:flex-row sm:justify-end gap-3 pt-6 border-t border-gray-200">
                    <a href="{{ route('term.index') }}" class="inline-flex items-center justify-center px-6 py-3 bg-gray-500 text-white text-sm font-medium rounded-lg hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 transition-colors duration-200 shadow-sm">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
