...
<div class="min-h-screen bg-gray-50 py-6">
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-600">Ubah informasi term</p>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <form action="{{ route('term.update', $term) }}" method="POST" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div>
                    ...
                    <input type="text" name="kode" id="kode" value="{{ old('kode', $term->kode) }}" required
                ...
                <div>
                    ...
                    <input type="text" name="nama_status" id="nama_status" value="{{ old('nama_status', $term->nama_status) }}" required
                ...
                <div>
                    ...
                    <textarea name="catatan" id="catatan" rows="4"
                              ...
                              placeholder="Masukkan catatan (opsional)">{{ old('catatan', $term->catatan) }}</textarea>
                    @error('catatan')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <div class="space-y-2">
                        <div class="flex items-center">
                            <input type="radio" name="status" id="status_active" value="active" {{ old('status', $term->status) === 'active' ? 'checked' : '' }} required
                        ...
                        <div class="flex items-center">
                            <input type="radio" name="status" id="status_inactive" value="inactive" {{ old('status', $term->status) === 'inactive' ? 'checked' : '' }}
                                   class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300">
