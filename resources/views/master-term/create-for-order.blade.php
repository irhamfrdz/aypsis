    ...
    <div class="min-h-screen py-6">
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                <form action="{{ route('order.term.store') }}" method="POST" class="space-y-6" id="termForm">
                    @csrf
                    ...
                    <div>
                        ...
                        <input type="text" name="nama_status" id="nama_status" value="{{ old('nama_status', $searchValue ?? '') }}" required
                               ...
                               placeholder="Masukkan nama status term">
                        @error('nama_status')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
