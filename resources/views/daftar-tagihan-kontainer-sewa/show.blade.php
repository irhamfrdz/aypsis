...
<div class="container mx-auto p-4">
    ...
    <div class="bg-white p-4 rounded shadow">
        ...
        <div class="mt-4">
            <a href="{{ route('daftar-tagihan-kontainer-sewa.edit', $item->id ?? 0) }}" class="bg-yellow-500 text-white px-4 py-2 rounded">Edit</a>
            <a href="{{ route('daftar-tagihan-kontainer-sewa.index') }}" class="ml-2 inline-block px-4 py-2 border rounded">Kembali</a>
        </div>
    </div>
</div>
@endsection
