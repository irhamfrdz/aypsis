...
@section('title', 'Tambah Perjalanan Kontainer')
@section('page_title', 'Tambah Perjalanan Kontainer')
...
<div class="min-h-screen bg-gray-50 py-8">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white shadow-lg rounded-lg overflow-hidden mb-6">
            <div class="bg-gradient-to-r from-indigo-600 to-indigo-700 px-6 py-4">
                <div class="flex items-center">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-white">Tambah Perjalanan Kontainer</h1>
                        <p class="text-indigo-100 text-sm">Input data master sewa kontainer baru</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white shadow-lg rounded-lg overflow-hidden">
            <form action="{{ route('container-trip.store') }}" method="POST" class="p-6 space-y-6">
                @csrf
