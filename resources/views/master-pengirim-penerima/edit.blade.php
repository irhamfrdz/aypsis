            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" 
                           name="pic" 
                           id="pic" 
                           value="{{ old('pic', $masterPengirimPenerima->pic) }}"
                ...
                <div>
                    ...
                    <input type="text" 
                           name="contact_person" 
                           id="contact_person" 
                           value="{{ old('contact_person', $masterPengirimPenerima->contact_person) }}"
                ...
                <div>
                    ...
                    <input type="text" 
                           name="telepon" 
                           id="telepon" 
                           value="{{ old('telepon', $masterPengirimPenerima->telepon) }}"
