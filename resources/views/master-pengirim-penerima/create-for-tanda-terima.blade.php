        ...
        <form action="{{ route('tanda-terima.penerima.store') }}" method="POST" class="p-6 space-y-4" id="penerimaForm">
            ...
            <div>
                ...
                <input type="text" 
                       ...
                       name="pic" 
                       value="{{ old('pic') }}"
                       class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 @error('pic') border-red-500 @enderror"
            ...
            <div>
                ...
                <input type="text" 
                       ...
                       name="telepon" 
                       value="{{ old('telepon') }}"
                       class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 @error('telepon') border-red-500 @enderror"
