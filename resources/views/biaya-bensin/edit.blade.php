                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="penerima_rekening" id="penerima_rekening" 
                                       value="{{ old('penerima_rekening', $item->penerima_rekening) }}" 
                        ...
                        <div class="bg-amber-50/40 rounded-2xl border border-amber-100/60 p-4 sm:p-5 space-y-4">
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="number" step="any" id="harga_per_liter" value="{{ old('harga_per_liter', $item->harga_per_liter) }}" placeholder="0"
                            ...
                            <div class="pt-2">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" step="any" name="biaya" id="biaya" value="{{ old('biaya', $item->biaya) }}" required placeholder="0"
