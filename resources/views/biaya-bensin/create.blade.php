...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="mb-6 flex items-center justify-between">
        <div>
            <h1 class="text-3xl font-bold text-gray-900">
                ...
                Catat Biaya Bensin Baru
            </h1>
            <p class="text-gray-600 mt-1">Masukkan informasi pengisian bensin kendaraan</p>
        </div>
    ...
    <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
        <form action="{{ route('biaya-bensin.store') }}" method="POST" class="p-8">
            @csrf
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="keterangan" id="keterangan" rows="3" placeholder="Tambahkan catatan jika diperlukan..."
                                  class="block w-full border-gray-300 rounded-lg shadow-sm focus:ring-amber-500 focus:border-amber-500 sm:text-sm">{{ old('keterangan') }}</textarea>
