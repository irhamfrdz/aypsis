...
@section('title', 'Tambah Tipe Stock Ban')
@section('page_title', 'Tambah Tipe Stock Ban')
    ...
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900">Tambah Tipe Stock Ban Baru</h1>
                    <p class="mt-1 text-sm text-gray-600">Masukkan informasi tipe stock ban yang akan ditambahkan</p>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <form action="{{ route('master.tipe-stock-ban.store') }}" method="POST" class="space-y-6">
                @csrf
                ...
                <div>
                    ...
                    <input type="text" name="nama" id="nama" value="{{ old('nama') }}" required
                           ...
                           placeholder="Masukkan tipe stock ban (misal: Ban Luar, Ban Dalam, Marset)">
                    @error('nama')
