    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
            <div class="flex items-center justify-between">
                ...
                <a href="{{ route('orders-batam.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-600 text-white text-sm font-medium rounded-lg hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 transition-colors duration-200">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <form action="{{ route('orders-batam.update', $orderBatam) }}" method="POST" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div class="border-b border-gray-200 pb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="nomor_order" id="nomor_order" value="{{ old('nomor_order', $orderBatam->nomor_order) }}" required
                        ...
                        <div>
                            ...
                            <input type="date" name="tanggal_order" id="tanggal_order" value="{{ old('tanggal_order', $orderBatam->tanggal_order->format('Y-m-d')) }}" required
                                   class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="no_tiket_do" id="no_tiket_do" value="{{ old('no_tiket_do', $orderBatam->no_tiket_do) }}"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                        ...
                        <div>
                            ...
                            <select name="status" id="status" required
                                ...
                                <option value="draft" {{ old('status', $orderBatam->status) === 'draft' ? 'selected' : '' }}>Draft</option>
                                <option value="confirmed" {{ old('status', $orderBatam->status) === 'confirmed' ? 'selected' : '' }}>Confirmed</option>
                                <option value="processing" {{ old('status', $orderBatam->status) === 'processing' ? 'selected' : '' }}>Processing</option>
                                <option value="completed" {{ old('status', $orderBatam->status) === 'completed' ? 'selected' : '' }}>Completed</option>
                                <option value="cancelled" {{ old('status', $orderBatam->status) === 'cancelled' ? 'selected' : '' }}>Cancelled</option>
                            </select>
                        </div>
                    </div>
                </div>
                                        ...
                                        @foreach($tujuanKirims as $tujuanKirim)
                                            @php
                                                ...
                                                if (old('tujuan_kirim_id')) {
                                                    ...
                                                    $isSelected = ($orderBatam->tujuan_kirim_id == $tujuanKirim->id) ||
                                                                  ($orderBatam->tujuan_kirim == $tujuanKirim->nama_tujuan);
                                                }
                                            @endphp
                                ...
                                <div class="dropdown-container-tujuan-ambil">
                                    ...
                                    <select name="tujuan_ambil" id="tujuan_ambil" required
                                        ...
                                        @foreach($pricelistUangJalanBatams as $item)
                                            ...
                                            @endphp
                                            <option value="{{ $val }}" {{ old('tujuan_ambil', $orderBatam->tujuan_ambil) == $val ? 'selected' : '' }}>
                                        ...
                                        @foreach($terms as $term)
                                            @php
                                                ...
                                                if (old('term_id')) {
                                                    ...
                                                    $isSelected = $orderBatam->term_id == $term->id;
                                                }
                                            @endphp
                                ...
                                <div class="dropdown-container-pengirim">
                                    ...
                                    <select name="pengirim_id" id="pengirim_id" class="hidden w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:border-blue-500">
                                        ...
                                        @foreach($pengirims as $pengirim)
                                            <option value="{{ $pengirim->id }}" {{ old('pengirim_id', $orderBatam->pengirim_id) == $pengirim->id ? 'selected' : '' }}>
                                ...
                                <div class="dropdown-container-jenis-barang">
                                    ...
                                    <select name="jenis_barang_id" id="jenis_barang_id" class="hidden w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:border-blue-500">
                                        ...
                                        @foreach($jenisBarangs as $jenisBarang)
                                            <option value="{{ $jenisBarang->id }}" {{ old('jenis_barang_id', $orderBatam->jenis_barang_id) == $jenisBarang->id ? 'selected' : '' }}>
                                ...
                                <div class="dropdown-container-penerima">
                                    ...
                                    <select name="penerima_id" id="penerima_id" class="hidden w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:border-blue-500">
                                        ...
                                        @foreach($penerimas as $penerima)
                                            <option value="{{ $penerima->id }}" {{ old('penerima_id', $orderBatam->penerima_id) == $penerima->id ? 'selected' : '' }}>
                ...
                <div class="border-b border-gray-200 pb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <div>
                            <label for="size_kontainer" class="block text-sm font-medium text-gray-700 mb-2">Size Kontainer <span class="text-red-500">*</span></label>
                                ...
                                @foreach($ukuranKontainers as $ukuran)
                                    <option value="{{ $ukuran }}" {{ old('size_kontainer', $orderBatam->size_kontainer) === $ukuran ? 'selected' : '' }}>
                                        {{ $ukuran }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div>
                            ...
                            <input type="number" name="unit_kontainer" id="unit_kontainer" value="{{ old('unit_kontainer', $orderBatam->unit_kontainer) }}" required min="1"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500">
                            <small class="text-gray-500">Units untuk outstanding: {{ $orderBatam->units ?? 0 }} | Sisa: {{ $orderBatam->sisa ?? 0 }}</small>
                        </div>
                        ...
                        <div>
                            ...
                            <select name="tipe_kontainer" id="tipe_kontainer" required class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500">
                                ...
                                <option value="fcl" {{ old('tipe_kontainer', $orderBatam->tipe_kontainer) === 'fcl' ? 'selected' : '' }}>FCL</option>
                                <option value="lcl" {{ old('tipe_kontainer', $orderBatam->tipe_kontainer) === 'lcl' ? 'selected' : '' }}>LCL</option>
                                <option value="cargo" {{ old('tipe_kontainer', $orderBatam->tipe_kontainer) === 'cargo' ? 'selected' : '' }}>Cargo</option>
                                <option value="fcl_plus" {{ old('tipe_kontainer', $orderBatam->tipe_kontainer) === 'fcl_plus' ? 'selected' : '' }}>FCL Plus</option>
                            </select>
                        ...
                        <div>
                            ...
                            <div class="flex items-center space-x-4 h-10">
                                <label class="flex items-center space-x-2 cursor-pointer">
                                    <input type="radio" name="f_e" value="Full" {{ old('f_e', $orderBatam->f_e ?? 'Full') === 'Full' ? 'checked' : '' }} 
                                           class="w-4 h-4 text-indigo-600 focus:ring-indigo-500 border-gray-300">
                                    <span class="text-sm text-gray-700">Full</span>
                                </label>
                                <label class="flex items-center space-x-2 cursor-pointer">
                                    <input type="radio" name="f_e" value="Empty" {{ old('f_e', $orderBatam->f_e) === 'Empty' ? 'checked' : '' }} 
                                           class="w-4 h-4 text-indigo-600 focus:ring-indigo-500 border-gray-300">
                        ...
                        <div>
                            ...
                            <input type="date" name="tanggal_pickup" id="tanggal_pickup" value="{{ old('tanggal_pickup', $orderBatam->tanggal_pickup?->format('Y-m-d')) }}"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                    </div>
                </div>
                ...
                <div class="border-b border-gray-200 pb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <div class="space-y-2">
                                <div class="flex items-center">
                                    <input type="radio" name="ftz03_option" id="exclude_ftz03" value="exclude" {{ old('ftz03_option', ($orderBatam->exclude_ftz03 ? 'exclude' : ($orderBatam->include_ftz03 ? 'include' : 'none'))) === 'exclude' ? 'checked' : '' }}
                                           class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300">
                                    <label for="exclude_ftz03" class="ml-2 block text-sm text-gray-900">Exclude FTZ03</label>
                                </div>
                                <div class="flex items-center">
                                    <input type="radio" name="ftz03_option" id="include_ftz03" value="include" {{ old('ftz03_option', ($orderBatam->exclude_ftz03 ? 'exclude' : ($orderBatam->include_ftz03 ? 'include' : 'none'))) === 'include' ? 'checked' : '' }}
                                           class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300">
                                    <label for="include_ftz03" class="ml-2 block text-sm text-gray-900">Include FTZ03</label>
                                </div>
                                <div class="flex items-center">
                                    <input type="radio" name="ftz03_option" id="none_ftz03" value="none" {{ old('ftz03_option', ($orderBatam->exclude_ftz03 ? 'exclude' : ($orderBatam->include_ftz03 ? 'include' : 'none'))) === 'none' ? 'checked' : '' }}
                                           class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300">
                        ...
                        <div>
                            ...
                            <div class="space-y-2">
                                <div class="flex items-center">
                                    <input type="radio" name="sppb_option" id="exclude_sppb" value="exclude" {{ old('sppb_option', ($orderBatam->exclude_sppb ? 'exclude' : ($orderBatam->include_sppb ? 'include' : 'none'))) === 'exclude' ? 'checked' : '' }}
                                           class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300">
                                    <label for="exclude_sppb" class="ml-2 block text-sm text-gray-900">Exclude SPPB</label>
                                </div>
                                <div class="flex items-center">
                                    <input type="radio" name="sppb_option" id="include_sppb" value="include" {{ old('sppb_option', ($orderBatam->exclude_sppb ? 'exclude' : ($orderBatam->include_sppb ? 'include' : 'none'))) === 'include' ? 'checked' : '' }}
                                           class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300">
                                    <label for="include_sppb" class="ml-2 block text-sm text-gray-900">Include SPPB</label>
                                </div>
                                <div class="flex items-center">
                                    <input type="radio" name="sppb_option" id="none_sppb" value="none" {{ old('sppb_option', ($orderBatam->exclude_sppb ? 'exclude' : ($orderBatam->include_sppb ? 'include' : 'none'))) === 'none' ? 'checked' : '' }}
                                           class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300">
                        ...
                        <div>
                            ...
                            <div class="space-y-2">
                                <div class="flex items-center">
                                    <input type="radio" name="buruh_bongkar_option" id="exclude_buruh_bongkar" value="exclude" {{ old('buruh_bongkar_option', ($orderBatam->exclude_buruh_bongkar ? 'exclude' : ($orderBatam->include_buruh_bongkar ? 'include' : 'none'))) === 'exclude' ? 'checked' : '' }}
                                           class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300">
                                    <label for="exclude_buruh_bongkar" class="ml-2 block text-sm text-gray-900">Exclude Buruh Bongkar</label>
                                </div>
                                <div class="flex items-center">
                                    <input type="radio" name="buruh_bongkar_option" id="include_buruh_bongkar" value="include" {{ old('buruh_bongkar_option', ($orderBatam->exclude_buruh_bongkar ? 'exclude' : ($orderBatam->include_buruh_bongkar ? 'include' : 'none'))) === 'include' ? 'checked' : '' }}
                                           class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300">
                                    <label for="include_buruh_bongkar" class="ml-2 block text-sm text-gray-900">Include Buruh Bongkar</label>
                                </div>
                                <div class="flex items-center">
                                    <input type="radio" name="buruh_bongkar_option" id="none_buruh_bongkar" value="none" {{ old('buruh_bongkar_option', ($orderBatam->exclude_buruh_bongkar ? 'exclude' : ($orderBatam->include_buruh_bongkar ? 'include' : 'none'))) === 'none' ? 'checked' : '' }}
                                           class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300">
                ...
                <div>
                    ...
                    <textarea name="catatan" id="catatan" rows="4"
                              class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500"
                              placeholder="Masukkan catatan tambahan (opsional)">{{ old('catatan', $orderBatam->catatan) }}</textarea>
                </div>
