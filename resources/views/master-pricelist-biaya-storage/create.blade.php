...
@section('title', 'Tambah Tarif Storage')

@section('content')
<div class="max-w-3xl mx-auto">
    <div class="flex justify-between items-center mb-6">
        <h2 class="text-xl font-bold text-gray-800">Tambah Tarif Biaya Storage</h2>
    ...
    <div class="bg-white rounded-lg shadow-md border overflow-hidden">
        <form action="{{ route('master-pricelist-biaya-storage.store') }}" method="POST" class="p-6 space-y-4">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <select name="size_kontainer" id="size_kontainer" required class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm">
                        ...
                        <option value="45" {{ old('size_kontainer') == '45' ? 'selected' : '' }}>45'</option>
                    </select>
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="free_time" id="free_time" value="{{ old('free_time', 0) }}" required
                           class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm">
                </div>
            ...
            <div class="pt-4 flex justify-end space-x-3">
                <button type="reset" class="px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50">
                    Reset
                </button>
