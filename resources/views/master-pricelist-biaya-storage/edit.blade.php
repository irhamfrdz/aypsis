        ...
        <form action="{{ route('master-pricelist-biaya-storage.update', $pricelist->id) }}" method="POST" class="p-6 space-y-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="number" name="tarif_massa_1" id="tarif_massa_1" value="{{ old('tarif_massa_1', $pricelist->tarif_massa_1) }}" required
                           class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm">
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="tarif_massa_2" id="tarif_massa_2" value="{{ old('tarif_massa_2', $pricelist->tarif_massa_2) }}"
                           class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm">
                </div>
