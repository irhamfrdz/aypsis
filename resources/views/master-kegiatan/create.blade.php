...
@section('content')
<h2 class="text-2xl font-bold mb-4 text-gray-800">Formulir Kegiatan Baru</h2>
        ...
        <fieldset class="mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="nama_kegiatan" id="nama_kegiatan" value="{{ old('nama_kegiatan') }}" class="{{ $inputClasses }}" required maxlength="255">
                    @error('nama_kegiatan')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
