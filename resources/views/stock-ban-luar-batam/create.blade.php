...
@section('title', 'Tambah Stock Ban Luar Batam')
@section('page_title', 'Tambah Stock Ban Luar Batam')
...
<div class="container mx-auto px-4 py-6">
    <div class="max-w-3xl mx-auto">
        <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
            <h1 class="text-2xl font-bold text-gray-800 mb-6">Tambah Stock Ban Luar Batam</h1>
            
            <form action="{{ route('stock-ban-luar-batam.store') }}" method="POST">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="nomor_faktur" value="{{ old('nomor_faktur') }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('nomor_faktur') border-red-500 @enderror" placeholder="Optional">
                        @error('nomor_faktur')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                            ...
                            <button type="button" id="merk-select-button" class="custom-select-button">
                                <span id="merk-selected-text">
                                    @if(old('merk_id'))
                                        ...
                                        {{ $selectedMerk ? $selectedMerk->nama : '-- Pilih Merk --' }}
                                    @else
                                        -- Pilih Merk --
                                    @endif
                                </span>
