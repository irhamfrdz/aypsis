        ...
        <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
            ...
            <form action="{{ route('stock-ban-luar-batam.update', $stockBan->id) }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <!-- Tanggal Digunakan -->
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Tanggal Digunakan</label>
                        <input type="date" name="tanggal_digunakan" value="{{ old('tanggal_digunakan', $stockBan->tanggal_digunakan ? $stockBan->tanggal_digunakan->format('Y-m-d') : '') }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('tanggal_digunakan') border-red-500 @enderror">
