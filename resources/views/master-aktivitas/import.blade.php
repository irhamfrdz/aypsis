...
@section('title', 'Import Aktivitas CSV')
@section('page_title', 'Import Aktivitas CSV')
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                <div class="mb-4 sm:mb-0">
                    <h1 class="text-3xl font-bold text-gray-900">Import Master Aktivitas CSV</h1>
                    <p class="mt-1 text-sm text-gray-600">Upload file CSV untuk import data master aktivitas secara massal</p>
                </div>
                <div class="flex flex-col sm:flex-row gap-3">
                    <a href="{{ route('master-aktivitas.download-template') }}" class="inline-flex items-center justify-center px-4 py-2 bg-green-600 text-white text-sm font-medium rounded-lg hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-colors duration-200 shadow-sm">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                        </svg>
                        Download Template
                    </a>
                    <a href="{{ route('master-aktivitas.index') }}" class="inline-flex items-center justify-center px-4 py-2 bg-gray-500 text-white text-sm font-medium rounded-lg hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 transition-colors duration-200 shadow-sm">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
            ...
            <div class="space-y-3 text-sm text-gray-600">
                ...
                <p><strong>3. Field Wajib:</strong> Nama aktivitas wajib diisi. Kode akan auto-generate dengan format AKT00001 jika kosong.</p>
                <p><strong>4. Status Default:</strong> Jika kolom status kosong, akan otomatis diset ke 'active'.</p>
                <p><strong>5. Auto-Generate Kode:</strong> Kosongkan kolom kode untuk auto-generate format AKT00001, AKT00002, dst.</p>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
            ...
            <form action="{{ route('master-aktivitas.import') }}" method="POST" enctype="multipart/form-data" id="importForm">
                @csrf
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div class="bg-gray-100 rounded-lg p-4 font-mono text-sm overflow-x-auto">
                <div class="text-gray-700">
                    kode;nama_aktivitas;catatan;status<br>
                    AKT001;Pemuatan Kontainer;Aktivitas pemuatan kontainer ke kapal;active<br>
                    ;Pembongkaran Kontainer;Aktivitas pembongkaran kontainer dari kapal;active<br>
                    ;Stuffing Barang;;
                </div>
            </div>
            ...
            <div class="mt-4 space-y-2 text-sm text-gray-600">
                ...
                <ul class="list-disc list-inside space-y-1 ml-4">
                    <li><strong>kode:</strong> Opsional, akan auto-generate dengan format AKT00001 jika kosong</li>
                    <li><strong>nama_aktivitas:</strong> Wajib diisi</li>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const dropArea = fileInput.parentElement.querySelector('label');
