...
<div class="container mx-auto px-4 py-4">
    <div class="max-w-2xl mx-auto bg-white rounded-lg shadow-sm border border-gray-200">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 p-4 border-b border-gray-200">
            <div>
                <h1 class="text-xl font-semibold text-gray-900">Tambah Aktivitas</h1>
                <p class="text-xs text-gray-600 mt-1">Tambahkan data aktivitas baru</p>
            </div>
        ...
        <!-- Form -->
        <form action="{{ route('master-aktivitas.store') }}" method="POST" class="p-4">
            @csrf
