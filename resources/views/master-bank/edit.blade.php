        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-600">Edit data bank dalam sistem</p>
                </div>
            ...
            <form action="{{ route('master-bank-update', $bank->id) }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <textarea name="keterangan"
                              ...
                              placeholder="Masukkan keterangan atau catatan tambahan tentang bank">{{ old('keterangan', $bank->keterangan) }}</textarea>
                    @error('keterangan')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
