...
@section('title', 'Detail Pembayaran Pranota Rit')
@section('page_title', 'Detail Pembayaran Pranota Rit')
...
<div class="max-w-4xl mx-auto">
    <div class="bg-white shadow-xl rounded-lg overflow-hidden border border-gray-200">
        ...
        <div class="bg-gray-50 px-6 py-4 flex justify-between border-t border-gray-200">
            <a href="{{ route('pembayaran-pranota-rit.index') }}" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-100">
            ...
            <div class="space-x-2">
                ...
                <form action="{{ route('pembayaran-pranota-rit.destroy', $item->id) }}" method="POST" class="inline-block" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data pembayaran ini? Status pranota akan kembali menjadi approved.')">
                    @csrf
                    @method('DELETE')
