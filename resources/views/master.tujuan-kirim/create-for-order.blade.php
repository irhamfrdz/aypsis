        ...
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-2xl font-bold text-gray-900">Tambah Tujuan Kirim Baru</h1>
                        <p class="mt-1 text-sm text-gray-600">Masukkan informasi tujuan kirim yang akan ditambahkan</p>
                    </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                <form action="{{ route('order.tujuan-kirim.store') }}" method="POST" class="space-y-6" id="tujuanKirimForm">
                    @csrf
                    ...
                    <div>
                        ...
                        <input type="text" name="nama_tujuan" id="nama_tujuan" value="{{ old('nama_tujuan', $searchValue ?? '') }}" required
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500 @error('nama_tujuan') border-red-500 @enderror"
                               placeholder="Masukkan nama tujuan kirim">
                        @error('nama_tujuan')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function generateKode() {
                ...
                .catch(() => {
                    ...
                    const code = 'TK' + year + month + day + time.substr(0, 1);
