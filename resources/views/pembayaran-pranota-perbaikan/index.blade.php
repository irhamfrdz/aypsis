...
@section('title', 'Pembayaran Pranota Perbaikan')
    ...
    <div class="bg-white rounded-lg shadow">
        ...
        <div class="px-6 py-4 border-b border-gray-200">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                <h1 class="text-2xl font-bold text-gray-900">Pembayaran Pranota Perbaikan</h1>
                <div class="mt-4 sm:mt-0 flex space-x-3">
                    <a href="{{ route('pembayaran-pranota-perbaikan.create') }}"
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900">
                                    {{ $pembayaran->tanggal_kas ? \Carbon\Carbon::parse($pembayaran->tanggal_kas)->format('d/m/Y') : '-' }}
                                </div>
                            </td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                                    ...
                                    @endif">
                                    {{ $pembayaran->jenis_transaksi ? ucfirst($pembayaran->jenis_transaksi) : '-' }}
                                </span>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm font-medium text-gray-900">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                                    @if($pembayaran->status === 'completed') bg-green-100 text-green-800
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <a href="{{ route('pembayaran-pranota-perbaikan.show', $pembayaran->id) }}"
                    ...
                    @empty
                        <tr>
                            <td colspan="7" class="px-6 py-4 text-center text-gray-500">
                                Tidak ada data pembayaran pranota perbaikan.
                            </td>
                        </tr>
                    @endforelse
                </tbody>
