...
@section('title', 'Edit Tipe Barang')
@section('page_title', 'Edit Tipe Barang')
    ...
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900">Edit Tipe Barang</h1>
                    <p class="mt-1 text-sm text-gray-600">Perbarui informasi tipe barang</p>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <form action="{{ route('master.tipe-barang.update', $tipeBarang->id) }}" method="POST" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div>
                    ...
                    <input type="text" name="kode" id="kode" value="{{ old('kode', $tipeBarang->kode) }}"
                ...
                <div>
                    ...
                    <input type="text" name="nama" id="nama" value="{{ old('nama', $tipeBarang->nama) }}" required
                ...
                <div>
                    ...
                    <textarea name="keterangan" id="keterangan" rows="4"
                              ...
                              placeholder="Masukkan keterangan (opsional)">{{ old('keterangan', $tipeBarang->keterangan) }}</textarea>
                    @error('keterangan')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
