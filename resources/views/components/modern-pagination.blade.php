        ...
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-2">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center gap-2">
                ...
                <div class="flex items-center space-x-2">
                    ...
                    <select id="perPageSelect" 
                        ...
                        <option value="10000" {{ request('per_page', 15) == 10000 ? 'selected' : '' }}>Semua</option>
                    </select>
                </div>
            ...
            <div class="flex flex-col sm:flex-row items-center gap-2">
                ...
                <div class="flex items-center bg-white rounded-lg border border-gray-200 shadow-sm overflow-hidden">
                    <form id="pageJumpForm" method="GET" action="{{ $routeName ? route($routeName, request()->route() ? request()->route()->parameters() : []) : url()->current() }}" class="flex items-center">
