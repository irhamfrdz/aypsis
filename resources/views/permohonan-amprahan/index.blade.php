...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="flex justify-between items-center mb-6">
        <div>
            ...
            <p class="text-gray-600 mt-1">Daftar permintaan amprahan dari ABK</p>
        </div>
    </div>

    <!-- Filter Section -->
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5 mb-6">
        <form action="{{ route('permohonan-amprahan.index') }}" method="GET" class="flex flex-col md:flex-row gap-4 items-end">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse($permohonans as $index => $item)
                        <tr class="hover:bg-gray-50 transition-colors duration-150">
                            ...
                            <td class="px-6 py-4">
                                <div class="text-sm font-bold text-gray-900">{{ $item->kapal->nama ?? '-' }}</div>
                        ...
                        <tr>
                            <td colspan="6" class="px-6 py-10 text-center text-gray-500">
                                <div class="flex flex-col items-center">
                                    ...
                                    <p class="text-sm mt-1">Gunakan filter di atas untuk mencari berdasarkan kapal atau voyage.</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
