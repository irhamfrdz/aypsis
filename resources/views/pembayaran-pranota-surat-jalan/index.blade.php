...
<div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="bg-white rounded-lg shadow">
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200 resizable-table" id="pembayaranPranotaSuratJalanTable">
...
$(document).ready(function() {
    initResizableTable('pembayaranPranotaSuratJalanTable');
});
</script>
@endpush