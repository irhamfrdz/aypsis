...
@section('title', 'Report Surat Jalan - Pilih Periode')
@section('page_title', 'Report Surat Jalan - Pilih Periode')
    ...
    <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
        <div class="flex items-center justify-between">
            <div class="flex items-center">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-gray-800">Report Surat Jalan</h1>
                    <p class="text-gray-600">Laporan surat jalan berdasarkan periode input</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-sm p-8">
        <div class="max-w-2xl mx-auto">
            <div class="text-center mb-8">
                ...
                <p class="text-gray-600">Silakan pilih rentang tanggal untuk menampilkan laporan surat jalan.</p>
            </div>

            <form method="GET" action="{{ route('report.surat_jalan.view') }}" class="space-y-6">
