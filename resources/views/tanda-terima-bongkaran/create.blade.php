...
@section('title', 'Tambah Tanda Terima Bongkaran')
...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 mb-6">
            <div class="px-6 py-4 border-b border-gray-200">
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-2xl font-bold text-gray-900">Tambah Tanda Terima Bongkaran</h1>
                        <p class="text-gray-600 mt-1">Buat tanda terima untuk surat jalan bongkaran</p>
                    </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <form action="{{ route('tanda-terima-bongkaran.store') }}" method="POST">
                @csrf
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="date" 
                                       ...
                                       value="{{ old('tanggal_tanda_terima', date('Y-m-d')) }}"
                            ...
                            <div class="md:col-span-2">
                                ...
                                <select name="surat_jalan_bongkaran_id" 
                                    ...
                                    @foreach($suratJalanBongkarans ?? [] as $sj)
                                        <option value="{{ $sj->id }}" {{ old('surat_jalan_bongkaran_id') == $sj->id ? 'selected' : '' }}>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <select name="kegiatan" 
                                    ...
                                    <option value="Stripping" {{ old('kegiatan') == 'Stripping' ? 'selected' : '' }}>Stripping</option>
                                </select>
                                @error('kegiatan')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
...
@push('scripts')
<script>
    // Auto-fill nomor tanda terima
    document.addEventListener('DOMContentLoaded', function() {
        const nomorTTInput = document.getElementById('nomor_tanda_terima');
        if (nomorTTInput && !nomorTTInput.value) {
