...
<div class="container mx-auto px-4 py-4 pb-20">
    ...
    <div class="flex items-center justify-between mb-4">
        <div>
            <h1 class="text-xl font-bold text-gray-800">Prospek Batam</h1>
            <p class="text-xs text-gray-600">Mobile View</p>
        </div>
        {{-- Add button if needed, but Prospek is usually from Scan SJ --}}
    </div>
        ...
        <form method="GET" action="{{ route('prospek-batam.index') }}">
            ...
            <div class="flex gap-2 mb-2">
                <input type="text" 
                       ...
                       class="flex-1 px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-teal-500 shadow-sm">
                ...
                <button type="submit" class="px-3 py-2 bg-teal-600 text-white rounded-lg hover:bg-teal-700 shadow-sm">
            ...
            <div x-show="showFilters" 
                ...
                <div class="flex justify-end pt-2">
                    <a href="{{ route('prospek-batam.index') }}" class="text-xs text-gray-500 hover:text-gray-700 underline">Reset Filter</a>
                </div>
            </div>
        </form>
    </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden relative">
                ...
                <div class="p-4 pl-5">
                    ...
                    <div class="flex items-center justify-between pt-2 border-t border-gray-100">
                        <a href="{{ route('prospek-batam.show', $prospek->id) }}" class="text-gray-500 text-sm flex items-center gap-1 hover:text-teal-600">
                        ...
                        <div class="flex gap-3">
                            ...
                            @can('prospek-batam-edit')
                                <a href="{{ route('prospek-batam.edit', $prospek->id) }}" class="text-yellow-600 p-2 bg-yellow-50 rounded-full hover:bg-yellow-100">
...
function updateStatusMobile(id, status) {
    ...
    fetch(`/prospek-batam/${id}/update-status`, {
        method: 'PATCH',
        headers: {
