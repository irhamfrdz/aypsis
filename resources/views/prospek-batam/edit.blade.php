...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
        <div class="flex items-center justify-between">
            <div class="flex items-center">
                <i class="fas fa-edit mr-3 text-teal-600 text-2xl"></i>
                <div>
                    <h1 class="text-2xl font-bold text-gray-800">Edit Prospek Batam</h1>
                    <p class="text-gray-600">Ubah data prospek pengiriman kontainer wilayah Batam</p>
                </div>
            </div>
            <a href="{{ route('prospek-batam.index') }}" class="bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded-md transition duration-200 flex items-center">
    ...
    {{-- Form --}}
    <form action="{{ route('prospek-batam.update', $prospek->id) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
                    ...
                    <div class="border-b border-gray-200 pb-4">
                        ...
                        <div class="grid grid-cols-1 gap-4">
                            <div>
                                ...
                                <input type="date" name="tanggal" value="{{ old('tanggal', $prospek->tanggal ? $prospek->tanggal->format('Y-m-d') : '') }}" 
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-teal-500 focus:ring-teal-500">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700">Status</label>
                                <select name="status" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-teal-500 focus:ring-teal-500">
                    ...
                    <div class="border-b border-gray-200 pb-4">
                        ...
                        <div class="grid grid-cols-1 gap-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="penerima" value="{{ old('penerima', $prospek->penerima) }}" 
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-teal-500 focus:ring-teal-500">
                            </div>
                            <div>
                    ...
                    <div class="border-b border-gray-200 pb-4">
                        ...
                        <div class="grid grid-cols-1 gap-4">
                            <div>
                                ...
                                <select name="kapal_id" id="kapal_id" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-teal-500 focus:ring-teal-500">
                            ...
                            <div>
                                ...
                                <input type="date" name="tanggal_muat" value="{{ old('tanggal_muat', $prospek->tanggal_muat ? $prospek->tanggal_muat->format('Y-m-d') : '') }}" 
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-teal-500 focus:ring-teal-500">
                            </div>
                        </div>
                    </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="border-b border-gray-200 pb-4">
                        ...
                        <div class="grid grid-cols-1 gap-4">
                            ...
                            <div>
                                ...
                                <input type="number" step="0.001" name="total_ton" value="{{ old('total_ton', $prospek->total_ton) }}" 
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-teal-500 focus:ring-teal-500">
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input type="number" step="0.001" name="total_volume" value="{{ old('total_volume', $prospek->total_volume) }}" 
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-teal-500 focus:ring-teal-500">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="border-b border-gray-200 pb-4">
                        ...
                        <div class="grid grid-cols-1 gap-4">
                            ...
                            @if($prospek->surat_jalan_batam_id)
                            <div>
                                <label class="block text-sm font-medium text-gray-500">Link Surat Jalan Batam</label>
                                <a href="{{ route('surat-jalan-batam.show', $prospek->surat_jalan_batam_id) }}" 
                                   class="mt-1 inline-flex items-center text-sm text-teal-600 hover:text-teal-800">
                                    <i class="fas fa-external-link-alt mr-2"></i>
                                    Lihat Surat Jalan Batam
                                </a>
                            </div>
                            @endif
                            @if($prospek->tanda_terima_batam_id)
                            <div>
                                <label class="block text-sm font-medium text-gray-500">Link Tanda Terima Batam</label>
                                <a href="{{ route('tanda-terima-batam.show', $prospek->tanda_terima_batam_id) }}" 
                                   class="mt-1 inline-flex items-center text-sm text-teal-600 hover:text-teal-800">
                                    <i class="fas fa-external-link-alt mr-2"></i>
                                    Lihat Tanda Terima Batam
                                </a>
                            </div>
                            @endif
                        </div>
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <textarea name="keterangan" rows="4" 
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-teal-500 focus:ring-teal-500">{{ old('keterangan', $prospek->keterangan) }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-8 flex items-center justify-end space-x-4 border-t border-gray-200 pt-6">
                <a href="{{ route('prospek-batam.index') }}" 
                   class="bg-gray-500 hover:bg-gray-600 text-white px-6 py-2 rounded-md transition duration-200">
                    Batal
                </a>
                <button type="submit" 
                        class="bg-teal-600 hover:bg-teal-700 text-white px-6 py-2 rounded-md transition duration-200 flex items-center">
