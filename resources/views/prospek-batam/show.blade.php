    ...
    <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
        <div class="flex items-center justify-between">
            <div class="flex items-center">
                <i class="fas fa-eye mr-3 text-teal-600 text-2xl"></i>
                <div>
                    <h1 class="text-2xl font-bold text-gray-800">Detail Prospek Batam</h1>
                    <p class="text-gray-600">Informasi detail data prospek pengiriman kontainer wilayah Batam</p>
                </div>
            </div>
            ...
            <div class="space-y-6">
                <div class="border-b border-gray-200 pb-4">
                    ...
                    <div class="grid grid-cols-1 gap-4">
                        <div>
                            <label class="block text-sm font-medium text-gray-500">ID Prospek Batam</label>
                ...
                <div class="border-b border-gray-200 pb-4">
                    ...
                    <div class="grid grid-cols-1 gap-4">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-500">Penerima</label>
                            <p class="mt-1 text-sm text-gray-900">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="bg-blue-50 rounded-lg p-4">
                    ...
                    <div class="text-sm text-blue-700">
                        <p><strong>Oleh:</strong> {{ $prospek->creator->name ?? 'System' }}</p>
                ...
                <div class="bg-green-50 rounded-lg p-4">
                    ...
                    <div class="text-sm text-green-700">
                        <p><strong>Oleh:</strong> {{ $prospek->updater->name ?? 'System' }}</p>
        ...
        <div class="mt-8 flex justify-center">
            <a href="{{ route('prospek-batam.index') }}"
               class="bg-gray-500 hover:bg-gray-600 text-white px-6 py-3 rounded-md transition duration-200 flex items-center">
                <i class="fas fa-arrow-left mr-2"></i>
                Kembali ke Daftar Prospek Batam
            </a>
        </div>
    </div>
</div>
