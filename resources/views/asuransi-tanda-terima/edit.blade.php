            ...
            <form action="{{ route('asuransi-tanda-terima.update', $asuransiTandaTerima->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="nomor_polis" name="nomor_polis" value="{{ old('nomor_polis', $asuransiTandaTerima->nomor_polis) }}" 
                    ...
                    @php
                        ...
                        if ($currentRate <= 0 && $asuransiTandaTerima->nilai_barang > 0) {
                            $currentRate = ($asuransiTandaTerima->premi / $asuransiTandaTerima->nilai_barang * 100);
                        }
                        if ($currentRate <= 0) {
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" id="nilai_barang" name="nilai_barang" value="{{ old('nilai_barang', $asuransiTandaTerima->nilai_barang) }}" required
