...
@section('title', 'Tambah Pricelist Rit')
@section('page_title', 'Tambah Pricelist Rit')

@section('content')
<div class="bg-white p-6 rounded-lg shadow-md">
    <div class="flex justify-between items-center mb-6">
        <h2 class="text-2xl font-bold text-gray-800">Tambah Pricelist Rit</h2>
    ...
    <form action="{{ route('master.pricelist-rit.store') }}" method="POST" class="space-y-6">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <select id="tujuan" name="tujuan"
                    ...
                    <option value="Supir" {{ old('tujuan') == 'Supir' ? 'selected' : '' }}>Supir</option>
                    <option value="Kenek" {{ old('tujuan') == 'Kenek' ? 'selected' : '' }}>Kenek</option>
                </select>
                @error('tujuan')
