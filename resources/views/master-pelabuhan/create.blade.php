...
@section('page_title', 'Tambah Pelabuhan')
...
<div class="container mx-auto px-4 py-4">
    <div class="max-w-2xl mx-auto bg-white rounded-lg shadow-sm border border-gray-200">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 p-4 border-b border-gray-200">
            <div>
                <h1 class="text-xl font-semibold text-gray-900">Tambah Pelabuhan</h1>
                <p class="text-xs text-gray-600 mt-1">Isi form di bawah untuk menambah data pelabuhan</p>
            </div>
            <div>
        ...
        <div class="p-4">
            ...
            <form action="{{ route('master-pelabuhan.store') }}" method="POST" class="space-y-6">
                @csrf
                ...
                <div>
                    ...
                    <input type="text" name="nama_pelabuhan" id="nama_pelabuhan" value="{{ old('nama_pelabuhan') }}" required
                ...
                <div>
                    ...
                    <textarea name="keterangan" id="keterangan" rows="4"
                              ...
                              placeholder="Keterangan tambahan tentang pelabuhan (opsional)">{{ old('keterangan') }}</textarea>
                </div>
