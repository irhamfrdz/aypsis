    ...
    <div class="max-w-6xl mx-auto">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 mb-6">
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 p-6">
                ...
                <div class="flex gap-3">
                    <a href="{{ route('tanda-terima-tanpa-surat-jalan-batam.index') }}"
                    ...
                    @can('tanda-terima-tanpa-surat-jalan-batam-update')
                        <a href="{{ route('tanda-terima-tanpa-surat-jalan-batam.edit', $tandaTerimaTanpaSuratJalan) }}"
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                                    ...
                                    <div class="rounded-md overflow-hidden bg-gray-50 border border-gray-100 group">
                                        ...
                                        <div class="p-2 flex items-center justify-between">
                                            ...
                                            <div class="flex gap-2 items-center">
                                                <a href="{{ route('tanda-terima-tanpa-surat-jalan-batam.download-image', [$tandaTerimaTanpaSuratJalan, $index]) }}" class="inline-flex items-center px-2 py-1 text-xs bg-white border rounded text-gray-700 hover:bg-gray-50">
                ...
                @php
                    $dokumenTambahanData = [
                        'PPBJ' => $tandaTerimaTanpaSuratJalan->dokumen_ppbj ?? null,
                        'Packing List' => $tandaTerimaTanpaSuratJalan->dokumen_packing_list ?? null,
                        'Invoice' => $tandaTerimaTanpaSuratJalan->dokumen_invoice ?? null,
                        'Faktur Pajak' => $tandaTerimaTanpaSuratJalan->dokumen_faktur_pajak ?? null,
                    ];
                @endphp
                ...
                @foreach($dokumenTambahanData as $judul => $dokumen)
                    ...
                    <div class="bg-white rounded-lg shadow-sm border border-gray-200 mt-6">
                        <div class="border-b border-gray-200 p-4">
                            <h2 class="text-lg font-semibold text-gray-800">Dokumen {{ $judul }}</h2>
                        </div>
                        <div class="p-6">
                            <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div class="border-t border-gray-200 pt-4 space-y-3">
                            ...
                            @can('tanda-terima-tanpa-surat-jalan-batam-delete')
                                <form action="{{ route('tanda-terima-tanpa-surat-jalan-batam.destroy', $tandaTerimaTanpaSuratJalan) }}" 
                                      method="POST"
