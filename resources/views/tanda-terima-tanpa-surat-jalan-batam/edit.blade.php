    ...
    <div class="max-w-4xl mx-auto bg-white rounded-lg shadow-sm border border-gray-200">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 p-4 border-b border-gray-200">
            ...
            <div class="flex gap-2">
                <a href="{{ route('tanda-terima-tanpa-surat-jalan-batam.show', $tandaTerimaTanpaSuratJalan) }}"
        ...
        <div class="p-4">
            ...
            <form action="{{ route('tanda-terima-tanpa-surat-jalan-batam.update', $tandaTerimaTanpaSuratJalan) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                @csrf
                @method('PUT')
...
<script>
    ...
    window.addEventListener('message', function(event) {
        ...
        if (event.data.type === 'penerimaAdded' || lastPopupOpened === 'penerima' || lastPopupOpened === 'pengirim') {
            ...
            const selectId = isPenerima ? '.select2-penerima' : '.select2-pengirim';
            const otherSelectId = isPenerima ? '.select2-pengirim' : '.select2-penerima';
