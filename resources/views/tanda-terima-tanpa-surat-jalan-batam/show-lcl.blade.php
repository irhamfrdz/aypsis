        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 mb-6">
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 p-6">
                ...
                <div class="flex gap-3">
                    <a href="{{ route('tanda-terima-tanpa-surat-jalan-batam.index', ['tipe' => 'lcl']) }}"
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                    ...
                    <div class="p-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            @endif
                            <div>
                                <label class="block text-sm font-medium text-gray-500 mb-2">Total Kuantitas</label>
                                <p class="text-base font-semibold text-gray-900">{{ $tandaTerima->total_koli }} Item</p>
                            </div>
                            <div>
