        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div class="bg-white rounded-xl shadow-lg border border-gray-200 hover:shadow-xl transition-all duration-300 hover:scale-105 h-full">
                <div class="flex flex-col h-full p-6 text-center">
                    ...
                    <a href="{{ route('tanda-terima-tanpa-surat-jalan-batam.create', ['tipe' => 'fcl']) }}"
            ...
            <div class="bg-white rounded-xl shadow-lg border border-gray-200 hover:shadow-xl transition-all duration-300 hover:scale-105 h-full">
                <div class="flex flex-col h-full p-6 text-center">
                    ...
                    <a href="{{ route('tanda-terima-tanpa-surat-jalan-batam.create-lcl') }}"
            ...
            <div class="bg-white rounded-xl shadow-lg border border-gray-200 hover:shadow-xl transition-all duration-300 hover:scale-105 h-full">
                <div class="flex flex-col h-full p-6 text-center">
                    ...
                    <a href="{{ route('tanda-terima-tanpa-surat-jalan-batam.create', ['tipe' => 'cargo']) }}"
