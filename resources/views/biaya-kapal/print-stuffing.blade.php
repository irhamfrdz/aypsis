...
<head>
    ...
    <title>Biaya Stuffing - {{ $biayaKapal->nomor_invoice }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="container">
        <!-- Header -->
        <div class="header">
            <h1>PERMOHONAN BIAYA STUFFING</h1>
        </div>
        ...
        <div class="document-info">
            ...
            <div>
                <div class="info-row">
                    ...
                    <span class="value">
                        @php
                            $kapals = $biayaKapal->stuffingDetails->pluck('kapal')->unique()->values();
                        @endphp
        ...
        <table class="detail-table">
            <thead>
                <tr>
                    ...
                    <th style="width: 40%;">Tanda Terima</th>
            ...
            <tbody>
                ...
                @if($biayaKapal->stuffingDetails->count() > 0)
                    @foreach($biayaKapal->stuffingDetails as $index => $detail)
                    <tr>
                        ...
                        <td>
                            @php
                                $tandaTerimas = $detail->getTandaTerimas();
                            @endphp
                            @if($tandaTerimas->count() > 0)
                                @foreach($tandaTerimas as $tt)
                                    <div style="margin-bottom: 2px;">
                                        <span class="tt-chip">{{ $tt->no_surat_jalan }}</span>
                                        @if($tt->no_kontainer)
                                            <span style="color: #666; font-size: 0.85em;">{{ $tt->no_kontainer }}</span>
                                        @endif
                                    </div>
                                @endforeach
                            @else
                ...
                @else
                    <tr>
                        <td colspan="5" class="center">Tidak ada detail stuffing.</td>
                    </tr>
                @endif
            </tbody>
        </table>
