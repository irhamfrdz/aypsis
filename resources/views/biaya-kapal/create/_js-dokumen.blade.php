        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            ...
            <div>
                ...
                <div class="flex gap-2">
                    <select name="dokumen_sections[${sectionIndex}][voyage]" class="dokumen-voyage-select w-full px-3 py-2 border border-gray-300 rounded-lg bg-white focus:ring-2 focus:ring-indigo-500" required disabled>
                        <option value="">-- Pilih Kapal Terlebih Dahulu --</option>
                    </select>
                    <input type="text" name="dokumen_sections[${sectionIndex}][voyage]" class="dokumen-voyage-input w-full px-3 py-2 border border-gray-300 rounded-lg bg-white focus:ring-2 focus:ring-indigo-500 hidden" disabled placeholder="Ketik No. Voyage">
