    ...
    window.addTypeToTantoSection = function(sectionIndex, data = null) {
        ...
        div.innerHTML = `
            ...
            <div class="grid grid-cols-2 lg:grid-cols-7 gap-2 mt-1">
                ...
                <div>
                    <label class="text-xs text-gray-500 block mb-1">Harga Satuan (Rp)</label>
                    <input type="number" name="tanto[${sectionIndex}][custom_prices][]" class="price-input-tanto w-full px-2 py-1 border border-gray-300 rounded text-sm focus:ring-2 focus:ring-blue-500 bg-gray-100" value="${data ? (data.harga || 0) : 0}" placeholder="0" readonly oninput="calculateTantoSectionTotal(${sectionIndex})">
                </div>
                <div>
                    <label class="text-xs text-gray-500 block mb-1">Kuantitas</label>
