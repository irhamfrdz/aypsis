...
<head>
    ...
    <title>Biaya Freight - {{ $biayaKapal->nomor_invoice }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <div class="container">
        ...
        <table class="detail-table">
            ...
            <tbody>
                ...
                @if($biayaKapal->freightDetails && $biayaKapal->freightDetails->count() > 0)
                    @foreach($biayaKapal->freightDetails as $index => $detail)
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="rincian-item">
                                <span>Materai:</span>
                                <span>{{ number_format($detail->biaya_meterai, 0, ',', '.') }}</span>
                            </div>
                            @endif
                            @if($detail->pph > 0)
                            <div class="rincian-item">
                                <span>PPh 2%:</span>
                                <span style="color: #d32f2f;">-{{ number_format($detail->pph, 0, ',', '.') }}</span>
                            </div>
                            @endif
                        </td>
                        <td class="right">
                ...
                @else
                    <tr>
                        <td colspan="5" class="center">Tidak ada detail Freight.</td>
                    </tr>
                @endif
            </tbody>
        </table>
