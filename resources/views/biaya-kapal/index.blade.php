                    ...
                    <div class="mt-2">
                        ...
                        <form action="{{ route('biaya-kapal.export-valuasi') }}" method="POST" id="valuasi_form">
                            ...
                            <div class="mb-4 text-left">
                                ...
                                <select name="jenis_biaya" id="valuasi_jenis_biaya_select" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-purple-500 focus:border-purple-500 sm:text-sm">
                                    <option value="">-- Semua Jenis Biaya --</option>
                                    @foreach($klasifikasiBiayas as $kb)
