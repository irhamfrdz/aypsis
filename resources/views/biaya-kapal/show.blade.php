...
<div class="bg-white shadow-md rounded-lg p-6">
    <div class="flex justify-between items-center mb-6">
        ...
        <div class="flex space-x-2">
            ...
            <a href="{{ route('biaya-kapal.print-buruh-batam', $biayaKapal->id) }}" target="_blank" class="inline-flex items-center px-4 py-2 bg-yellow-500 hover:bg-yellow-600 text-white text-sm font-medium rounded-md transition duration-150">
                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-4a2 2 0 00-2-2H9a2 2 0 00-2 2v4a2 2 0 002 2zm8-12V5a2 2 0 00-2-2H9a2 2 0 00-2 2v4h10z"></path>
                </svg>
                Print Buruh Batam
            ...
            <a href="{{ route('biaya-kapal.print-storage', $biayaKapal->id) }}" target="_blank" class="inline-flex items-center px-4 py-2 bg-sky-500 hover:bg-sky-600 text-white text-sm font-medium rounded-md transition duration-150">
                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-4a2 2 0 00-2-2H9a2 2 0 00-2 2v4a2 2 0 002 2zm8-12V5a2 2 0 00-2-2H9a2 2 0 00-2 2v4h10z"></path>
                </svg>
                Print Storage
            ...
            <a href="{{ route('biaya-kapal.print-meratus', $biayaKapal->id) }}" target="_blank" class="inline-flex items-center px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-medium rounded-md transition duration-150">
                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-4a2 2 0 00-2-2H9a2 2 0 00-2 2v4a2 2 0 002 2zm8-12V5a2 2 0 00-2-2H9a2 2 0 00-2 2v4h10z"></path>
                </svg>
                Print Meratus
            ...
            <a href="{{ route('biaya-kapal.print-temas', $biayaKapal->id) }}" target="_blank" class="inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-md transition duration-150">
                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-4a2 2 0 00-2-2H9a2 2 0 00-2 2v4a2 2 0 002 2zm8-12V5a2 2 0 00-2-2H9a2 2 0 00-2 2v4h10z"></path>
                </svg>
                Print Temas
            ...
            <div class="col-span-1 md:col-span-2 mt-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    @foreach($biayaKapal->bukti_array as $index => $file_path)
                        ...
                        @if($isImage)
                            <a href="{{ asset('storage/' . $file_path) }}" target="_blank" class="block relative group overflow-hidden rounded-lg shadow-sm border border-gray-200">
                                <img src="{{ asset('storage/' . $file_path) }}" alt="Bukti {{ $index + 1 }}" class="w-full h-48 object-cover group-hover:scale-105 transition-transform duration-300">
                        ...
                        @elseif($isPdf)
                            <a href="{{ asset('storage/' . $file_path) }}" target="_blank" class="flex flex-col items-center justify-center w-full h-48 bg-red-50 hover:bg-red-100 border border-red-200 rounded-lg shadow-sm transition-colors text-red-600 group">
                                <i class="fas fa-file-pdf text-4xl mb-3 group-hover:scale-110 transition-transform"></i>
                                <span class="text-sm font-semibold">PDF Bukti {{ $index + 1 }}</span>
                            </a>
                        @else
                            <a href="{{ asset('storage/' . $file_path) }}" target="_blank" class="flex flex-col items-center justify-center w-full h-48 bg-blue-50 hover:bg-blue-100 border border-blue-200 rounded-lg shadow-sm transition-colors text-blue-600 group">
                                <i class="fas fa-file-download text-4xl mb-3 group-hover:scale-110 transition-transform"></i>
                                <span class="text-sm font-semibold">Download File {{ $index + 1 }}</span>
                            </a>
                        @endif
                    @endforeach
                </div>
                ...
                <table class="min-w-full divide-y divide-indigo-100">
                    <thead class="bg-indigo-50/50">
                        <tr>
                            ...
                            <th class="px-6 py-4 text-right text-xs font-bold text-indigo-900 uppercase tracking-wider">Total Section</th>
                        </tr>
                    </thead>
        ...
        <div class="space-y-6">
            @foreach($biayaKapal->notaReturDetails as $detail)
                <div class="bg-indigo-50 border-2 border-indigo-200 rounded-lg p-5">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                        <div>
                            <span class="text-xs font-semibold text-indigo-600 uppercase tracking-wider">Nomor Invoice</span>
                            <p class="text-lg font-bold text-gray-900">{{ $detail->no_invoice ?: ($detail->voyage ?: $detail->kapal) }}</p>
                        </div>
                        <div>
                            <span class="text-xs font-semibold text-indigo-600 uppercase tracking-wider">Vendor</span>
