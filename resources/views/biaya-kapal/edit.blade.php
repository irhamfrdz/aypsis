        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="text" 
                       ...
                       id="nomor_referensi" 
                       value="{{ old('nomor_referensi', $biayaKapal->nomor_referensi) }}"
                       class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('nomor_referensi') border-red-500 @enderror"
            ...
            <div>
                ...
                <input type="text" 
                       ...
                       class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('nama_vendor') border-red-500 @enderror">
                @error('nama_vendor')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div>
                ...
                <input type="text" 
                       ...
                       class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('nomor_rekening') border-red-500 @enderror">
