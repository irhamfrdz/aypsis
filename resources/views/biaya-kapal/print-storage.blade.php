...
<head>
    ...
    <title>Biaya Storage - {{ $biayaKapal->nomor_invoice }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <div class="container">
        ...
        <table class="detail-table">
            ...
            <tbody>
                ...
                @if($biayaKapal->storageDetails && $biayaKapal->storageDetails->count() > 0)
                    @foreach($biayaKapal->storageDetails as $index => $detail)
                    <tr>
                        ...
                        <td>
                            ...
                            @if($detail->lokasi)
                            <br><span style="color: #555; font-size: 0.9em;">Lokasi: {{ $detail->lokasi }}</span>
                            @endif
                        </td>
                        <td>
