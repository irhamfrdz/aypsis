        ...
        div.innerHTML = `
            ...
            <div class="grid grid-cols-2 lg:grid-cols-6 gap-2 mt-1">
                ...
                <div>
                    ...
                    <input type="number" name="temas[${sectionIndex}][custom_prices][]" class="price-input-temas w-full px-2 py-1 border border-gray-300 rounded text-sm focus:ring-2 focus:ring-blue-500 ${isManual ? 'bg-white' : 'bg-gray-100'}" value="${data ? (data.harga || 0) : 0}" placeholder="0" ${isManual ? '' : 'readonly'} oninput="calculateTemasSectionTotal(${sectionIndex})">
                </div>
                <div>
