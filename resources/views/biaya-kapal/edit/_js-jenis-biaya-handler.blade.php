    ...
    jenisBiayaSelect.addEventListener('change', function() {
        ...
        if (storageWrapper) {
            storageWrapper.classList.add('hidden');
        ...
        // Show Temas wrapper if "Temas" is selected
        else if (selectedText.toLowerCase().includes('temas')) {
            if (temasWrapper) temasWrapper.classList.remove('hidden');
            if (temasSectionsContainer && temasSectionsContainer.children.length === 0) {
        ...
        // Show Tanto wrapper if "Tanto" is selected
        else if (selectedText.toLowerCase().includes('tanto')) {
            if (tantoWrapper) tantoWrapper.classList.remove('hidden');
            if (tantoSectionsContainer && tantoSectionsContainer.children.length === 0) {
            ...
            if (document.getElementById('umum_wrapper')) {
                ...
                if (typeof initializeUmumSections === 'function' && document.getElementById('umum_sections_container').children.length === 0) {
            ...
            // Show Biaya Perlengkapan multi-section
            if (typeof perlengkapanWrapper !== 'undefined' && perlengkapanWrapper) {
                perlengkapanWrapper.classList.remove('hidden');
                if (typeof initializePerlengkapanSections === 'function' && perlengkapanSectionsContainer.children.length === 0) {
            ...
            // Hide Perlengkapan wrapper for other types
            if (typeof perlengkapanWrapper !== 'undefined' && perlengkapanWrapper) {
                perlengkapanWrapper.classList.add('hidden');
                if (typeof clearAllPerlengkapanSections === 'function') clearAllPerlengkapanSections();
            }
