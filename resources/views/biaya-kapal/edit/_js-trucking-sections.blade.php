        ...
        section.innerHTML = `
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4 border-t pt-4 mt-2">
                <div>
                    ...
                    <div class="relative"><span class="absolute left-3 top-2.5 text-gray-400">Rp</span>
                        <input type="text" name="trucking_sections[${sectionIndex}][total_biaya_20ft]" class="trucking-total-20ft-input w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg bg-gray-50 focus:ring-0" value="0" readonly>
                    </div>
                ...
                <div>
                    ...
                    <div class="relative"><span class="absolute left-3 top-2.5 text-gray-400">Rp</span>
                        <input type="text" name="trucking_sections[${sectionIndex}][total_biaya_40ft]" class="trucking-total-40ft-input w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg bg-gray-50 focus:ring-0" value="0" readonly>
                    </div>
                ...
                <div>
                    ...
                    <div class="relative"><span class="absolute left-3 top-2.5 text-gray-400">Rp</span>
                        <input type="text" name="trucking_sections[${sectionIndex}][adjustment]" class="trucking-adjustment-input w-full pl-10 pr-3 py-2 border border-yellow-300 rounded-lg bg-yellow-50 focus:ring-2 focus:ring-yellow-500" value="0" placeholder="0">
                    </div>
                </div>
                <div class="md:col-span-2">
                    <label class="block text-sm font-medium text-gray-700 mb-1">Keterangan Adjustment</label>
                    <input type="text" name="trucking_sections[${sectionIndex}][notes_adjustment]" class="trucking-notes-adjustment-input w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500" placeholder="Keterangan adjustment">
                </div>
                <div>
