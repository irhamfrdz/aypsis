...
<head>
    ...
    <title>Biaya THC - {{ $biayaKapal->nomor_invoice }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        <table class="detail-table">
            <thead>
                <tr>
                    ...
                    <th style="width: 25%;">Daftar Kontainer</th>
            ...
            <tbody>
                ...
                @if($biayaKapal->thcDetails && $biayaKapal->thcDetails->count() > 0)
                    @foreach($biayaKapal->thcDetails as $index => $detail)
                    <tr>
                        ...
                        <td>
                            <div class="rincian-item">
                                <span>Subtotal THC:</span>
                                <span>{{ number_format($detail->subtotal, 0, ',', '.') }}</span>
                            </div>
                            @if($detail->biaya_dokumen_muat > 0)
                            <div class="rincian-item">
                                <span>Dok. Muat:</span>
                                <span>{{ number_format($detail->biaya_dokumen_muat, 0, ',', '.') }}</span>
                            </div>
                            @endif
                            @if($detail->biaya_dokumen_bongkar > 0)
                            <div class="rincian-item">
                                <span>Dok. Bongkar:</span>
                                <span>{{ number_format($detail->biaya_dokumen_bongkar, 0, ',', '.') }}</span>
                            </div>
                            @endif
                ...
                @else
                    <tr>
                        <td colspan="5" class="center">Tidak ada detail THC.</td>
                    </tr>
                @endif
            </tbody>
        </table>
