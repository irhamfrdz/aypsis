            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div id="labuh_tambat_wrapper" class="md:col-span-2 hidden">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <button type="button" id="add_labuh_tambat_section_btn" class="px-4 py-2 bg-slate-600 hover:bg-slate-700 text-white text-sm rounded-lg transition flex items-center gap-2">
                            <i class="fas fa-plus"></i>
                            <span>Tambah Kapal</span>
                        </button>
                    </div>
...
<script>
    ...
    function initializeLabuhTambatSections() {
    ...
    function clearAllLabuhTambatSections() {
        if (labuhTambatSectionsContainer) labuhTambatSectionsContainer.innerHTML = '';
        labuhTambatSectionCounter = 0;
        if (nominalInput) nominalInput.value = '';
    }
    
    addLabuhTambatSectionBtn.addEventListener('click', function() {
        addLabuhTambatSection();
    });
    ...
    function addLabuhTambatSection() {
        ...
        section.innerHTML = `
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">No. Referensi</label>
                    <input type="text" name="labuh_tambat[${sectionIndex}][nomor_referensi]" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-slate-500" placeholder="Masukkan No. Referensi">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Tanggal Invoice Vendor</label>
                    <input type="date" name="labuh_tambat[${sectionIndex}][tanggal_invoice_vendor]" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-slate-500">
                </div>
            </div>
        `;
