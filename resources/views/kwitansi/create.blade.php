            ...
            <div class="overflow-x-auto border border-gray-200 rounded-md">
                <table class="min-w-full divide-y divide-gray-200" id="detail-table">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200" id="detail-body">
                        ...
                        <tr class="detail-row">
                            <td class="px-2 py-2">
                                <input type="text" name="details[0][item_kode]" value="{{ $manifest ? $manifest->size_kontainer . $manifest->tipe_kontainer : '' }}" class="w-full bg-gray-100 border-gray-200 focus:bg-white focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-xs py-2 px-3 rounded-lg transition-all shadow-sm shadow-indigo-100/10" placeholder="Kode Item">
                            </td>
                            <td class="px-2 py-2">
                                <input type="text" name="details[0][item_description]" value="{{ $manifest ? 'Tagihan Manifest #' . $manifest->nomor_manifest . ' (' . $manifest->nomor_kontainer . ')' : '' }}" required class="w-full bg-gray-100 border-gray-200 focus:bg-white focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-xs py-2 px-3 rounded-lg transition-all shadow-sm shadow-indigo-100/10" placeholder="Deskripsi Item">
                            </td>
                            <td class="px-2 py-2">
                                <input type="number" name="details[0][qty]" min="0" step="1" value="{{ $manifest ? 1 : 0 }}" class="w-full bg-gray-100 border-gray-200 focus:bg-white focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-xs py-2 px-3 rounded-lg transition-all shadow-sm shadow-indigo-100/10 text-right qty-input">
                            </td>
                            <td class="px-2 py-2">
                            ...
                            <td class="px-2 py-2">
                                <input type="text" name="details[0][no_bl]" value="{{ $manifest ? $manifest->nomor_bl : '' }}" class="w-full bg-gray-100 border-gray-200 focus:bg-white focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-xs py-2 px-3 rounded-lg transition-all shadow-sm shadow-indigo-100/10">
                            </td>
                            <td class="px-2 py-2">
                                <input type="text" name="details[0][no_sj]" value="{{ $manifest ? $manifest->nomor_manifest : '' }}" class="w-full bg-gray-100 border-gray-200 focus:bg-white focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-xs py-2 px-3 rounded-lg transition-all shadow-sm shadow-indigo-100/10">
                            </td>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                    ...
                    <input type="text" name="akun_piutang" class="w-full bg-gray-100 border-gray-200 focus:bg-white focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-sm py-2.5 px-4 rounded-xl transition-all shadow-sm shadow-indigo-100/10">
                </div>
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="w-2/3 flex gap-2">
                            <div class="relative w-1/3">
                                <input type="number" name="discount_persen" id="discount_persen" value="0" min="0" max="100" step="0.01" class="w-full bg-gray-100 border-gray-200 focus:bg-white focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-sm py-2.5 px-4 rounded-xl transition-all shadow-sm shadow-indigo-100/10 text-right pr-6">
                                <span class="absolute right-2 top-2 text-gray-500 text-sm">%</span>
                            </div>
                            <input type="text" name="discount_nominal" id="discount_nominal" value="0" class="w-2/3 bg-gray-100 border-gray-200 focus:bg-white focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-sm py-2.5 px-4 rounded-xl transition-all shadow-sm shadow-indigo-100/10 text-right number-format">
                        </div>
                    </div>
