...
@section('title', 'Tambah Gudang Ban')
@section('page_title', 'Tambah Gudang Ban')
    ...
    <div class="max-w-3xl mx-auto">
        ...
        <div class="bg-white rounded-t-lg shadow-sm p-6 border-b">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-xl font-bold text-gray-800">Tambah Gudang Ban</h1>
                    <p class="text-gray-600 text-sm mt-1">Masukkan informasi gudang ban baru</p>
                </div>
        ...
        <div class="bg-white rounded-b-lg shadow-sm p-6">
            <form action="{{ route('master-gudang-ban.store') }}" method="POST">
                @csrf
                <div class="space-y-6">
                    <div>
                ...
                <div class="mt-8 flex justify-end space-x-3">
                    ...
                    <button type="submit"
                            class="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-md shadow-sm transition duration-200">
                        <i class="fas fa-save mr-2"></i>Simpan Gudang Ban
                    </button>
                </div>
            </form>
        </div>
