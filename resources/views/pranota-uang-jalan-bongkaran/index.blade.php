...
<div class="max-w-full mx-auto px-3 py-2 overflow-hidden">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 mb-4">
        ...
        <a href="{{ route('pranota-uang-jalan-bongkaran.create') }}" 
                ...
                <div class="md:col-span-2">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" 
                               ...
                               placeholder="Cari nomor uang jalan bongkaran atau no kontainer..."
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200 resizable-table" id="pranotaUangJalanBongkaranTable">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse($pranotaUangJalanBongkarans as $index => $pranota)
                        <tr class="hover:bg-gray-50 transition-colors">
                            <td class="px-2 py-2.5 whitespace-nowrap text-sm text-gray-900 font-medium">
                                {{ $pranotaUangJalanBongkarans->firstItem() + $index }}
                            </td>
                            ...
                            <td class="px-2 py-2.5 whitespace-nowrap text-sm text-gray-900 text-center">
                                <span class="inline-flex items-center justify-center px-2 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                                    {{ $pranota->jumlah_uang_jalan_bongkaran }}
                                </span>
                            </td>
                            ...
                            <td class="px-2 py-2.5 whitespace-nowrap text-center">
                                <div class="flex items-center justify-center space-x-1">
                                    <a href="{{ route('pranota-uang-jalan-bongkaran.show', $pranota) }}" 
                                    ...
                                    <a href="{{ route('pranota-uang-jalan-bongkaran.print', $pranota) }}" 
                                    ...
                                    @if($pranota->status_pembayaran == 'unpaid')
                                        <a href="{{ route('pranota-uang-jalan-bongkaran.edit', $pranota) }}" 
                                        ...
                                        <form action="{{ route('pranota-uang-jalan-bongkaran.destroy', $pranota) }}" 
                                              method="POST" 
                                              class="inline"
                        ...
                        <tr>
                            <td colspan="8" class="px-2 py-8 text-center">
                                <div class="flex flex-col items-center justify-center">
                                    ...
                                    <p class="text-gray-500 text-sm mb-3">Belum ada pranota uang jalan bongkaran yang tersedia</p>
                                    <a href="{{ route('pranota-uang-jalan-bongkaran.create') }}" 
        ...
        <!-- Pagination -->
        @if($pranotaUangJalanBongkarans->hasPages())
            <div class="bg-gray-50 px-3 py-2 border-t border-gray-200">
                {{ $pranotaUangJalanBongkarans->links() }}
            </div>
        @endif
    </div>
