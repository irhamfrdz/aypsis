...
@section('page_title', 'Detail Mobil')@section('title', 'Detail Mobil')@section('title', 'Detail Mobil')



@section('content')@section('page_title', 'Detail Mobil')@section('page_title', 'Detail Mobil')

<div class="bg-white shadow-md rounded-lg p-6">

    <div class="flex justify-between items-center mb-6">

        <h2 class="text-xl font-bold text-gray-800">Detail Mobil: {{ $mobil->kode_no ?? $mobil->nomor_polisi }}</h2>

        <div class="flex space-x-2">@section('content')@section('content')
            ...
            <a href="{{ route('master.mobil.edit', $mobil->id) }}" class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                ...
                </svg>    <div class="flex justify-between items-center mb-6">    <div class="flex justify-between items-center mb-6">

                Edit

            </a>        <h2 class="text-xl font-bold text-gray-800">Detail Mobil: {{ $mobil->kode_no ?? $mobil->nomor_polisi }}</h2>        <h2 class="text-xl font-bold text-gray-800">Detail Mobil: {{ $mobil->kode_no }}</h2>
            ...
            <a href="{{ route('master.mobil.index') }}" class="inline-flex items-center px-3 py-2 border border-gray-300 text-sm leading-4 font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                ...
                <svg class="mr-2 h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">        <div class="flex space-x-2">        <div class="flex space-x-2">

                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"></path>

                </svg>            <a href="{{ route('master.mobil.edit', $mobil->id) }}" class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">            <a href="{{ route('master.mobil.edit', $mobil->id) }}" class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">

                Kembali

            </a>                <svg class="mr-2 h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">                <svg class="mr-2 h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">

        </div>

    </div>                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>



    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">                </svg>                </svg>

        <!-- Panel Kiri -->

        <div class="space-y-6">                Edit                Edit

            <!-- Informasi Dasar -->

            <div class="bg-gray-50 p-6 rounded-lg">            </a>            </a>
                ...
                <div class="space-y-3">            <a href="{{ route('master.mobil.index') }}" class="inline-flex items-center px-3 py-2 border border-gray-300 text-sm leading-4 font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">            <a href="{{ route('master.mobil.index') }}" class="inline-flex items-center px-3 py-2 border border-gray-300 text-sm leading-4 font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                    ...
                    <div class="flex justify-between">
                        ...
                        <span class="font-medium text-gray-600">Kode No:</span>                <svg class="mr-2 h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">                <svg class="mr-2 h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">

                        <span class="text-gray-900">{{ $mobil->kode_no ?: '-' }}</span>

                    </div>                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"></path>                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"></path>

                    <div class="flex justify-between">

                        <span class="font-medium text-gray-600">Nomor Polisi:</span>                </svg>                </svg>
                    ...
                    <div class="flex justify-between">
                        ...
                        <span class="font-medium text-gray-600">Lokasi:</span>            </a>            </a>
                    ...
                    <div class="flex justify-between">
                        ...
                        <span class="font-medium text-gray-600">Merek:</span>    </div>    </div>
                    ...
                    <div class="flex justify-between">
                        ...
                        <span class="font-medium text-gray-600">Jenis:</span>    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">

                        <span class="text-gray-900">{{ $mobil->jenis ?: '-' }}</span>

                    </div>        <!-- Panel Kiri -->        <!-- Informasi Dasar -->

                    <div class="flex justify-between">

                        <span class="font-medium text-gray-600">Tahun Pembuatan:</span>        <div class="space-y-6">        <div class="space-y-6">

                        <span class="text-gray-900">{{ $mobil->tahun_pembuatan ?: '-' }}</span>

                    </div>            <!-- Informasi Dasar -->            <div class="bg-gray-50 p-6 rounded-lg">

                    <div class="flex justify-between">

                        <span class="font-medium text-gray-600">Tipe:</span>            <div class="bg-gray-50 p-6 rounded-lg">                <h3 class="text-lg font-semibold text-gray-800 mb-4 border-b border-gray-200 pb-2">Informasi Dasar</h3>

                        <span class="text-gray-900">{{ $mobil->tipe ?: '-' }}</span>

                    </div>                <h3 class="text-lg font-semibold text-gray-800 mb-4 border-b border-gray-200 pb-2">Informasi Dasar</h3>                <div class="space-y-3">

                    <div class="flex justify-between">

                        <span class="font-medium text-gray-600">Model:</span>                <div class="space-y-3">                    <div class="flex justify-between">

                        <span class="text-gray-900">{{ $mobil->model ?: '-' }}</span>

                    </div>                    <div class="flex justify-between">                        <span class="font-medium text-gray-600">Kode No:</span>

                </div>

            </div>                        <span class="font-medium text-gray-600">Kode No:</span>                        <span class="text-gray-900">{{ $mobil->kode_no ?: '-' }}</span>



            <!-- Informasi Teknis -->                        <span class="text-gray-900">{{ $mobil->kode_no ?: '-' }}</span>                    </div>

            <div class="bg-gray-50 p-6 rounded-lg">

                <h3 class="text-lg font-semibold text-gray-800 mb-4 border-b border-gray-200 pb-2">Informasi Teknis</h3>                    </div>                    <div class="flex justify-between">

                <div class="space-y-3">

                    <div class="flex justify-between">                    <div class="flex justify-between">                        <span class="font-medium text-gray-600">Nomor Polisi:</span>

                        <span class="font-medium text-gray-600">Nomor BPKB:</span>

                        <span class="text-gray-900">{{ $mobil->bpkb ?: '-' }}</span>                        <span class="font-medium text-gray-600">Nomor Polisi:</span>                        <span class="text-gray-900 font-semibold">{{ $mobil->nomor_polisi ?: '-' }}</span>

                    </div>

                    <div class="flex justify-between">                        <span class="text-gray-900 font-semibold">{{ $mobil->nomor_polisi ?: '-' }}</span>                    </div>

                        <span class="font-medium text-gray-600">Nomor Mesin:</span>

                        <span class="text-gray-900">{{ $mobil->no_mesin ?: '-' }}</span>                    </div>                    <div class="flex justify-between">

                    </div>

                    <div class="flex justify-between">                    <div class="flex justify-between">                        <span class="font-medium text-gray-600">Lokasi:</span>

                        <span class="font-medium text-gray-600">Nomor Rangka:</span>

                        <span class="text-gray-900">{{ $mobil->nomor_rangka ?: '-' }}</span>                        <span class="font-medium text-gray-600">Lokasi:</span>                        <span class="text-gray-900">{{ $mobil->lokasi ?: '-' }}</span>

                    </div>

                    <div class="flex justify-between">                        <span class="text-gray-900">{{ $mobil->lokasi ?: '-' }}</span>                    </div>

                        <span class="font-medium text-gray-600">Atas Nama:</span>

                        <span class="text-gray-900">{{ $mobil->atas_nama ?: '-' }}</span>                    </div>                    <div class="flex justify-between">

                    </div>

                    <div class="flex justify-between">                    <div class="flex justify-between">                        <span class="font-medium text-gray-600">Merek:</span>

                        <span class="font-medium text-gray-600">Silinder:</span>

                        <span class="text-gray-900">{{ $mobil->silinder ?: '-' }}</span>                        <span class="font-medium text-gray-600">Merek:</span>                        <span class="text-gray-900">{{ $mobil->merek ?: '-' }}</span>

                    </div>

                    <div class="flex justify-between">                        <span class="text-gray-900">{{ $mobil->merek ?: '-' }}</span>                    </div>

                        <span class="font-medium text-gray-600">Bahan Bakar:</span>

                        <span class="text-gray-900">{{ $mobil->bahan_bakar ?: '-' }}</span>                    </div>                    <div class="flex justify-between">

                    </div>

                    <div class="flex justify-between">                    <div class="flex justify-between">                        <span class="font-medium text-gray-600">Jenis:</span>

                        <span class="font-medium text-gray-600">Warna:</span>

                        <span class="text-gray-900">{{ $mobil->warna ?: '-' }}</span>                        <span class="font-medium text-gray-600">Jenis:</span>                        <span class="text-gray-900">{{ $mobil->jenis ?: '-' }}</span>

                    </div>

                    <div class="flex justify-between">                        <span class="text-gray-900">{{ $mobil->jenis ?: '-' }}</span>                    </div>

                        <span class="font-medium text-gray-600">Warna TNKB:</span>

                        <span class="text-gray-900">{{ $mobil->warna_tnkb ?: '-' }}</span>                    </div>                    <div class="flex justify-between">

                    </div>

                </div>                    <div class="flex justify-between">                        <span class="font-medium text-gray-600">Tahun Pembuatan:</span>
            ...
            <div class="bg-gray-50 p-6 rounded-lg">                        <span class="text-gray-900">{{ $mobil->tahun_pembuatan ?: '-' }}</span>                    </div>
                ...
                <h3 class="text-lg font-semibold text-gray-800 mb-4 border-b border-gray-200 pb-2">Informasi Pembelian</h3>

                <div class="space-y-3">                    </div>                </div>

                    <div class="flex justify-between">

                        <span class="font-medium text-gray-600">Tanggal Beli:</span>                </div>            </div>
                    ...
                    </div>            <!-- Informasi Teknis -->

                    <div class="flex justify-between">

                        <span class="font-medium text-gray-600">Harga Beli:</span>            <!-- Informasi Teknis -->            <div class="bg-gray-50 p-6 rounded-lg">

                        <span class="text-gray-900">

                            {{ $mobil->harga_beli ? 'Rp ' . number_format($mobil->harga_beli, 0, ',', '.') : '-' }}            <div class="bg-gray-50 p-6 rounded-lg">                <h3 class="text-lg font-semibold text-gray-800 mb-4 border-b border-gray-200 pb-2">Informasi Teknis</h3>

                        </span>

                    </div>                <h3 class="text-lg font-semibold text-gray-800 mb-4 border-b border-gray-200 pb-2">Informasi Teknis</h3>                <div class="space-y-3">

                    <div class="flex justify-between">

                        <span class="font-medium text-gray-600">Dealer:</span>                <div class="space-y-3">                    <div class="flex justify-between">

                        <span class="text-gray-900">{{ $mobil->dealer ?: '-' }}</span>

                    </div>                    <div class="flex justify-between">                        <span class="font-medium text-gray-600">Nomor BPKB:</span>

                </div>

            </div>                        <span class="font-medium text-gray-600">Nomor BPKB:</span>                        <span class="text-gray-900">{{ $mobil->bpkb ?: '-' }}</span>
        ...
        <div class="space-y-6">                    </div>                    <div class="flex justify-between">
            ...
            <div class="bg-gray-50 p-6 rounded-lg">                    <div class="flex justify-between">                        <span class="font-medium text-gray-600">Nomor Mesin:</span>

                <h3 class="text-lg font-semibold text-gray-800 mb-4 border-b border-gray-200 pb-2">Informasi Pajak & Dokumen</h3>

                <div class="space-y-3">                        <span class="font-medium text-gray-600">Nomor Mesin:</span>                        <span class="text-gray-900">{{ $mobil->no_mesin ?: '-' }}</span>

                    <div class="flex justify-between">

                        <span class="font-medium text-gray-600">Pajak STNK:</span>                        <span class="text-gray-900">{{ $mobil->no_mesin ?: '-' }}</span>                    </div>

                        <span class="text-gray-900 {{ $mobil->pajak_stnk && \Carbon\Carbon::parse($mobil->pajak_stnk)->isPast() ? 'text-red-600 font-semibold' : '' }}">

                            {{ $mobil->pajak_stnk ? \Carbon\Carbon::parse($mobil->pajak_stnk)->format('d/m/Y') : '-' }}                    </div>                    <div class="flex justify-between">

                            @if($mobil->pajak_stnk && \Carbon\Carbon::parse($mobil->pajak_stnk)->isPast())

                                <span class="text-xs">(Expired)</span>                    <div class="flex justify-between">                        <span class="font-medium text-gray-600">Nomor Rangka:</span>

                            @endif

                        </span>                        <span class="font-medium text-gray-600">Nomor Rangka:</span>                        <span class="text-gray-900">{{ $mobil->nomor_rangka ?: '-' }}</span>

                    </div>

                    <div class="flex justify-between">                        <span class="text-gray-900">{{ $mobil->nomor_rangka ?: '-' }}</span>                    </div>
                        ...
                        <span class="text-gray-900 {{ $mobil->pajak_plat && \Carbon\Carbon::parse($mobil->pajak_plat)->isPast() ? 'text-red-600 font-semibold' : '' }}">                    </div>                    <div class="flex justify-between">
                            ...
                            {{ $mobil->pajak_plat ? \Carbon\Carbon::parse($mobil->pajak_plat)->format('d/m/Y') : '-' }}

                            @if($mobil->pajak_plat && \Carbon\Carbon::parse($mobil->pajak_plat)->isPast())                    <div class="flex justify-between">                        <span class="font-medium text-gray-600">Atas Nama:</span>

                                <span class="text-xs">(Expired)</span>

                            @endif                        <span class="font-medium text-gray-600">Atas Nama:</span>                        <span class="text-gray-900">{{ $mobil->atas_nama ?: '-' }}</span>

                        </span>

                    </div>                        <span class="text-gray-900">{{ $mobil->atas_nama ?: '-' }}</span>                    </div>

                    <div class="flex justify-between">

                        <span class="font-medium text-gray-600">Nomor KIR:</span>                    </div>                </div>
                    ...
                    <div class="flex justify-between">
                        ...
                        <span class="font-medium text-gray-600">Pajak KIR:</span>                        <span class="font-medium text-gray-600">Tipe:</span>        </div>

                        <span class="text-gray-900 {{ $mobil->pajak_kir && \Carbon\Carbon::parse($mobil->pajak_kir)->isPast() ? 'text-red-600 font-semibold' : '' }}">

                            {{ $mobil->pajak_kir ? \Carbon\Carbon::parse($mobil->pajak_kir)->format('d/m/Y') : '-' }}                        <span class="text-gray-900">{{ $mobil->tipe ?: '-' }}</span>
