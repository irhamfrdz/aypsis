        ...
        <fieldset class="mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="aktiva" id="aktiva" value="{{ old('aktiva', $mobil->aktiva) }}" class="{{ $inputClasses }}" required maxlength="50">
                    @error('aktiva')
                ...
                <div>
                    ...
                    <input type="text" name="plat" id="plat" value="{{ old('plat', $mobil->plat) }}" class="{{ $inputClasses }}" required maxlength="20">
                    @error('plat')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="nomor_rangka" id="nomor_rangka" value="{{ old('nomor_rangka', $mobil->nomor_rangka) }}" class="{{ $inputClasses }}" required maxlength="50">
                    @error('nomor_rangka')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="ukuran" id="ukuran" value="{{ old('ukuran', $mobil->ukuran) }}" class="{{ $inputClasses }}" required maxlength="50">
                    @error('ukuran')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
