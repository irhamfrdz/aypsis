        ...
        <fieldset class="mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="nickname" id="nickname" value="{{ old('nickname') }}" class="{{ $inputClasses }}" maxlength="50" placeholder="Contoh: Truck 01, Box 05">
                    @error('nickname')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
...
$(document).ready(function() {
    ...
    $('#btn_refresh_kode').on('click', function() {
        ...
        $.ajax({
            url: '{{ route("master.mobil.get-next-kode", [], false) }}',
            method: 'GET',
