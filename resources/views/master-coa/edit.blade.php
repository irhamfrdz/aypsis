                ...
                <div class="mb-6">
                    ...
                    <select name="kode_nomor"
                        ...
                        @foreach($kodeNomors as $kodeNomor)
                            <option value="{{ $kodeNomor->kode }}" {{ old('kode_nomor', $coa->kode_nomor) == $kodeNomor->kode ? 'selected' : '' }}>
                                {{ $kodeNomor->kode }}
                ...
                <div class="mb-6">
                    ...
                    <select name="tipe_akun"
                        ...
                        @foreach($tipeAkuns as $tipeAkun)
                            <option value="{{ $tipeAkun->tipe_akun }}" {{ old('tipe_akun', $coa->tipe_akun) == $tipeAkun->tipe_akun ? 'selected' : '' }}>
                                {{ $tipeAkun->tipe_akun }}
                                @if($tipeAkun->catatan)
                                    - {{ $tipeAkun->catatan }}
                                @endif
