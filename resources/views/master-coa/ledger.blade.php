    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4 mb-6 no-print">
            <form method="GET" action="{{ route('master-coa-ledger', ['coa' => $coa->id]) }}" class="flex items-center space-x-3">
                ...
                @if(request('dari_tanggal') || request('sampai_tanggal'))
                    <div class="pt-5">
                        <a href="{{ route('master-coa-ledger', ['coa' => $coa->id]) }}" class="inline-flex items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50">
                            Reset
                        </a>
                    </div>
                @endif
