...
<div class="bg-white shadow-md rounded-lg p-6 max-w-2xl mx-auto">
    <div class="flex justify-between items-center mb-6">
        <h2 class="text-xl font-bold text-gray-800">Tambah Sertifikat Kapal</h2>
    ...
    <form action="{{ route('master-sertifikat-kapal.store') }}" method="POST">
        @csrf
        <div class="space-y-6">
            <div>
                ...
                <input type="text" name="nama_sertifikat" id="nama_sertifikat" value="{{ old('nama_sertifikat') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" required>
            </div>
