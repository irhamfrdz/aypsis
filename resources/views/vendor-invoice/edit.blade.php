...
@section('title', 'Edit Invoice Vendor')
@section('page_title', 'Edit Invoice Vendor')
...
<div class="min-h-screen bg-gray-50 py-8">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-gradient-to-r from-teal-600 to-teal-700 px-6 py-4">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-teal-100 text-sm">Update data invoice {{ $vendorInvoice->no_invoice }}</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white shadow-lg rounded-lg overflow-hidden">
            <form action="{{ route('vendor-invoice.update', $vendorInvoice) }}" method="POST" class="p-6 space-y-6" id="invoiceForm">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="col-span-1 md:col-span-2">
                        ...
                        <select name="vendor_id" id="vendor_id" class="block w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-teal-500 focus:border-teal-500 @error('vendor_id') border-red-500 @enderror" required>
                            ...
                            @foreach($vendors as $vendor)
                                <option value="{{ $vendor->id }}" {{ old('vendor_id', $vendorInvoice->vendor_id) == $vendor->id ? 'selected' : '' }}>{{ $vendor->name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div>
                        ...
                        <input type="text" name="no_invoice" id="no_invoice" value="{{ old('no_invoice', $vendorInvoice->no_invoice) }}" class="block w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-teal-500 focus:border-teal-500 @error('no_invoice') border-red-500 @enderror" placeholder="Contoh: INV/2024/001" required>
                    ...
                    <div>
                        ...
                        <input type="date" name="tgl_invoice" id="tgl_invoice" value="{{ old('tgl_invoice', $vendorInvoice->tgl_invoice->format('Y-m-d')) }}" class="block w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-teal-500 focus:border-teal-500 @error('tgl_invoice') border-red-500 @enderror" required>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" step="0.01" name="total_dpp" id="total_dpp" value="{{ old('total_dpp', $vendorInvoice->total_dpp) }}" class="calc-field block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg focus:ring-teal-500 focus:border-teal-500 @error('total_dpp') border-red-500 @enderror" required>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <span class="absolute inset-y-0 left-0 pl-3 flex items-center text-gray-500 sm:text-sm">Rp</span>
                            <input type="number" step="0.01" name="total_ppn" id="total_ppn" value="{{ old('total_ppn', $vendorInvoice->total_ppn) }}" class="calc-field block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg focus:ring-teal-500 focus:border-teal-500 @error('total_ppn') border-red-500 @enderror" required>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <span class="absolute inset-y-0 left-0 pl-3 flex items-center text-gray-500 sm:text-sm">Rp</span>
                            <input type="number" step="0.01" name="total_pph23" id="total_pph23" value="{{ old('total_pph23', $vendorInvoice->total_pph23) }}" class="calc-field block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg focus:ring-teal-500 focus:border-teal-500 @error('total_pph23') border-red-500 @enderror" required>
                        </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <span class="absolute inset-y-0 left-0 pl-3 flex items-center text-gray-500 sm:text-sm">Rp</span>
                            <input type="number" step="0.01" name="total_materai" id="total_materai" value="{{ old('total_materai', $vendorInvoice->total_materai) }}" class="calc-field block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg focus:ring-teal-500 focus:border-teal-500 @error('total_materai') border-red-500 @enderror">
                        </div>
                    </div>
                    ...
                    <div class="col-span-1 md:col-span-2 bg-teal-50 p-4 rounded-lg border border-teal-100 mt-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="number" step="0.01" name="total_netto" id="total_netto" value="{{ old('total_netto', $vendorInvoice->total_netto) }}" class="block w-full pl-14 pr-4 py-3 border-2 border-teal-300 rounded-xl focus:ring-teal-500 focus:border-teal-500 text-2xl font-black text-teal-800 text-right bg-white @error('total_netto') border-red-500 @enderror" required readonly>
                        </div>
                ...
                <div class="flex items-center justify-end space-x-4 pt-8 border-t border-gray-100">
                    ...
                    <button type="submit" class="px-10 py-2 bg-teal-600 text-white font-black rounded-lg hover:bg-teal-700 shadow-lg hover:shadow-xl transition duration-150">Simpan Perubahan</button>
                </div>
            </form>
        </div>
    </div>
