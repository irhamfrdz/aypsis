    ...
    <tbody>
        ...
        @foreach($grouped as $key => $items)
            ...
            <tr>
                ...
                <td align="left"><b>1 {{ $first->satuan ?: 'UNIT/PALET' }}</b> {{ str_replace(', ', "," . chr(10), strtoupper($first->nama_barang)) }}</td>
                <td></td><td></td><td></td>
                <td align="left">Rp</td>
            ...
            @if($items->count() > 1)
                ...
                <tr>
                    ...
                    <td align="left"><b>1 {{ $later->satuan ?: 'UNIT/PALET' }}</b> {{ str_replace(', ', "," . chr(10), strtoupper($later->nama_barang)) }}</td>
                </tr>
                @endforeach
            @endif
