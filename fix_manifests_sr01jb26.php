...
/**
 * Script untuk membuat manifest untuk voyage SR01JB26
 * Memeriksa semua kontainer yang sudah OB untuk voyage ini
 * 
 * Cara menjalankan:
 * php fix_manifests_sr01jb26.php
 */
...
echo "===== FIX MANIFESTS - VOYAGE SR01JB26 =====\n";
echo "Memeriksa kontainer untuk voyage SR01JB26...\n\n";

try {
    DB::beginTransaction();
    
    $targetVoyage = 'SR01JB26';
