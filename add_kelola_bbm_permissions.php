...
try {
    // Permissions untuk Kelola BBM
    $permissions = [
        'master-kelola-bbm-view',
        'master-kelola-bbm-create',
        'master-kelola-bbm-edit',
        'master-kelola-bbm-delete',
    ];

    echo "=== Menambahkan Permissions Kelola BBM ===\n\n";
