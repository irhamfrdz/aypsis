...
try {
    ...
    $fileName = 'manual_export_' . date('Ymd_His') . '.csv';
    
    // Generate CSV file directly to disk
    ...
    // Check for Rohman specifically
    $content = file_get_contents($fileName);
    if (stripos($content, 'rohman') !== false) {
        echo "✓ Rohman data found in exported CSV!\n";
    } else {
        echo "✗ Rohman data NOT found in exported CSV!\n";
    }
