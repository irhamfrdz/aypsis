...
Route::middleware(['auth'])->group(function () {
    ...
    /*
    |===========================================================================
    | 🔧 PERBAIKAN KONTAINER ROUTES
    |===========================================================================
    | Manajemen perbaikan & perawatan kontainer (tagihan, pranota, pembayaran)
    */

    // Perbaikan Kontainer - extra actions (MUST be before resource routes)
    Route::get('perbaikan-kontainer/print-bulk', [\App\Http\Controllers\PerbaikanKontainerController::class, 'printBulk'])
    ...
    Route::get('perbaikan-kontainer/{perbaikanKontainer}/print', [\App\Http\Controllers\PerbaikanKontainerController::class, 'print'])
         ...
         ->middleware('can:tagihan-perbaikan-kontainer-view');
    Route::patch('perbaikan-kontainer/{perbaikanKontainer}/update-status', [\App\Http\Controllers\PerbaikanKontainerController::class, 'updateStatus'])
    ...
    Route::post('perbaikan-kontainer/bulk-update-status', [\App\Http\Controllers\PerbaikanKontainerController::class, 'bulkUpdateStatus'])
         ->name('perbaikan-kontainer.bulk-update-status')
         ->middleware('can:tagihan-perbaikan-kontainer-update');
    Route::post('perbaikan-kontainer/bulk-pranota', [\App\Http\Controllers\PerbaikanKontainerController::class, 'bulkPranota'])
    ...
    // Perbaikan Kontainer - CRUD (index, create, store, show, edit, update, destroy)
    ...
    Route::get('pembayaran-pranota-perbaikan-kontainer', [PembayaranPranotaPerbaikanKontainerController::class, 'index'])
         ->name('pembayaran-pranota-perbaikan-kontainer.index')
         ->middleware('can:pembayaran-pranota-perbaikan-kontainer-view');
    Route::get('pembayaran-pranota-perbaikan-kontainer/{pembayaranPranotaPerbaikanKontainer}', [PembayaranPranotaPerbaikanKontainerController::class, 'show'])
         ->name('pembayaran-pranota-perbaikan-kontainer.show')
         ->middleware('can:pembayaran-pranota-perbaikan-kontainer-view');
    Route::post('pembayaran-pranota-perbaikan-kontainer', [PembayaranPranotaPerbaikanKontainerController::class, 'store'])
         ->name('pembayaran-pranota-perbaikan-kontainer.store')
         ->middleware('can:pembayaran-pranota-perbaikan-kontainer-create');
    Route::delete('pembayaran-pranota-perbaikan-kontainer/{pembayaranPranotaPerbaikanKontainer}', [PembayaranPranotaPerbaikanKontainerController::class, 'destroy'])
