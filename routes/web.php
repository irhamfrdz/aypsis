...
Route::middleware(['auth', \App\Http\Middleware\EnsureKaryawanPresent::class, \App\Http\Middleware\EnsureUserApproved::class])->group(function () {
    ...
    Route::get('stock-amprahan/dashboard-pemakaian/hasil', [\App\Http\Controllers\DashboardPemakaianBarangController::class, 'index'])->name('stock-amprahan.dashboard-pemakaian.hasil')->middleware('can:stock-amprahan-view');
