...
Route::middleware([
    ...
    Route::post('/kontainer-sewa-final/submit-pranota', [App\Http\Controllers\KontainerSewaFinalController::class, 'submitPranota'])->name('kontainer-sewa-final.submit-pranota');
    ...
    Route::get('/tanda-terima-surat-jalan-kontainer-sewa-next-number', [\App\Http\Controllers\TandaTerimaSuratJalanKontainerSewaController::class, 'getNextNumber'])->name('tanda-terima-surat-jalan-kontainer-sewa.get-next-number');
    Route::get('/tanda-terima-surat-jalan-kontainer-sewa/{id}/print', [\App\Http\Controllers\TandaTerimaSuratJalanKontainerSewaController::class, 'print'])->name('tanda-terima-surat-jalan-kontainer-sewa.print');
    Route::resource('tanda-terima-surat-jalan-kontainer-sewa', \App\Http\Controllers\TandaTerimaSuratJalanKontainerSewaController::class)->parameters([
        'tanda-terima-surat-jalan-kontainer-sewa' => 'tanda_terima_sewa',
    ]);
    ...
    */
    ...
    Route::prefix('master')->name('master.')->middleware(['auth'])->group(function () {
        ...
        Route::get('persetujuan-absensi/riwayat', function () {
        ...
        Route::prefix('api')->group(function () {
            Route::get('/admin/pending-attendance', function () {
                ...
                $userNik = null;
                if ($karyawanUser) {
                    $userNik = $karyawanUser->nik;
                    $pekerjaan = strtoupper($karyawanUser->pekerjaan ?? '');
                    if (in_array($pekerjaan, ['HRD', 'IT'])) {
                        $canApproveAll = true;
                    }
                }
                if ($user->hasRole('super-admin') || $user->username === 'kiky') {
                    $canApproveAll = true;
                }
    ...
    */
    ...
    Route::prefix('master')->name('master.')->group(function () {
        ...
        Route::get('kontainer/stock-pergudang', [\App\Http\Controllers\StockKontainerPergudangController::class, 'index'])
            ...
            ->middleware('can:master-kontainer-view');
        Route::post('kontainer/stock-pergudang/sync', [\App\Http\Controllers\StockKontainerPergudangController::class, 'syncManual'])
            ->name('kontainer.stock-pergudang.sync')
        ...
        Route::get('kontainer/stock-pergudang/{id}', [\App\Http\Controllers\StockKontainerPergudangController::class, 'show'])
            ...
            ->middleware('can:master-kontainer-view');
        Route::get('kontainer/stock-pergudang/{id}/export', [\App\Http\Controllers\StockKontainerPergudangController::class, 'exportDetail'])
            ->name('kontainer.stock-pergudang.export')
            ->middleware('can:master-kontainer-view');
        ...
        Route::get('pricelist-opp-opt', [\App\Http\Controllers\PricelistOppOptController::class, 'index'])
            ->name('pricelist-opp-opt.index')
            ->middleware('can:master-pricelist-opp-opt-view');
        Route::get('pricelist-opp-opt/create', [\App\Http\Controllers\PricelistOppOptController::class, 'create'])
            ->name('pricelist-opp-opt.create')
            ->middleware('can:master-pricelist-opp-opt-create');
        Route::post('pricelist-opp-opt', [\App\Http\Controllers\PricelistOppOptController::class, 'store'])
            ->name('pricelist-opp-opt.store')
            ->middleware('can:master-pricelist-opp-opt-create');
        Route::get('pricelist-opp-opt/{id}/edit', [\App\Http\Controllers\PricelistOppOptController::class, 'edit'])
            ->name('pricelist-opp-opt.edit')
            ->middleware('can:master-pricelist-opp-opt-update');
        Route::put('pricelist-opp-opt/{id}', [\App\Http\Controllers\PricelistOppOptController::class, 'update'])
            ->name('pricelist-opp-opt.update')
            ->middleware('can:master-pricelist-opp-opt-update');
        Route::delete('pricelist-opp-opt/{id}', [\App\Http\Controllers\PricelistOppOptController::class, 'destroy'])
        ...
        // Pricelist Tanto Routes
        Route::get('pricelist-tanto', [\App\Http\Controllers\PricelistTantoController::class, 'index'])
            ->name('pricelist-tanto.index')
            ->middleware('can:master-pricelist-tanto-view');
        Route::get('pricelist-tanto/create', [\App\Http\Controllers\PricelistTantoController::class, 'create'])
            ->name('pricelist-tanto.create')
            ->middleware('can:master-pricelist-tanto-create');
        Route::post('pricelist-tanto', [\App\Http\Controllers\PricelistTantoController::class, 'store'])
            ->name('pricelist-tanto.store')
            ->middleware('can:master-pricelist-tanto-create');
        Route::get('pricelist-tanto/{id}/edit', [\App\Http\Controllers\PricelistTantoController::class, 'edit'])
            ->name('pricelist-tanto.edit')
            ->middleware('can:master-pricelist-tanto-update');
        Route::put('pricelist-tanto/{id}', [\App\Http\Controllers\PricelistTantoController::class, 'update'])
            ->name('pricelist-tanto.update')
            ->middleware('can:master-pricelist-tanto-update');
        Route::delete('pricelist-tanto/{id}', [\App\Http\Controllers\PricelistTantoController::class, 'destroy'])
            ->name('pricelist-tanto.destroy')
            ->middleware('can:master-pricelist-tanto-delete');
    ...
    Route::middleware([
        ...
        Route::get('absensi/export-machine-users', [AbsensiController::class, 'exportMachineUsers'])
    ...
    Route::middleware([
        ...
        Route::match(['get', 'post'], 'asuransi-tanda-terima/export', [AsuransiTandaTerimaController::class, 'exportExcel'])
        ...
        Route::post('master-kapal/{master_kapal}/print-spkbm', [\App\Http\Controllers\MasterKapalController::class, 'printSpkbm'])
        ...
        Route::post('biaya-kapal/get-manifests-by-kapal-voyage', [\App\Http\Controllers\BiayaKapalController::class, 'getManifestsByKapalVoyage'])
            ->name('biaya-kapal.get-manifests-by-kapal-voyage');
        ...
        Route::get('biaya-kapal/get-containers', [\App\Http\Controllers\BiayaKapalController::class, 'getContainersByVoyage'])
            ->name('biaya-kapal.get-containers');
        ...
        Route::get('master/klasifikasi-biaya-export', [KlasifikasiBiayaController::class, 'export'])
            ->name('klasifikasi-biaya.export')
            ->middleware('can:master-klasifikasi-biaya-view');

        Route::get('master/klasifikasi-biaya-download-template', [KlasifikasiBiayaController::class, 'downloadTemplate'])
            ->name('klasifikasi-biaya.download-template')
            ->middleware('can:master-klasifikasi-biaya-view');

        Route::get('master/klasifikasi-biaya-import', [KlasifikasiBiayaController::class, 'showImportForm'])
            ->name('klasifikasi-biaya.import-form')
            ->middleware('can:master-klasifikasi-biaya-create');

        Route::post('master/klasifikasi-biaya-import', [KlasifikasiBiayaController::class, 'import'])
            ->name('klasifikasi-biaya.import')
            ->middleware('can:master-klasifikasi-biaya-create');

        Route::get('master/klasifikasi-biaya-get-next-kode', [KlasifikasiBiayaController::class, 'getNextKode'])
        ...
        Route::resource('master/vendor-invoice', \App\Http\Controllers\VendorInvoiceController::class)
            ->names([
                'index' => 'vendor-invoice.index',
                'create' => 'vendor-invoice.create',
                'store' => 'vendor-invoice.store',
                'show' => 'vendor-invoice.show',
                'edit' => 'vendor-invoice.edit',
                'update' => 'vendor-invoice.update',
                'destroy' => 'vendor-invoice.destroy',
            ])
            ->parameters(['vendor-invoice' => 'vendorInvoice'])
            ->middleware([
                'index' => 'can:vendor-invoice-view',
                'create' => 'can:vendor-invoice-create',
                'store' => 'can:vendor-invoice-create',
                'show' => 'can:vendor-invoice-view',
                'edit' => 'can:vendor-invoice-edit',
                'update' => 'can:vendor-invoice-edit',
                'destroy' => 'can:vendor-invoice-delete',
            ]);
    ...
    Route::middleware(['auth'])->group(function () {
        ...
        Route::get('orders-batam/{orderBatam}/edit', [\App\Http\Controllers\OrderBatamController::class, 'edit'])
            ...
            ->middleware('can:order-batam-update');
        ...
        Route::post('surat-jalan-tarik-kosong-batam/store-bulk', [\App\Http\Controllers\SuratJalanTarikKosongBatamController::class, 'storeBulk'])
            ...
            ->middleware('can:surat-jalan-tarik-kosong-batam-create');
        Route::post('surat-jalan-tarik-kosong-batam/check-container-sizes', [\App\Http\Controllers\SuratJalanTarikKosongBatamController::class, 'checkContainerSizes'])
            ->name('surat-jalan-tarik-kosong-batam.check-container-sizes')
            ->middleware('can:surat-jalan-tarik-kosong-batam-view');
        ...
        Route::get('/surat-jalan-bongkaran-batam/get-voyages', [\App\Http\Controllers\SuratJalanBongkaranBatamController::class, 'getVoyages'])
            ...
            ->middleware('permission:surat-jalan-bongkaran-batam-view');
        Route::post('/surat-jalan-bongkaran-batam/check-container-sizes', [\App\Http\Controllers\SuratJalanBongkaranBatamController::class, 'checkContainerSizes'])
            ->name('surat-jalan-bongkaran-batam.check-container-sizes')
            ->middleware('can:surat-jalan-bongkaran-batam-view');
        ...
        Route::get('pranota-uang-rit-kenek/{pranotaUangRitKenek}/print', [\App\Http\Controllers\PranotaUangRitKenekController::class, 'print'])
            ...
            ->middleware('can:pranota-uang-rit-kenek-print');
        ...
        Route::get('pranota-invoice-vendor-supir/{id}/get-surat-jalans', [\App\Http\Controllers\PranotaInvoiceVendorSupirController::class, 'getSuratJalans'])
            ->name('pranota-invoice-vendor-supir.get-surat-jalans')
            ->middleware('can:pranota-invoice-vendor-supir-update');
        ...
        Route::resource('pembayaran-pranota-invoice-vendor-supir', \App\Http\Controllers\PembayaranPranotaInvoiceVendorSupirController::class)
            ...
            ->middleware([
                ...
                'store' => 'can:pembayaran-pranota-invoice-vendor-supir-create',
                'show' => 'can:pembayaran-pranota-invoice-vendor-supir-view',
...
Route::middleware(['auth'])->group(function () {
    ...
    // ->middleware('can:pranota-kontainer-sewa-create'); // Commented temporarily
    Route::get('pranota-kontainer-sewa/create', [PranotaTagihanKontainerSewaController::class, 'create'])
        ->name('pranota-kontainer-sewa.create')
        ->middleware('can:pranota-kontainer-sewa-create');
    Route::get('pranota-kontainer-sewa/{pranota}', [PranotaTagihanKontainerSewaController::class, 'show'])
        ->name('pranota-kontainer-sewa.show')
        ->middleware('can:pranota-kontainer-sewa-view');
    Route::get('pranota-kontainer-sewa/{pranota}/edit', [PranotaTagihanKontainerSewaController::class, 'edit'])
        ->name('pranota-kontainer-sewa.edit')
        ->middleware('can:pranota-kontainer-sewa-edit');
    Route::put('pranota-kontainer-sewa/{pranota}', [PranotaTagihanKontainerSewaController::class, 'update'])
        ->name('pranota-kontainer-sewa.update')
        ->middleware('can:pranota-kontainer-sewa-update');
    Route::get('pranota-kontainer-sewa/{pranota}/print', [PranotaTagihanKontainerSewaController::class, 'print'])
        ->name('pranota-kontainer-sewa.print')
        ->middleware('can:pranota-kontainer-sewa-print');
    Route::post('pranota-kontainer-sewa', [PranotaTagihanKontainerSewaController::class, 'store'])
        ->name('pranota-kontainer-sewa.store')
        ->middleware('can:pranota-kontainer-sewa-create');
    Route::post('pranota-kontainer-sewa/bulk-create-from-tagihan-kontainer-sewa', [PranotaTagihanKontainerSewaController::class, 'bulkCreateFromTagihanKontainerSewa'])
        ->name('pranota-kontainer-sewa.bulk-create-from-tagihan-kontainer-sewa')
        ->middleware('can:pranota-kontainer-sewa-create');
    Route::get('pranota-kontainer-sewa/next-number', [PranotaTagihanKontainerSewaController::class, 'getNextPranotaNumber'])
        ->name('pranota-kontainer-sewa.next-number')
        ->middleware('can:pranota-kontainer-sewa-view');
    Route::post('pranota-kontainer-sewa/bulk-status-update', [PranotaTagihanKontainerSewaController::class, 'bulkStatusUpdate'])
    ...
    Route::delete('pranota-kontainer-sewa-bulk-delete', [PranotaTagihanKontainerSewaController::class, 'bulkDelete'])
        ->name('pranota-kontainer-sewa.bulk-delete')
        ->middleware('can:pranota-kontainer-sewa-delete');

    // New routes for vendor invoice grouping
    Route::post('pranota-kontainer-sewa/create-by-vendor-invoice-group', [PranotaTagihanKontainerSewaController::class, 'createPranotaByVendorInvoiceGroup'])
        ->name('pranota-kontainer-sewa.create-by-vendor-invoice-group')
        ->middleware('can:pranota-kontainer-sewa-create');
    Route::post('pranota-kontainer-sewa/preview-vendor-invoice-grouping', [PranotaTagihanKontainerSewaController::class, 'previewVendorInvoiceGrouping'])
        ->name('pranota-kontainer-sewa.preview-vendor-invoice-grouping')
        ->middleware('can:pranota-kontainer-sewa-view');
    Route::post('pranota-kontainer-sewa/add-items-to-existing', [PranotaTagihanKontainerSewaController::class, 'addItemsToExisting'])
        ->name('pranota-kontainer-sewa.add-items-to-existing')
        ->middleware('can:pranota-kontainer-sewa-update');
    Route::post('pranota-kontainer-sewa/update-grand-total', [PranotaTagihanKontainerSewaController::class, 'updateGrandTotal'])
...
Route::prefix('pembayaran-aktivitas-lain')->name('pembayaran-aktivitas-lain.')->middleware(['auth'])->group(function () {
    ...
    Route::patch('/{pembayaranAktivitasLain}/update-jumlah', [PembayaranAktivitasLainController::class, 'updateJumlah'])->name('update-jumlah')
        ->middleware('can:pembayaran-aktivitas-lain-update');
    Route::patch('/{pembayaranAktivitasLain}/update-nomor-accurate', [PembayaranAktivitasLainController::class, 'updateNomorAccurate'])->name('update-nomor-accurate')
        ->middleware('can:pembayaran-aktivitas-lain-update');
...
Route::middleware(['auth'])->prefix('report')->name('report.')->group(function () {
    ...
    Route::get('/tanda-terima-jakarta', [App\Http\Controllers\ReportTandaTerimaJakartaController::class, 'index'])->name('tanda-terima-jakarta.index');
    ...
    Route::post('/kas-truck/update-starting-balance', [App\Http\Controllers\Report\KasTruckController::class, 'updateStartingBalance'])->name('kas-truck.update-starting-balance')->middleware('only.kiky');
    ...
    Route::post('manifests/{id}/update-shipper', [App\Http\Controllers\ManifestController::class, 'updateShipper'])->name('manifests.update-shipper');
    Route::post('manifests/{id}/add-shipper', [App\Http\Controllers\ManifestController::class, 'addShipper'])->name('manifests.add-shipper');
...
Route::middleware(['auth', \App\Http\Middleware\EnsureKaryawanPresent::class, \App\Http\Middleware\EnsureUserApproved::class])->group(function () {
    ...
    Route::get('stock-amprahan/generate-nomor-pranota', [\App\Http\Controllers\StockAmprahanController::class, 'generateNomorPranota'])
        ...
        ->middleware('can:pranota-stock-create');
    ...
    Route::get('stock-amprahan/dashboard-pemakaian/hasil', [\App\Http\Controllers\DashboardPemakaianBarangController::class, 'show'])->name('stock-amprahan.dashboard-pemakaian.hasil')->middleware('can:stock-amprahan-view');
    ...
    Route::get('dokumen-tanda-terima/select', [\App\Http\Controllers\DokumenTandaTerimaController::class, 'select'])
        ...
        ->middleware('can:dokumen-tanda-terima-view');
    ...
    Route::post('tanda-terima-lcl/sync-manifest', [TandaTerimaLclController::class, 'syncManifest'])
        ->name('tanda-terima-lcl.sync-manifest')
        ->middleware('only.kiky');
    ...
    Route::prefix('admin')->name('admin.')->group(function () {
        ...
        Route::get('cek-kendaraan-daily/export', [\App\Http\Controllers\CekKendaraanController::class, 'exportDaily'])
...
Route::middleware(['auth',
    ...
    Route::get('permohonan-amprahan/create', [\App\Http\Controllers\PermohonanAmprahanController::class, 'create'])->name('permohonan-amprahan.create')->middleware('can:permohonan-amprahan-create');
