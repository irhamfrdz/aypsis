...
Route::middleware(['auth'])->group(function () {
    ...
    */
    ...
    Route::get('pembayaran-pranota-perbaikan-kontainer/{pembayaran}', [PembayaranPranotaPerbaikanKontainerController::class, 'show'])
    ...
    Route::delete('pembayaran-pranota-perbaikan-kontainer/{pembayaran}', [PembayaranPranotaPerbaikanKontainerController::class, 'destroy'])
