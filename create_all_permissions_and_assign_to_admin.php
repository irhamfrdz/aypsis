...
echo "=== MEMBUAT SEMUA PERMISSIONS DAN ASSIGN KE ADMIN ===\n\n";

// Daftar lengkap permissions berdasarkan analisis web.php
$permissions = [
    // Authentication & Core
    'login',
    'logout',
    ...
    'master-kontainer-print',
    'master-kontainer-export',
    ...
    'master-kegiatan-print',
    'master-kegiatan-export',
    ...
    'master-permission-print',
    'master-permission-export',
    ...
    'master-vendor-bengkel-print',
    'master-vendor-bengkel-export',
    ...
    'master-kode-nomor-print',
    'master-kode-nomor-export',
    'master-kode-nomor',
    ...
    'master-stock-kontainer-print',
    'master-stock-kontainer-export',
    ...
    'master-tipe-akun-destroy',
    'master-tipe-akun-print',
    'master-tipe-akun-export',
    'master-tipe-akun',
    ...
    'master-nomor-terakhir-print',
    'master-nomor-terakhir-export',
    ...
    'master-pricelist-sewa-kontainer-print',
    'master-pricelist-sewa-kontainer-export',
    
    'master-pricelist-cat-view',
    'master-pricelist-cat-create',
    'master-pricelist-cat-update',
    'master-pricelist-cat-delete',
    'master-pricelist-cat-print',
    'master-pricelist-cat-export',
    ...
    'pembayaran-pranota-kontainer-export',
    ...
    'pembayaran-aktivitas-lainnya-reject',
    ...
    'tagihan-perbaikan-kontainer-export',
    ...
    'admin.features',
    'admin.user-approval',
    'admin.user-approval.create',
    'admin.user-approval.update',
...
echo "Total permissions yang akan dibuat: " . count($permissions) . "\n\n";
...
try {
    ...
    foreach ($permissions as $permission) {
        ...
        if (!$existingPermission) {
            ...
            $existingCount++;
            echo "⚠️  Exists: {$permission}\n";
        }
    }
    
    echo "\n=== SUMMARY PERMISSIONS ===\n";
    echo "Permissions dibuat: {$createdCount}\n";
    echo "Permissions sudah ada: {$existingCount}\n";
    echo "Total permissions: " . ($createdCount + $existingCount) . "\n\n";
    ...
    if ($adminUsers->isEmpty()) {
        ...
        echo "Silakan buat user admin terlebih dahulu atau ubah email/name user untuk mengandung kata 'admin'\n";
        DB::rollBack();
        return;
    }
    
    echo "=== ADMIN USERS DITEMUKAN ===\n";
    ...
    echo "✅ Role admin tersedia\n\n";
    
    // Assign semua permissions ke admin users
    foreach ($adminUsers as $admin) {
        echo "=== ASSIGNING PERMISSIONS TO {$admin->name} ===\n";
        ...
        // Assign semua permissions
        $allPermissions = Permission::all();
        $admin->syncPermissions($allPermissions);
        
        echo "✅ Assigned semua {$allPermissions->count()} permissions\n";
        echo "✅ User {$admin->name} sekarang memiliki akses penuh\n\n";
    }
    ...
    echo "=== FINAL SUMMARY ===\n";
    echo "✅ Semua permissions berhasil dibuat\n";
    echo "✅ Semua permissions berhasil di-assign ke admin users\n";
    echo "✅ Admin users sekarang memiliki akses penuh ke seluruh sistem\n\n";
    
    echo "Admin users dengan permissions lengkap:\n";
    foreach ($adminUsers as $admin) {
        echo "- {$admin->name} ({$admin->email}) - {$admin->permissions->count()} permissions\n";
    }
