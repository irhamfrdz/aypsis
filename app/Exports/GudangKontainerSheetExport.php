...
class GudangKontainerSheetExport implements FromCollection, ShouldAutoSize, WithEvents, WithHeadings, WithTitle
{
    protected $gudangId;
    ...
    public function __construct($gudangId, $type, $title)
    {
    ...
    public function collection()
    {
        ...
        return $stockKontainers->concat($kontainers); // Milik sendiri di atas, lalu sewa. Jika type spesifik, salah satu kosong.
    }
