...
class ProspekBatamExport implements FromCollection, WithHeadings, ShouldAutoSize, WithEvents
{
    protected $filters;
    ...
    public function collection()
    {
        ...
        if (!empty($this->prospekIds)) {
            $query = ProspekBatam::whereIn('id', $this->prospekIds);
        } else {
            $query = ProspekBatam::orderBy('created_at', 'desc');
