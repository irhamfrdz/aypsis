...
class BiayaKapal extends Model
{
    ...
    public function tanggalBayarDetails()
    {
        return $this->hasMany(BiayaKapalTanggalBayar::class, 'biaya_kapal_id');
    }
    ...
    public function meratusDetails()
    {
    ...
    public function tantoDetails()
    {
        return $this->hasMany(BiayaKapalTanto::class, 'biaya_kapal_id');
    }
    ...
    public function notaReturDetails()
    {
