...
class Karyawan extends Model
{
    ...
    protected $fillable = [
        ...
        'status_perkawinan', 'agama', 'divisi', 'pekerjaan', 'posisi', 'penempatan', 'tanggal_masuk', 'tanggal_berhenti',
        'tanggal_masuk_sebelumnya', 'tanggal_berhenti_sebelumnya', 'catatan', 'catatan_pekerjaan', 'status_pajak',
        'nama_bank', 'bank_cabang', 'akun_bank', 'atas_nama', 'jkn', 'dpp_jkn', 'status_jkn', 'group_jkn', 'no_ketenagakerjaan', 'dpp_bp_jamsostek', 'status_bp_jamsostek', 'group_bp_jamsostek', 'cabang_bpjs', 'no_sim',
