...
class PranotaUangJalanBatam extends Model
{
    use HasFactory, SoftDeletes;

    protected $table = 'pranota_uang_jalan_batams';
    ...
    /**
     * Generate nomor pranota batam otomatis
     * Format: PRN-UJBTM-YYYYMMDD-XXXX (XXXX is running number)
     */
