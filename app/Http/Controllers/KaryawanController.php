...
class KaryawanController extends Controller
{
    ...
    {
        // Generate NIK otomatis sebelum validasi
        $autoGeneratedNik = Karyawan::generateNextNik();
        ...
        // Set NIK yang di-generate otomatis
        $validated['nik'] = $autoGeneratedNik;
    ...
    public function update(Request $request, Karyawan $karyawan)
    {
        ...
        $validated = $request->validate([
            ...
            'ktp' => ['nullable', 'string', 'regex:/^[0-9]{16}$/', Rule::unique('karyawans')->ignore($karyawan->id)->whereNotNull('ktp')],
            'kk' => ['nullable', 'string', 'regex:/^[0-9]{16}$/', Rule::unique('karyawans')->ignore($karyawan->id)->whereNotNull('kk')],
            'alamat' => 'nullable|string|max:255',
            'rt_rw' => 'nullable|string|max:255',
            'kelurahan' => 'nullable|string|max:255',
            'kecamatan' => 'nullable|string|max:255',
