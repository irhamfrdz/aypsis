...
class BlController extends Controller
{
    ...
    /**
     * Show the selection form for Rekap Bongkaran.
     */
    public function rekapBongkaranSelect()
    {
        $user = Auth::user();
        ...
        return view('bl.rekap_bongkaran_select', compact('masterKapals'));
    }

    /**
     * Show the Rekap Bongkaran report.
     */
    ...
    /**
     * Show the Rekap Bongkaran report for print.
     */
    public function rekapBongkaranPrint(Request $request)
    {
        $user = Auth::user();
    ...
    public function rekapBongkaranPerincian(Request $request)
    {
        ...
        return view('bl.rekap_bongkaran_perincian', compact('namaKapal', 'noVoyage', 'dari', 'estTiba', 'labelTanggal', 'items', 'totalAmount'));
    }
    ...
    public function rekapBongkaranPerincianPrint(Request $request)
    {
        ...
        return view('bl.rekap_bongkaran_perincian_print', compact('namaKapal', 'noVoyage', 'dari', 'estTiba', 'labelTanggal', 'items', 'totalAmount'));
    }
