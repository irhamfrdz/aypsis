...
class AlatBeratController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'nomor_sertifikat_sia' => 'nullable|string|max:255',
            'tanggal_terbit_sertifikat_sia' => 'nullable|date|required_with:biaya_sertifikat_sia',
            'tanggal_kadaluarsa_sertifikat_sia' => 'nullable|date|required_with:biaya_sertifikat_sia|after_or_equal:tanggal_terbit_sertifikat_sia',
            'biaya_sertifikat_sia' => 'nullable|numeric|min:0',
