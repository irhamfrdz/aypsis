...
use App\Models\TandaTerimaTanpaSuratJalanBatam;
...
class TandaTerimaTanpaSuratJalanBatamController extends Controller
{
    public function __construct()
    {
        $this->middleware('permission:tanda-terima-tanpa-surat-jalan-batam-view', ['only' => ['index', 'show']]);
        $this->middleware('permission:tanda-terima-tanpa-surat-jalan-batam-create', ['only' => ['create', 'store']]);
        $this->middleware('permission:tanda-terima-tanpa-surat-jalan-batam-update', ['only' => ['edit', 'update']]);
        $this->middleware('permission:tanda-terima-tanpa-surat-jalan-batam-delete', ['only' => ['destroy']]);
    }
    /**
    ...
    public function index(Request $request)
    {
        ...
        if ($tipe == 'lcl') {
            $query = \App\Models\TandaTerimaLclBatam::query();
            ...
            $stats = [
                'total' => \App\Models\TandaTerimaLclBatam::count(),
                'draft' => 0,
                'terkirim' => 0,
                'selesai' => 0,
            ];
            ...
            $query = TandaTerimaTanpaSuratJalanBatam::query();
            ...
            // Statistics
            $stats = [
                'total' => TandaTerimaTanpaSuratJalanBatam::count(),
                'draft' => 0,
                'terkirim' => 0,
                'selesai' => 0,
            ];
        ...
        return view('tanda-terima-tanpa-surat-jalan-batam.index', compact('tandaTerimas', 'stats', 'isLclData', 'availableKontainers'));
    }
    ...
    {
        return view('tanda-terima-tanpa-surat-jalan-batam.pilih-tipe');
    }
    ...
    public function create(Request $request)
    {
        ...
        if (!in_array($tipe, ['fcl', 'lcl', 'cargo'])) {
            return redirect()->route('tanda-terima-tanpa-surat-jalan-batam.pilih-tipe')
        ...
        return view('tanda-terima-tanpa-surat-jalan-batam.create', compact('terms', 'pengirims', 'masterPengirimPenerima', 'supirs', 'kranis', 'tujuan_kirims', 'master_kapals', 'tipe', 'containerOptions', 'kegiatanSuratJalan', 'gudangs'));
    }
    ...
    public function createLcl()
    {
        ...
        return view('tanda-terima-tanpa-surat-jalan-batam.create-lcl', compact(
            'terms', 
            'pengirims',
        ...
        */
        ...
        try {
            ...
            $validated['no_tanda_terima'] = !empty($validated['nomor_tanda_terima']) 
                ...
                : TandaTerimaTanpaSuratJalanBatam::generateNoTandaTerima();
            ...
            // Create main record
            $tandaTerima = TandaTerimaTanpaSuratJalanBatam::create($validated);
            ...
            return redirect()->route('tanda-terima-tanpa-surat-jalan-batam.index')
     ...
     */
    public function show(TandaTerimaTanpaSuratJalanBatam $tandaTerimaTanpaSuratJalan)
    {
        // Load dimensi items relationship
        $tandaTerimaTanpaSuratJalan->load(['dimensiItems', 'term', 'creator', 'updater']);
        
        return view('tanda-terima-tanpa-surat-jalan-batam.show', compact('tandaTerimaTanpaSuratJalan'));
    }

    /**
     * Show the form for editing the specified resource.
     */
    public function edit(TandaTerimaTanpaSuratJalanBatam $tandaTerimaTanpaSuratJalan)
    {
        $terms = Term::where('status', 'active')->get();
        $pengirims = Pengirim::where('status', 'active')->get();
        $masterPengirimPenerima = MasterPengirimPenerima::where('status', 'active')->orderBy('nama')->get();
        ...
        return view('tanda-terima-tanpa-surat-jalan-batam.edit', compact('tandaTerimaTanpaSuratJalan', 'terms', 'pengirims', 'masterPengirimPenerima', 'supirs', 'kranis', 'tujuan_kirims', 'master_kapals', 'containerOptions'));
    }

    /**
     * Update the specified resource in storage.
     */
    public function update(Request $request, TandaTerimaTanpaSuratJalanBatam $tandaTerimaTanpaSuratJalan)
    {
        $validated = $request->validate([
            'tanggal_tanda_terima' => 'required|date',
            'nomor_surat_jalan_customer' => 'nullable|string|max:255',
     ...
     */
    public function destroy(TandaTerimaTanpaSuratJalanBatam $tandaTerimaTanpaSuratJalan)
    {
        try {
     ...
     */
    public function downloadImage(TandaTerimaTanpaSuratJalanBatam $tandaTerimaTanpaSuratJalan, $imageIndex)
    {
        try {
            ...
            return back()->with('error', 'Gagal mendownload gambar.');
        }
    }
     ...
     */
    public function addToProspek(TandaTerimaTanpaSuratJalanBatam $tandaTerimaTanpaSuratJalan)
    {
        try {
    ...
    public function syncPenerimaPengirim($id)
    {
        try {
            DB::beginTransaction();
            $tt = TandaTerimaTanpaSuratJalanBatam::findOrFail($id);
