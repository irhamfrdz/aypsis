...
class AbsensiController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $query->selectRaw('
            ...
            MIN(CASE WHEN LOWER(tipe) = "masuk" THEN server_received_at ELSE NULL END) as server_received_masuk,
            MIN(CASE WHEN LOWER(tipe) = "masuk" THEN server_processed_at ELSE NULL END) as server_processed_masuk,
            MAX(CASE WHEN LOWER(tipe) IN ("pulang", "keluar") THEN server_received_at ELSE NULL END) as server_received_pulang,
            MAX(CASE WHEN LOWER(tipe) IN ("pulang", "keluar") THEN server_processed_at ELSE NULL END) as server_processed_pulang,
