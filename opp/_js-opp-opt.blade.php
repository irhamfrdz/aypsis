        ...
        .then(data => {
            if (data.success && data.counts) {
                ...
                if (isBongkaran) {
                    ...
                    // Add FCL 20FT
                    const fcl20 = (data.counts['20'] && data.counts['20'].full !== undefined && data.counts['20'].lcl !== undefined) ? (data.counts['20'].full - data.counts['20'].lcl) : 0;
                    if (fcl20 > 0 && pricelistIds['FCL 20FT']) {
                        addBarangToOppOptSectionWithValue(sectionIndex, pricelistIds['FCL 20FT'], fcl20);
                        itemsAdded = true;
                    }
                    
                    // Add FCL 40FT
                    const fcl40 = (data.counts['40'] && data.counts['40'].full !== undefined && data.counts['40'].lcl !== undefined) ? (data.counts['40'].full - data.counts['40'].lcl) : 0;
                    if (fcl40 > 0 && pricelistIds['FCL 40FT']) {
                        addBarangToOppOptSectionWithValue(sectionIndex, pricelistIds['FCL 40FT'], fcl40);
                        itemsAdded = true;
                    }
