...
echo '=== FIXING USER TEST4 EDIT PERMISSION FORMAT ===' . PHP_EOL;
...
$oldPermission = Permission::where('name', 'permohonan-edit')->first();
$newPermission = Permission::where('name', 'permohonan.edit')->first();

if (!$oldPermission) {
    echo PHP_EOL . '❌ Old permission permohonan-edit not found in database' . PHP_EOL;
    exit;
}

if (!$newPermission) {
    echo PHP_EOL . '❌ New permission permohonan.edit not found in database' . PHP_EOL;
    exit;
}
