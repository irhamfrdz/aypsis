...
/**
 * Script untuk membuat manifest untuk voyage SA01JB26
 * Memeriksa semua kontainer yang sudah OB untuk voyage ini
 * 
 * Cara menjalankan:
 * php fix_manifests_sa01jb26.php
 */
...
echo "===== FIX MANIFESTS - VOYAGE SA01JB26 =====\n";
echo "Memeriksa kontainer untuk voyage SA01JB26...\n\n";

try {
    DB::beginTransaction();
    
    $targetVoyage = 'SA01JB26';
