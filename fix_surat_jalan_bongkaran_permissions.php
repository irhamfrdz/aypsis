...
echo "=== Memperbaiki Permission Surat Jalan Bongkaran ===\n\n";

try {
    // Daftar permissions yang benar sesuai dengan route
    $permissions = [
        'surat-jalan-bongkaran-view',
        'surat-jalan-bongkaran-create',
        'surat-jalan-bongkaran-update',  // Ini yang diperlukan di route
    ...
    echo "\n=== Selesai ===\n";
    echo "✓ Semua permission Surat Jalan Bongkaran berhasil diperbaiki!\n";
    echo "\n⚠ PENTING: Silakan logout dan login kembali untuk menerapkan perubahan permission!\n";
