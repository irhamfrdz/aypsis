...
/**
 * Script untuk menambahkan permissions Master Pricelist Rit
 * 
 * Permissions yang ditambahkan:
 * - master-pricelist-rit-view
 * - master-pricelist-rit-create
 * - master-pricelist-rit-update
 * - master-pricelist-rit-delete
 */
...
echo "==============================================\n";
echo "  ADDING MASTER PRICELIST RIT PERMISSIONS\n";
echo "==============================================\n\n";

// Define permissions to be added
$permissions = [
    [
        'name' => 'master-pricelist-rit-view',
        'created_at' => Carbon::now(),
        'updated_at' => Carbon::now(),
    ],
    [
        'name' => 'master-pricelist-rit-create',
        'created_at' => Carbon::now(),
        'updated_at' => Carbon::now(),
    ],
    [
        'name' => 'master-pricelist-rit-update',
        'created_at' => Carbon::now(),
        'updated_at' => Carbon::now(),
    ],
    [
        'name' => 'master-pricelist-rit-delete',
        'created_at' => Carbon::now(),
        'updated_at' => Carbon::now(),
    ],
];
...
try {
    ...
    echo "- Module: Master Pricelist Rit\n\n";
